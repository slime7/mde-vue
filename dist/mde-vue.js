...
var ce = "currentcolor", Z = "data-mat-state-layer-host", le = 150, ue = /* @__PURE__ */ new Set([
	"AREA",
	"AUDIO",
	"BASE",
	"BR",
...
function he(e) {
	return e.color === void 0 || typeof e.color != "string" || !(typeof CSS > "u" || CSS.supports("color", e.color)) ? ce : e.color;
}
function ge(e) {
...
function Ee(e, t) {
	...
	r.className = "mat-state-layer", r.setAttribute("aria-hidden", "true"), r.style.setProperty("position-anchor", n), r.style.backgroundColor = he(me(t.value)), oe(e, n), e.setAttribute(Z, ""), e.prepend(r);
	let i = {
		activeKey: void 0,
...
function De(e) {
	let t = fe.get(e);
	t && (ye(e), t.removeEventListeners(), t.observer.disconnect(), t.layer.remove(), e.removeAttribute(Z), se(e, t.anchorName), fe.delete(e));
}
var Oe = {
	mounted: Ee,
	updated(e, t) {
...
function at({ seedColor: e, isDark: t, schemeVariant: n, contrastLevel: r }) {
	...
	let a = new i(q.fromInt(re(it(e))), t, r, "2025", "phone");
	if (a.specVersion !== "2025" || a.platform !== "phone") throw Error("Material Color Utilities 未生成请求的 2025 phone 配色");
	return a;
}
function ot(e, t) {
	return Object.freeze(Object.fromEntries(t.map((t) => [t, ie(e[t])])));
}
...
var It = Symbol("mat-app-root"), Lt = /* @__PURE__ */ new WeakMap();
function Rt(e, t) {
	Lt.set(e, t);
}
function zt(e) {
...
function $t(e, t, n, r, i, a, o, s) {
	let c = Yt(e, t, n, r, o), l = Math.max(a, i.width - r.width - a), u = Math.max(a, i.height - r.height - a), d = {
		left: qt(c.left, a, l),
		top: qt(c.top, a, u)
	}, f = Zt(d, r);
	return Qt(f, n) || s.some((e) => Qt(f, Wt(e))) ? null : d;
}
function en({ avoidRects: e = [], gap: t = 4, location: n = "top", margin: r = 8, targetRect: i, tooltipRect: a, viewport: o = {
	height: window.innerHeight,
	width: window.innerWidth
} }) {
	let s = Wt(i), c = Wt(a), [l, u = "center"] = (Ht.includes(n) ? n : "top").split("-"), d = u === "start" || u === "end" ? u : "center", f = l === "top" || l === "bottom" ? c.height : c.width, p = Jt(l, s, o, r, t), m = Ut[l], h = Jt(m, s, o, r, t), g = f > p && h > p ? m : l, _ = Math.max(r, o.width - c.width - r), v = Math.max(r, o.height - c.height - r), y = Xt(g), b = e.map((e) => Wt(e)), x = y.find((e) => Jt(e, s, o, r, t) >= f && $t(e, d, s, c, o, r, t, b)) ?? y.find((e) => $t(e, d, s, c, o, r, t, b)) ?? g, S = d === "center" ? x : `${x}-${d}`, C = Yt(x, d, s, c, t);
	return {
		left: Math.round(qt(C.left, r, _)),
		location: S,
		top: Math.round(qt(C.top, r, v))
	};
}
//#endregion
//#region src/components/tooltip-stack.js
var tn = null, nn = "pointer";
...
var cn = /* @__PURE__ */ new Map(), ln = /* @__PURE__ */ new Set(), un = 0;
function dn(e) {
	let t = Number(e?.left) || 0, n = Number(e?.top) || 0, r = Number.isFinite(Number(e?.width)) ? Number(e.width) : Math.max(0, (Number(e?.right) || t) - t), i = Number.isFinite(Number(e?.height)) ? Number(e.height) : Math.max(0, (Number(e?.bottom) || n) - n);
	return {
		bottom: Number.isFinite(Number(e?.bottom)) ? Number(e.bottom) : n + i,
...
function pn() {
	cn.forEach((e, t) => {
		e.element.isConnected || cn.delete(t);
	});
}
function mn(e, t = {}) {
	...
	return cn.set(n, r), fn(), {
		unregister() {
			i && (i = !1, cn.delete(n), fn());
		},
		update() {
			i && fn();
		}
...
function gn(e = window.innerHeight) {
	pn();
	let t = Number.isFinite(Number(e)) ? Number(e) : 0;
	return Math.max(0, ...[...cn.values()].filter((e) => e.isBottom()).flatMap((e) => {
		try {
			return [Math.max(0, t - dn(e.getRect()).top)];
		} catch {
			return [];
		}
	}));
...
var vn = ["id", "data-location"], yn = {
	key: 0,
	class: "mat-tooltip__subhead mat-sys-typescale-title-small"
}, bn = { class: "mat-tooltip__content mat-sys-typescale-body-medium" }, xn = {
	key: 1,
	class: "mat-tooltip__actions"
}, Sn = 600, Cn = 150, wn = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatTooltip",
	inheritAttrs: !1
}, {
	__name: "MatTooltip",
	...
	emits: { "update:modelValue": (e) => typeof e == "boolean" },
	setup(e, { emit: r }) {
		let l = e, d = r, p = $("tooltip", l), m = ee(), g = V(), y = f(), b = h(It, null), x = j(null), O = L(null), k = { value: O }, A = L(null), M = j(!1), N = j(null), F = j(!1), I = j(!1), U = j(!1), W = j("closed"), G = j("top"), te = j({}), K = j(!1), q = `${B().replace(/[^\w-]/g, "-")}-tooltip`, J = i(() => typeof m.id == "string" ? m.id : q), Y = i(() => p.content === void 0 ? !!g.default : p.content.length > 0), ne = i(() => p.subhead === void 0 ? !!g.subhead : p.subhead.length > 0), X = i(() => p.rich || ne.value || !!g.action), re = i(() => !!g.activator), ie = y?.vnode.props ?? {}, ae = Object.prototype.hasOwnProperty.call(ie, "modelValue") || Object.prototype.hasOwnProperty.call(ie, "model-value"), oe, se, ce = Pt(), Z = Ft({ motion: ce }), le, ue = !1, de, fe, pe = null, me = null, he = null, ge = null, _e = null, ve = !1, ye = !0, be = !1, xe = !1, Se = !1, Ce = { close: Ye };
		function we(e) {
		...
		function Fe() {
			se !== void 0 && (window.clearTimeout(se), se = void 0);
		}
		function Ie() {
		...
		function Ke() {
			...
			}, he = _n(Ge), typeof ResizeObserver < "u" && (fe = new ResizeObserver(Ge), fe.observe(O.value), fe.observe(N.value)));
		}
		function qe() {
			F.value = !1, W.value = "closed", I.value = !1, U.value = !1, A.value = null, M.value = !1;
		}
		function Je({ immediate: e = !1 } = {}) {
			if (Fe(), Ie(), Re(), Ue(), Ve(), on(Ce), !F.value) {
				qe();
				return;
			}
		...
		function Ye() {
			ae && (K.value = !0, d("update:modelValue", !1)), Je();
		}
		function Xe() {
		...
		function Qe() {
			if (Ie(), ae || I.value || K.value || !Y.value) return;
			let e = sn() ? 0 : Ne();
			if (e === 0) {
				ut();
				return;
			}
			se === void 0 && (se = window.setTimeout(() => {
				se = void 0, ut();
			}, e));
		}
		function $e() {
			Fe(), !(ae || !I.value || be || xe) && oe === void 0 && (oe = window.setTimeout(() => {
				oe = void 0, Ye();
			}, Pe()));
		}
		function et() {
		...
		function lt() {
			let e = O.value;
			e && (e.addEventListener("keydown", st), !ae && Y.value && (e.addEventListener("focusin", nt), e.addEventListener("focusout", rt)), pe = () => {
		...
		async function ut() {
			...
			Fe(), Ie(), Le(), an(Ce), A.value = e, M.value = e === b?.freeLayer.value, G.value = p.location, te.value = {
				left: "0px",
				top: "0px"
			}, U.value = !1, W.value = "opening", F.value = !0, I.value = !0, await v(), !(!ve || !ye || !I.value) && (He(), We(), Ke(), ze());
		}
		return T(async () => {
			ve = !0, Ze({ warn: !1 }), await v(), ve && (Ze({ warn: !1 }), ae && p.modelValue && ut());
		}), E(() => {
			Ze({ warn: !1 }), I.value && Ge();
		}), S(() => {
			ye || (ye = !0, Ze({ warn: !1 }), ae && p.modelValue && ut());
		}), w(() => {
			...
			F.value && A.value ? (D(), a(n, {
				...
				ne.value ? (D(), s("span", yn, [z(p).subhead === void 0 ? P(r.$slots, "subhead", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(p).subhead), 1)], 64))])) : o("", !0),
				c("span", bn, [z(p).content === void 0 ? P(r.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(p).content), 1)], 64))]),
				r.$slots.action ? (D(), s("span", xn, [P(r.$slots, "action", {}, void 0, !0)])) : o("", !0)
			], 64)) : z(p).content === void 0 ? P(r.$slots, "default", { key: 2 }, void 0, !0) : (D(), s(t, { key: 1 }, [u(R(z(p).content), 1)], 64))], 16, vn)], 8, ["to"])) : o("", !0)
		], 64));
	}
}), [["__scopeId", "data-v-cc34425b"]]), Tn = Symbol("mde-vue-button-group"), En = Symbol("mde-vue-split-button");
//#endregion
//#region src/components/use-button.js
function Dn(e, t) {
	let n = h(Ne, Me), r = h(Tn, null), a = h(En, null), o = i(() => a?.size.value ?? e.size ?? r?.size.value ?? "small"), s = i(() => a ? "round" : e.shape ?? r?.shape.value ?? "round"), c = i(() => a?.variant.value ?? e.variant), l = i(() => a?.color.value ?? e.color ?? r?.color.value), u = i(() => e.disabled || !!a?.disabled.value || !!r?.disabled.value), d = i(() => !!(r && r.selection.value !== "none")), f = i(() => a?.role === "trailing" ? a.expanded.value : d.value ? r.isSelected(e.value) : e.selected), p = i(() => a?.role === "trailing" || d.value || e.toggle), { colorStyle: m, hasExplicitColor: g } = dt(l);
	function _(n) {
...
function Mn(e) {
	return kn.includes(e) || Object.hasOwn(An, e);
}
function Nn(e) {
	return An[e] ?? e;
}
...
var Fn = {
...
}, In = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBtn",
	inheritAttrs: !1
}, {
	__name: "MatBtn",
	...
	setup(e, { emit: n }) {
		let r = $("btn", e), c = n, l = ee(), d = V(), f = j(null), p = B(), { colorStyle: m, effectiveColor: h, effectiveDisabled: v, effectiveSelected: y, effectiveShape: b, effectiveSize: x, effectiveToggle: S, effectiveVariant: C, handleClick: w, hasExplicitColor: E, split: O, useCursor: k } = Dn(r, c), A = i(() => He(h.value)), M = i(() => !A.value || C.value === "text"), N = i(() => M.value ? m.value : {}), F = i(() => M.value && E.value), I = i(() => S.value && C.value !== "text"), L = i(() => I.value && y.value), H = i(() => r.icon === !0 || typeof r.icon == "string" && r.icon.trim().length > 0), G = i(() => r.fill === void 0 ? +!!L.value : r.fill);
		function te(e) {
			return e.flatMap((e) => typeof e == "string" || typeof e == "number" ? [String(e)] : g(e) ? e.type === t && Array.isArray(e.children) ? te(e.children) : typeof e.children == "string" || typeof e.children == "number" ? [String(e.children)] : Array.isArray(e.children) ? te(e.children) : [] : []).join("").trim();
		}
		let K = i(() => r.icon === !0 ? te(d.default?.() ?? []) : ""), q = i(() => typeof r.icon == "string" ? r.icon.trim() : K.value), J = i(() => l["aria-label"] ?? r.label), Y = i(() => H.value ? l.title ?? r.label : void 0), ne = i(() => !H.value && (r.prefix !== void 0 || !!d.prefix)), X = i(() => !H.value && (r.suffix !== void 0 || !!d.suffix)), re = i(() => L.value && !!d.selected), ie = i(() => ({
			"extra-small": 20,
			small: H.value ? 24 : 20,
			medium: 24,
			large: 32,
		...
		return T(() => {
			...
			r.toggle && r.variant === "text" && console.warn("MatBtn: text 形态不支持 toggle，当前按普通文本按钮处理"), A.value && C.value !== "text" && console.warn("MatBtn: on-* 内容色只支持 text 形态，当前按默认配色处理"), H.value && (!J.value || J.value.trim().length === 0) && console.warn("MatBtn: 图标模式必须提供非空 label 或 aria-label");
		}), (e, n) => (D(), a(Ae, _({
			...
			style: N.value,
			"aria-label": H.value ? J.value : z(l)["aria-label"],
			...
			default: W(() => [
				...
				H.value ? o("", !0) : (D(), s("span", Fn, [re.value ? P(e.$slots, "selected", { key: 0 }, void 0, !0) : P(e.$slots, "default", { key: 1 }, void 0, !0)])),
				X.value ? (D(), a(ht, {
					key: 3,
					as: "span",
...
function Vn(e, t, n) {
	...
	if (t.element.isConnected && n.element.isConnected) {
		...
		if (Bn(e, Node.DOCUMENT_POSITION_FOLLOWING)) return -1;
		if (Bn(e, Node.DOCUMENT_POSITION_PRECEDING)) return 1;
	}
	return e.indexOf(t) - e.indexOf(n);
}
function Hn({ scheduleMeasure: e } = {}) {
	let t = [], n;
	function r(e) {
		n = e, t.forEach((e) => {
	...
	function i({ baseInsets: e, width: n = 0, height: r = 0 } = {}) {
		let i = zn(e), a = Object.fromEntries(Ln.map((e) => [e, {
			startInset: 0,
			endInset: 0
		}]));
		t.filter((e) => e.active).sort((e, n) => Vn(t, e, n)).forEach((e) => {
		...
		let o = Object.fromEntries(Ln.map((e) => [e, {
			size: i[e],
			...a[e]
		}]));
		return {
	...
	function a({ edge: r, element: i } = {}) {
		if (!Ln.includes(r)) throw TypeError("registerEdge() 的 edge 必须是 top、bottom、left、right、start 或 end");
...
var Un = Symbol("mat-edge-layout"), Wn = { class: "mat-app-root__overlay" }, Gn = { class: "mat-app-root__bottom-stack" }, Kn = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAppRoot",
	inheritAttrs: !1
}, {
	__name: "MatAppRoot",
	...
	setup(e) {
		...
		if (h(It, null)) throw Error("MatAppRoot 不允许嵌套");
		...
		let V = Hn({ scheduleMeasure: B }), U = V.registerEdge, G = Object.freeze({
			layout: y,
			registerEdge: U
		});
		function te() {
		...
		return T(async () => {
			w = !0, Rt(o.value, K), E = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(B), E?.observe(o.value), V.setResizeObserver(E), q(), await v(), B();
		}), C(() => {
			w = !1, V.setResizeObserver(void 0), zt(o.value), E?.disconnect(), E = void 0, J(), M !== void 0 && (typeof window.cancelAnimationFrame == "function" ? window.cancelAnimationFrame(M) : window.clearTimeout(M));
...
}), [["__scopeId", "data-v-05570144"]]), qn = Symbol("mat-layout");
function Jn() {
	let e = h(qn, null);
...
var Yn = L([]), Xn = L(0), Zn = Symbol("mat-dialog-document-scope"), Qn = /* @__PURE__ */ new WeakMap(), $n = /* @__PURE__ */ new Map();
function er(e) {
...
function tr(e, t) {
	let n = er(e);
	!t || t === n.inertElement || (n.inertElement && !n.inert && n.inertElement.removeAttribute("inert"), $n.set(e, {
		...n,
...
function nr(e) {
	let t = $n.get(e);
	t?.inertElement && (t.inert || t.inertElement.removeAttribute("inert"), $n.set(e, {
		...t,
		inert: !1,
		inertElement: null
	}));
...
function rr(e) {
	let t = er(e), n = document.documentElement, r = n.clientWidth > 0 ? Math.max(0, window.innerWidth - n.clientWidth) : 0, i = getComputedStyle(n).scrollbarGutter, a = r > 0 && !i.includes("stable") ? "stable" : null;
	$n.set(e, {
		...t,
		lockedScrollbarGutter: a,
		overflow: n.style.overflow,
		scrollbarGutter: n.style.scrollbarGutter
	}), a && (n.style.scrollbarGutter = a, Xn.value = r), n.style.overflow = "hidden";
}
function ir(e) {
	let t = $n.get(e);
	if (!t) return;
	let n = document.documentElement;
	n.style.overflow === "hidden" && (n.style.overflow = t.overflow), t.lockedScrollbarGutter !== null && n.style.scrollbarGutter === t.lockedScrollbarGutter && (n.style.scrollbarGutter = t.scrollbarGutter), t.lockedScrollbarGutter !== null && (Xn.value = 0);
}
function ar(e) {
	let t = e, n = er(e), r = getComputedStyle(t), i = (Number.parseFloat(r.borderLeftWidth) || 0) + (Number.parseFloat(r.borderRightWidth) || 0), a = Math.max(0, t.offsetWidth - t.clientWidth - i) > 0 && !r.scrollbarGutter.includes("stable") ? "stable" : null;
	$n.set(e, {
		...n,
		lockedScrollbarGutter: a,
...
function sr(e) {
	let t = $n.get(e);
	!t || t.count > 0 || (e === Zn ? ir(e) : or(e), nr(e), $n.delete(e));
}
function cr() {
	[...$n.keys()].forEach((e) => {
		e === Zn ? ir(e) : or(e), nr(e);
...
function lr({ inertElement: e = null, scrollElement: t } = {}) {
	let n = t instanceof HTMLElement ? t : Zn, r = er(n);
	r.count === 0 ? (n === Zn ? rr(n) : ar(n), tr(n, e)) : e && r.inertElement !== e && tr(n, e);
	let i = er(n);
	$n.set(n, {
		...i,
		count: i.count + 1
...
function ur(e) {
	let t = e?.scrollElement instanceof HTMLElement ? e.scrollElement : Zn, n = $n.get(t);
	n && ($n.set(t, {
		...n,
...
function dr(e, t) {
	let n = Yn.value.filter((e) => e.isConnected);
	if (n.length === 0 && cr(), n.includes(e)) {
		Yn.value = n;
		return;
	}
	Qn.set(e, t), Yn.value = [...n, e], lr(t);
}
function fr(e) {
	let t = Qn.get(e);
	Qn.delete(e), Yn.value = Yn.value.filter((t) => t !== e && t.isConnected), t && ur(t), Yn.value.length === 0 && cr();
}
//#endregion
...
function mr(e, t) {
	...
	function i() {
		let t = e.value;
		return t ? [...t.querySelectorAll(pr)].filter((e) => e instanceof HTMLElement) : [];
	}
	function a(t) {
		if (t.key !== "Tab") return;
		let n = i(), r = e.value;
...
var hr = 200, gr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAside",
	inheritAttrs: !1
}, {
	__name: "MatAside",
	...
	setup(e, { expose: r, emit: l }) {
		...
		let E = w(), O = i(() => ({
			...m,
			...E
		})), k = i(() => d.open === void 0 ? d.modelValue === void 0 || !!d.modelValue : !!d.open), A = j(!d.unmountOnClose || k.value), M = j(k.value ? "open" : "closed"), N = Pt(), I = Ft({ motion: N }), R = !1, B, V = null;
		function U() {
			V?.isConnected && V.focus({ preventScroll: !0 }), V = null;
		}
		let G = h(qn, null), te = h(It, null), K = h(Un, null), q = g?.vnode.props ?? {}, J = i(() => Object.prototype.hasOwnProperty.call(q, "attach") && q.attach !== void 0);
		function Y() {
			let e = g?.vnode.props ?? {};
			return Object.prototype.hasOwnProperty.call(e, "mode") && e.mode !== void 0;
		}
		let ne = i(() => d.app && !!te && !J.value), X = i(() => Y() ? d.mode : d.app ? ne.value ? "docked" : "fixed" : d.mode), re = i(() => {
			let e = d.location;
		...
		}), ie = i(() => d.blockSize === void 0 || d.blockSize === "auto"), ae = j({
			blockSize: 0,
			inlineSize: 0
		}), oe = i(() => !!d.modal), se = i(() => oe.value && d.placeholder), ce = i(() => oe.value && Yn.value.at(-1) === b.value);
		mr(b, i(() => oe.value && A.value && ce.value));
		let Z = i(() => {
			...
			return e !== null && t !== null ? `${e + t}px` : `calc(${Z.value} + ${le.value})`;
		...
		let pe = i(() => [
			...
			`mat-aside--${M.value}`,
			{
				...
				"mat-aside--auto-size": ie.value,
				"mat-aside--modal": oe.value,
				"mat-aside--modal-scoped": oe.value && he.value,
				"mat-aside--top-scrim": ce.value,
				"mat-aside--no-transition": !d.transition,
				"mat-aside--app": d.app
			}
		]), me = i(() => [m.style, {
			"--mat-aside-block-size": ie.value ? "auto" : Z.value,
			"--mat-aside-safe-area-size": le.value,
			"--mat-aside-total-block-size": ie.value ? "auto" : ue.value,
			...
			zIndex: d.zIndex === void 0 ? oe.value ? "calc(var(--mat-sys-z-index-dialog) + 1)" : de.value : String(d.zIndex)
		}]), he = i(() => X.value !== "fixed" && !!(K?.rootElement?.value && (K.kind !== "app-root" || !J.value))), ge = i(() => X.value === "fixed" && J.value), _e = i(() => {
			if (J.value && d.attach) {
			...
			return X.value !== "fixed" && K?.rootElement?.value ? K.rootElement.value : X.value === "fixed" ? null : "body";
		}), ve = i(() => oe.value && he.value ? K?.contentElement?.value ?? _e.value : _e.value), ye = i(() => {
			let e = re.value === "start" || re.value === "end", t = k.value && M.value !== "closed", n;
			return n = t ? d.placeholderSize === void 0 ? ie.value ? e ? `${ae.value.inlineSize}px` : `${ae.value.blockSize}px` : ue.value : Tt(d.placeholderSize, {
		...
		function be() {
			let e = J.value ? G : K ?? G ?? te;
			if (!e) return {
				inertElement: null,
				scrollElement: null
			};
			if (e.kind === "app-root" || e === te) {
		...
		function xe() {
			if (!R || !b.value || !A.value || !oe.value || !k.value || M.value === "closed") {
				b.value && fr(b.value);
				return;
			}
			dr(b.value, be());
		...
		function we() {
			!oe.value || !d.closeOnBack || Ce();
		}
		function Te(e) {
			oe.value && ce.value && e.key === "Escape" && (e.preventDefault(), Ce());
		}
		function Ee() {
			if (!R || !b.value) return;
			let e = b.value.getBoundingClientRect(), t = Math.max(0, Math.ceil(Number(e.height) || 0)), n = Math.max(0, Math.ceil(Number(e.width) || 0));
			ae.value.blockSize === t && ae.value.inlineSize === n || (ae.value = {
				blockSize: t,
				inlineSize: n
			}, S.value?.update());
		}
		...
		function Oe() {
			...
			S.value?.unregister(), S.value = null, !(X.value === "flow" || X.value === "sticky" || d.modal) && K && (S.value = K.publicContext.registerEdge({
				edge: re.value,
				element: b.value
			}));
		}
		function Q() {
			if (N.cancel(), A.value = !0, oe.value && typeof document < "u" && document.activeElement instanceof HTMLElement && (V = document.activeElement), !d.transition) {
				M.value = "open", v().then(() => {
					Oe(), xe(), p("opened");
				});
				return;
			...
			M.value = "opening", v().then(() => {
				Oe(), xe(), !(!R || !A.value || !k.value) && N.wait(b.value, hr, () => {
		...
		return H(k, (e) => {
			...
			activeInsets: fe,
			phase: M
		}), (e, r) => se.value && (A.value || !z(d).unmountOnClose) ? (D(), s(t, { key: 0 }, [P(e.$slots, "placeholder", { style: x(ye.value) }, () => [c("span", {
			...
			to: _e.value,
			disabled: !_e.value
		}, [oe.value && A.value && M.value !== "closed" ? (D(), s("div", {
			key: 0,
			class: y(["mat-aside__scrim", [z(d).scrimClass, {
				"mat-aside__scrim--top": ce.value,
			...
			default: W(() => [oe.value && A.value && M.value !== "closed" ? (D(), a(n, {
				key: 0,
				to: ve.value,
				disabled: !ve.value
			}, [c("div", {
...
}), [["__scopeId", "data-v-dc44c35a"]]), _r = /* @__PURE__ */ new WeakMap(), vr = /* @__PURE__ */ new WeakMap();
function yr(e, t, n) {
...
function br(e, t, n, r) {
	...
	}, e.set(t, i)), i.names.add(r), yr(t, n, i), () => {
...
function xr({ name: e, scope: t, source: n }) {
	let r = _r.get(n)?.initialAxis ?? n.style.scrollTimelineAxis, i = br(_r, n, "scrollTimelineName", e), a = _r.get(n);
	a.initialAxis = r;
	let o = n.style;
	o.scrollTimelineAxis = "block";
	let s = br(vr, t, "timelineScope", e);
	return () => {
		s(), i(), _r.has(n) || (o.scrollTimelineAxis = r);
	};
}
function Sr(e) {
...
var wr = {
	...
	setup(e, { expose: n, emit: r }) {
		let a = [
			...
			"image",
			"search"
		], u = ["start", "center"], p = $("appBar", e), m = r, g = ee(), b = f(), S = h(It, null), w = b?.vnode.props ?? {}, E = i(() => Object.prototype.hasOwnProperty.call(w, "attach") && w.attach !== void 0), O = i(() => E.value ? p.attach : void 0), k = j(null), A = i(() => {
		...
		]), U = i(() => [g.style, { "--mat-app-bar-timeline": M }]), G = i(() => N.value === "medium-flexible" ? Pn("headline", "small") : N.value === "large-flexible" ? Pn("headline", "medium") : Pn("title", "large")), te = !1, K, q;
		function J() {
		...
		async function X() {
			...
			if (!te || !e) return;
			ne();
			let t = Y(p.scrollTarget), n = R.value && S.rootElement.value?.dataset.scrollable === "true" ? S.contentElement.value : null, r = t ?? n ?? Sr(e);
			if (!r) return;
			let i = Cr(r, e);
			J() && i && (K = xr({
				name: M,
		...
		return T(() => {
			...
			default: W(() => [
				e.$slots.leading ? (D(), s("div", wr, [P(e.$slots, "leading", {}, void 0, !0)])) : o("", !0),
				c("div", Tr, [c("div", { class: y(["mat-app-bar__primary", G.value]) }, [P(e.$slots, "default", {}, void 0, !0)], 2), e.$slots.subtitle ? (D(), s("div", Er, [P(e.$slots, "subtitle", {}, void 0, !0)])) : o("", !0)]),
				n[2] ||= c("span", {
					class: "mat-app-bar__spacer",
					"aria-hidden": "true"
				}, null, -1),
				e.$slots.trailing ? (D(), s("div", Dr, [P(e.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
			]),
			_: 3
		}, 16, [
			"app",
...
}), [["__scopeId", "data-v-abe3039f"]]), kr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatInputBase",
	inheritAttrs: !1
}, {
	__name: "MatInputBase",
...
}), [["__scopeId", "data-v-ace9bd51"]]), Ar = { class: "mat-search__leading" }, jr = {
	key: 0,
	...
	setup(e, { expose: t, emit: n }) {
		...
		return t({
			...
			c("span", Ar, [P(e.$slots, "leading", {}, () => [d(In, {
				disabled: z(r).disabled,
				icon: "search",
				label: z(r).label,
				size: "small",
			...
			d(kr, _({
				...
				readonly: z(r).readonly,
				type: "search",
				onKeydown: te(K(m, ["prevent"]), ["enter"]),
			...
			e.$slots.trailing ? (D(), s("span", jr, [P(e.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
		], 16));
	}
}), [["__scopeId", "data-v-7c60e904"]]), Nr = 150, Pr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBtnGroup",
	inheritAttrs: !1
}, {
	__name: "MatBtnGroup",
	...
	setup(e, { emit: t }) {
		let n = $("btnGroup", e), r = t, a = j(null), o = j(null), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakMap(), d = /* @__PURE__ */ new Set(), f, p, m, h = Nr, g = !0, y = !1, { colorStyle: b } = dt(i(() => n.color));
		function x(e) {
		...
		function A() {
			return k(getComputedStyle(a.value).getPropertyValue("--mat-btn-group-size-animation-duration")) ?? Nr;
		}
		function M() {
		...
		function R() {
			...
			}), d.clear(), o.value && delete o.value.dataset.matGroupPressed, m &&= (m.style.removeProperty("--mat-button-visual-scale"), void 0), o.value = null, h = Nr, g = !0, y = !1;
		}
		function ee() {
			if (!o.value) return;
...
var zr = ["aria-hidden"], Br = ["aria-hidden"], Vr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatFab",
	inheritAttrs: !1
}, {
	__name: "MatFab",
	...
	setup(t, { emit: r }) {
		let c = $("fab", t), l = r, f = ee(), p = V(), m = h(Ne, Me), g = h(It, null), v = j(null), y = B(), b = i(() => (p.default?.() ?? []).some((t) => t.type === e ? !1 : typeof t.children != "string" || t.children.trim().length > 0)), x = i(() => c.expanded && b.value), S = i(() => typeof c.icon == "string" && c.icon.trim().length > 0), C = i(() => !x.value), w = i(() => C.value ? f.title ?? c.label : void 0), T = i(() => C.value ? c.label : f["aria-label"]), E = i(() => ({
			small: 24,
			medium: 28,
			large: 36
		})[c.size]), O = i(() => {
		...
		return U(() => {
			...
			default: W(() => [
				...
				}, [P(e.$slots, "default", {}, void 0, !0)], 8, Br)) : o("", !0),
				C.value && w.value ? (D(), a(wn, {
					key: 2,
					content: w.value,
					id: `${z(y)}-tooltip`,
					target: v.value
			...
			default: W(() => [
				...
				b.value ? (D(), s("span", {
					...
					class: "mat-fab__label",
					"aria-hidden": x.value ? void 0 : "true"
				}, [P(e.$slots, "default", {}, void 0, !0)], 8, zr)) : o("", !0),
				C.value && w.value ? (D(), a(wn, {
					key: 2,
					content: w.value,
					id: `${z(y)}-tooltip`,
	...
	setup(e, { emit: t }) {
		let r = $("fabMenu", e), l = t, f = h(Ne, Me), p = h(It, null), m = j(null), g = j(null), v = j(!1), y = B(), b = i(() => r.modelValue !== void 0), x = i(() => b.value ? !!r.modelValue : v.value), S = i(() => r.closeLabel || "关闭"), w = i(() => r.color.replace(/-container$/, "")), E = i(() => `${w.value}-container`), O = i(() => ({
		...
		return T(() => {
			...
			"aria-hidden": x.value ? void 0 : "true",
			onClick: F
		}, [P(e.$slots, "default", {}, void 0, !0)], 8, Hr), c("div", Ur, [P(e.$slots, "trigger", {
			open: x.value,
			toggle: N,
			size: z(r).size,
			color: z(r).color
			...
			"aria-hidden": x.value ? void 0 : "true",
			onClick: F
		}, [P(e.$slots, "default", {}, void 0, !0)], 8, Wr), c("div", Gr, [P(e.$slots, "trigger", {
			open: x.value,
			toggle: N,
			size: z(r).size,
			color: z(r).color
...
}), [["__scopeId", "data-v-d5f3cb83"]]), Yr = L(/* @__PURE__ */ new Set()), Xr = 0;
function Zr(e) {
	return Xr += 1, Yr.value = new Set(e), Xr;
}
function Qr(e) {
	e === Xr && (Yr.value = /* @__PURE__ */ new Set());
}
//#endregion
//#region src/components/mat-shared-element/MatSharedElement.vue
var $r = /*@__PURE__*/ Object.assign({
	...
	setup(e) {
		let t = $("sharedElement", e), n = ee(), r = i(() => !t.disabled && Yr.value.has(t.name) ? t.name : void 0), o = i(() => [n.style, { viewTransitionName: r.value }]);
...
}, ni = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAvatar",
	inheritAttrs: !1
}, {
	__name: "MatAvatar",
	...
	setup(e) {
		...
		return (e, n) => (D(), s("span", _(e.$attrs, {
			...
			"aria-hidden": "true"
		}, null, 8, ["icon"])) : (D(), s("span", ti, [P(e.$slots, "default", {}, void 0, !0)]))], 16));
	}
}), [["__scopeId", "data-v-a04143bf"]]), ri = Object.freeze({
...
Object.freeze(Object.keys(ri));
function ii(e) {
	return typeof e == "string" && Object.hasOwn(ri, e);
}
var ai = Object.freeze([
	...
	"4-sided-cookie",
	"oval"
]), oi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatShape",
	inheritAttrs: !1
}, {
	__name: "MatShape",
	...
	setup(e) {
		let t = $("shape", e), { colorStyle: n } = dt(i(() => t.color)), r = i(() => Tt(t.size, {
			...
			positive: !0,
			fallback: "48px"
		})), o = i(() => ii(t.name) ? t.name : "circle"), s = i(() => ({
			...n.value,
			inlineSize: r.value,
			blockSize: r.value,
			clipPath: ri[o.value]
...
}), [["__scopeId", "data-v-d3e79d42"]]), si = /*@__PURE__*/ Object.assign({ name: "MatText" }, {
	__name: "MatText",
	props: {
		type: {
			type: String,
	...
	setup(e) {
		let t = $("text", e), n = i(() => Pn(t.type, t.size, t.emphasized));
		return (e, r) => (D(), a(F(z(t).as), { class: y(n.value) }, {
			default: W(() => [P(e.$slots, "default")]),
			_: 3
		}, 8, ["class"]));
	}
}), ci = ["data-char", "onAnimationend"], li = { class: "mat-dynamic-text__stage" }, ui = {
	key: 1,
	class: "mat-dynamic-text__char mat-dynamic-text__char--exiting"
}, di = 25, fi = 300, pi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatDynamicText" }, {
	...
	setup(e) {
		...
		function _(e, t) {
			let n = t * di + fi, r = setTimeout(() => g(e), n);
			u.set(e, r);
		}
		function v(e, t) {
			let n = m(e), i = t && !p();
		...
		return l.value = v(n.text, n.appear), H(() => n.text, (e, t) => {
			...
			}, [c("span", li, [e.char ? (D(), s("span", {
				key: 0,
				class: y(["mat-dynamic-text__char", e.animating ? "mat-dynamic-text__char--entering" : "mat-dynamic-text__char--idle"])
			}, R(e.char), 3)) : o("", !0), e.oldChar ? (D(), s("span", ui, R(e.oldChar), 1)) : o("", !0)])], 44, ci))), 128))]),
			_: 1
		}, 8, ["aria-label"]));
	}
}), [["__scopeId", "data-v-314708d8"]]), mi = /*@__PURE__*/ Object.assign({ name: "MatSplitSegment" }, {
...
}), [["__scopeId", "data-v-30ec286f"]]), gi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSurfaceBase",
	inheritAttrs: !1
}, {
...
}), [["__scopeId", "data-v-73d1306b"]]), _i = { class: "mat-card-headline mat-sys-typescale-title-large" }, vi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardHeadline" }, {
	__name: "MatCardHeadline",
	setup(e) {
		return (e, t) => (D(), s("div", _i, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-53a5927c"]]), yi = { class: "mat-card-media" }, bi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardMedia" }, {
	__name: "MatCardMedia",
	setup(e) {
		return (e, t) => (D(), s("div", yi, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-c38ab1c6"]]), xi = { class: "mat-card-subhead mat-sys-typescale-body-medium" }, Si = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardSubhead" }, {
	__name: "MatCardSubhead",
	setup(e) {
		return (e, t) => (D(), s("div", xi, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-c437408b"]]), Ci = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatCard",
	inheritAttrs: !1
}, {
	__name: "MatCard",
...
}), [["__scopeId", "data-v-cb7bd9d9"]]), wi = { class: "mat-card-action-area__content" }, Ti = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: t }) {
		...
		return (e, t) => (D(), a(ke, _(e.$attrs, {
			...
			default: W(() => [c("span", wi, [P(e.$slots, "default", {}, void 0, !0)])]),
			_: 3
		}, 16, [
			"disabled",
			"href",
...
}), [["__scopeId", "data-v-c7ecd12e"]]), Ei = { class: "mat-card-content" }, Di = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardContent" }, {
	__name: "MatCardContent",
	setup(e) {
		return (e, t) => (D(), s("div", Ei, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-9ba80632"]]), Oi = { class: "mat-card-actions" }, ki = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardActions" }, {
	__name: "MatCardActions",
	setup(e) {
		return (e, t) => (D(), s("div", Oi, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-69850177"]]), Ai = [
	"none",
	"single-action",
	"multi-action",
	"single-select",
	"multi-select"
], ji = Symbol("mat-list"), Mi = Symbol("mat-list-group-activator");
function Ni(e) {
...
var Bi = 500, Vi = 8, Hi = 48, Ui = 24, Wi = "color-mix(\n  in srgb,\n  var(--mat-list-drag-content-color) calc(var(--mat-sys-state-dragged-state-layer-opacity) * 100%),\n  var(--mat-list-drag-container-color)\n)", Gi = "data-mat-list-drag-selection-lock", Ki = 0;
function qi(e) {
	e.cancelable && e.preventDefault();
}
function Ji() {
	Ki === 0 && (document.documentElement.setAttribute(Gi, ""), document.addEventListener("selectstart", qi, !0)), Ki += 1, globalThis.getSelection?.()?.removeAllRanges();
}
function Yi() {
	Ki !== 0 && (--Ki, Ki === 0 && (document.documentElement.removeAttribute(Gi), document.removeEventListener("selectstart", qi, !0)));
}
function Xi(e) {
...
function $i(e, t) {
	let { style: n } = e;
	n.setProperty("--mat-list-drag-container-color", t.backgroundColor), n.setProperty("--mat-list-drag-content-color", t.color), n.background = Wi;
}
function ea(e, t) {
	...
	Qi(n), n.setAttribute("aria-hidden", "true"), n.setAttribute("data-mat-list-drag-preview", ""), n.setAttribute("inert", "");
	for (let e = 0; e < r.length; e += 1) {
		let t = r.item(e);
		t.startsWith("--mat-") && n.style.setProperty(t, r.getPropertyValue(t));
	}
	return $i(a, getComputedStyle(i)), Object.assign(n.style, {
		position: "fixed",
		zIndex: "1000",
...
function na(e) {
	...
	function m() {
		...
		}).map((e) => Xi(e.value.value)).sort().join("|");
	...
	function x() {
		o && (o.source.style.display = o.sourceDisplay, o.placeholder.remove(), o.preview.remove(), Yi(), o = void 0, t.value = !1);
	}
	function S() {
		b(), l?.cancel(), x(), y();
	}
	...
	function E(e) {
		...
		if (e < n.top + Hi ? r = -Math.ceil(Ui * ((n.top + Hi - e) / Hi)) : e > n.bottom - Hi && (r = Math.ceil(Ui * ((e - n.bottom + Hi) / Hi))), r === 0) return 0;
		let i = t.scrollTop;
	...
	function k() {
		...
		let h = m.getBoundingClientRect(), g = document.createElement(m.tagName.toLowerCase()), _ = ea(m, h), v = m.matches(".mat-list-item__surface") ? m : m.querySelector(".mat-list-item__surface") ?? m, y = getComputedStyle(v), b = m.style.display, x = u.indexOf(n.record);
		g.setAttribute("aria-hidden", "true"), g.setAttribute("data-mat-list-drag-placeholder", ""), g.style.blockSize = `${h.height}px`, g.style.inlineSize = `${h.width}px`, $i(g, y), e.root.value.insertBefore(g, m), m.style.display = "none", o = {
			record: n.record,
			source: m,
			sourceDisplay: b,
			placeholder: g,
	...
	function A(e) {
		if (a && e.pointerId === a.pointerId) {
			Math.hypot(e.clientX - a.clientX, e.clientY - a.clientY) > Vi && S();
			return;
		}
	...
	function I(t) {
		...
		i?.record && (S(), a = {
			...
			clientX: t.clientX,
			clientY: t.clientY,
			timer: globalThis.setTimeout(k, Bi)
		}, O());
	}
	function L(e) {
...
var ra = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	emits: {
		...
		"update:expanded"(e) {
			return Array.isArray(e) && e.every(Fi);
		},
		reorder(e) {
	...
	setup(e, { expose: n, emit: r }) {
		let c = $("list", e), l = r, u = j(null), d = i(() => Ni(c.interaction)), f = i(() => d.value ? "div" : "ul"), { colorStyle: p } = dt(i(() => c.color)), { colorStyle: m } = dt(i(() => c.activeColor)), h = i(() => Object.fromEntries(Object.entries(m.value).map(([e, t]) => [e.replace("accent", "active"), t]))), g = i(() => ({
			...p.value,
			...h.value
		})), y = [], b = [
		...
		}), { calculate: R, getItemKey: ee, getScroller: B, paddingBottom: V, paddingTop: U, refresh: G, scrollTo: te, scrollToIndex: K, setItemRef: q, visibleItems: J } = Ri({
			root: u,
			props: c,
			enabled: i(() => c.virtual),
		...
		return O(ji, {
			...
			default: W(() => [z(c).virtual ? Y.value > 0 ? (D(), s(t, { key: 1 }, [
				ne.value ? P(e.$slots, "default", {
					...
					itemRef: (e) => z(q)(ne.value.index, e),
					isFirst: !0,
					isLast: Y.value === 1
				}, void 0, !0) : o("", !0),
...
}), [["__scopeId", "data-v-fa306a6f"]]), ia = Symbol("mat-expansion"), aa = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatExpansion",
	inheritAttrs: !1
}, {
	__name: "MatExpansion",
	props: {
		modelValue: {
			...
			default: void 0,
			validator(e) {
				return e == null ? !0 : Array.isArray(e) ? e.every(Fi) : Fi(e);
			}
		},
		multiple: {
			type: Boolean,
...
}), [["__scopeId", "data-v-f96e5c0a"]]), oa = ["data-line-count"], sa = ["inert"], ca = ["inert"], la = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatItemContentBase" }, {
	...
	setup(e) {
		return (t, n) => (D(), s("span", {
			...
			}, [P(t.$slots, "leading", {}, void 0, !0)], 10, sa)) : o("", !0),
			c("span", {
			...
			t.$slots.trailing && !e.separateTrailing ? (D(), s("span", {
				...
				inert: e.presentationSlots ? "" : void 0
			}, [P(t.$slots, "trailing", {}, void 0, !0)], 10, ca)) : o("", !0)
		], 10, oa));
	}
}), [["__scopeId", "data-v-3223d16a"]]), ua = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatListItemContent" }, {
...
}), [["__scopeId", "data-v-c5a4a0b9"]]), da = [
	"id",
	"aria-disabled",
	"data-mat-list-disabled"
], fa = ["aria-disabled", "data-mat-list-disabled"], pa = ["aria-disabled", "data-mat-list-disabled"], ma = ["inert"], ha = ["inert"], ga = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatListItem",
	inheritAttrs: !1
}, {
	__name: "MatListItem",
	...
	setup(e, { emit: t }) {
		...
		return T(async () => {
			...
			te(), u?.requestDragValidation?.(), await v(), u?.requestFocusRefresh();
		...
		]), 1032, ["line-count"])], 16, da)) : z(f) ? (D(), a(ke, _({
			key: 1,
			ref_key: "itemRoot",
			ref: O
		}, e.$attrs, {
		...
		]), 1032, ["line-count"])], 16, fa)), [[z(Oe), { color: "var(--mat-action-state-color, currentcolor)" }]]) : g.value ? G((D(), s("li", {
			key: 3,
			ref_key: "itemRoot",
			ref: O,
			...
			onPointerdown: U
		}, [P(e.$slots, "trailing", {}, void 0, !0)], 40, ma)) : o("", !0)], 10, pa)), [[z(Oe), b.value ? { color: "var(--mat-action-state-color, currentcolor)" } : void 0]]) : (D(), a(ke, _({
			key: 4,
			ref_key: "itemRoot",
			ref: O
		}, e.$attrs, {
			...
			default: W(() => [d(ua, {
				...
				inert: z(n).disabled ? "" : void 0,
				onPointerdown: U
			}, [P(e.$slots, "trailing", {}, void 0, !0)], 40, ha)) : o("", !0)]),
			_: 3
		}, 16, [
			"class",
			"data-mat-list-disabled",
...
}), [["__scopeId", "data-v-5efcd385"]]), _a = /*@__PURE__*/ Object.assign({ name: "MatListGroupActivatorProvider" }, {
	...
	setup(e) {
		return O(Mi, e.context), (e, t) => P(e.$slots, "default");
	}
}), va = [
	"role",
	"aria-hidden",
	...
	setup(n) {
		let r = $("listGroup", n), o = h(ji, null), s = V(), l = j(null), u = j(!1), f = j(null), p = Symbol("mat-list-group"), m = B().replace(/[^\w-]/g, "-"), y = `mat-list-group-${m}-content`, b = `mat-list-group-${m}-label`, x = !1, S, w = i(() => r.value !== void 0), O = i(() => o?.isSelectable.value ?? !1), k = i(() => w.value ? o?.isGroupExpanded(r.value) ?? !1 : u.value);
		function A(n) {
		...
		let M = i(() => {
			...
			let t = e[0].type;
			return t === ga || typeof t == "object" && (t.name === "MatListItem" || t.__name === "MatListItem");
	...
	setup(e, { emit: t }) {
		let n = $("expansionPanel", e), r = t, o = f(), c = h(ia, null), l = "expansion-panel-" + B().replace(/[^\w-]/g, "-"), p = i(() => n.value === void 0 ? l : n.value), m = i(() => n.disabled || !!c?.disabled.value), g = i(() => n.color || c?.color.value), v = i(() => c?.variant.value ?? "segmented"), { colorStyle: b, hasExplicitColor: x } = dt(i(() => n.color || c?.color.value)), S = i(() => {
			let e = o?.vnode?.props ?? {};
		...
		return (e, t) => z(c) ? (D(), a(ya, _({ key: 0 }, e.$attrs, {
			value: p.value,
			as: z(n).as,
			...
			activator: W(({ expanded: t }) => [P(e.$slots, "activator", { expanded: t }, () => [d(ga, { disabled: m.value }, {
				trailing: W(() => [d(ht, {
					icon: "expand_more",
			...
			default: W(() => [z(n).split ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s("div", ba, [P(e.$slots, "default", {}, void 0, !0)]))]),
			_: 3
		}, 16, [
			"value",
			"as",
			...
			default: W(() => [d(ya, _(e.$attrs, {
				...
				default: W(() => [z(n).split ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s("div", xa, [P(e.$slots, "default", {}, void 0, !0)]))]),
				_: 3
			}, 16, [
				"value",
				"class",
...
}), [["__scopeId", "data-v-75c0236c"]]), Ca = Symbol("mat-menu"), wa = Symbol("mat-menu-item"), Ta = Symbol("mat-menu-group");
function Ea(e, t, n) {
	return Math.abs((e.x * (t.y - n.y) + t.x * (n.y - e.y) + n.x * (e.y - t.y)) / 2);
}
function Da(e, t, n, r = "right") {
	let i = r === "left" ? n.right : n.left, a = {
		...
		x: i,
		y: n.bottom
	}, s = Ea(t, a, o), c = Ea(e, a, o), l = Ea(t, e, o), u = Ea(t, a, e);
...
var ka = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatDivider",
	inheritAttrs: !1
}, {
	__name: "MatDivider",
	...
	setup(e) {
		let t = $("divider", e), n = h(ji, null), r = h(Ca, null), o = i(() => !!n), s = i(() => !!r), c = i(() => n?.isSelectable.value ?? !1), l = i(() => t.inset === !0 ? "middle" : t.inset === !1 ? "none" : t.inset), u = i(() => o.value ? c.value ? "div" : "li" : s.value ? "div" : "hr");
...
}), [["__scopeId", "data-v-88c82c06"]]), Aa = { class: "mat-selection-control__target" }, ja = [
	"aria-checked",
	"checked",
	"disabled",
	"indeterminate",
	...
	setup(e, { expose: t, emit: n }) {
		...
		return t({
			...
			c("span", Ma, [P(t.$slots, "indicator", {}, void 0, !0)])
		]), z(u).default ? (D(), s("span", Na, [P(t.$slots, "default", {}, void 0, !0)])) : o("", !0)], 16));
	}
}), [["__scopeId", "data-v-5041102c"]]), Fa = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatCheckbox",
	inheritAttrs: !1
}, {
	__name: "MatCheckbox",
...
var Ra = ["data-dot"], za = ["data-dot"], Ba = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBadge",
	inheritAttrs: !1
}, {
	__name: "MatBadge",
	...
	setup(e) {
		...
		}), R(u.value), 17, Ra)) : a.value ? o("", !0) : (D(), s("span", _({ key: 1 }, z(n), { class: "mat-badge" }), [P(e.$slots, "default", {}, void 0, !0), l.value ? (D(), s("span", {
			key: 0,
			class: y(["mat-badge__indicator", [`mat-badge__indicator--${z(t).location}`, { "mat-badge__indicator--dot": z(t).dot }]]),
			style: x(f.value),
			"aria-hidden": "true",
			"data-dot": z(t).dot ? "" : void 0
		}, R(u.value), 15, za)) : o("", !0)], 16));
	}
}), [["__scopeId", "data-v-9406a351"]]), Va = Symbol("mat-chip-set"), Ha = {
	key: 0,
	...
	"aria-hidden": "true",
	inert: ""
}, Wa = { class: "mat-chip__label" }, Ga = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatChip",
	inheritAttrs: !1
}, {
	__name: "MatChip",
	...
	setup(e, { emit: t }) {
		let n = $("chip", e), r = t, l = V(), u = h(Ne, Me), d = h(Va, null), f = i(() => ["filter", "input"].includes(n.variant)), p = i(() => !!d && f.value && n.value !== void 0 && d.selection.value !== "none"), m = i(() => p.value ? d.isSelected(n.value) : f.value && n.selected), g = i(() => !!l.avatar), v = i(() => !g.value && !!l.leading), y = i(() => n.variant === "filter" && m.value && !g.value && !v.value && !n.hideSelectedIcon), b = i(() => g.value || v.value || y.value), x = i(() => n.variant === "input"), { colorStyle: S, hasExplicitColor: C } = dt(i(() => n.color));
		function w(e) {
		...
		return (e, t) => (D(), a(ke, _(e.$attrs, {
			...
			default: W(() => [
				g.value ? (D(), s("span", Ha, [P(e.$slots, "avatar", {}, void 0, !0)])) : v.value || y.value ? (D(), s("span", Ua, [v.value ? P(e.$slots, "leading", { key: 0 }, void 0, !0) : (D(), a(ht, {
					key: 1,
					as: "span",
					icon: "check",
					"optical-size": 20,
				...
				c("span", Wa, [P(e.$slots, "default", {}, void 0, !0)]),
				x.value ? (D(), s("span", {
					key: 2,
...
}), [["__scopeId", "data-v-f6054847"]]), Ka = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatScrollArea",
	inheritAttrs: !1
}, {
	...
	setup(e, { expose: t, emit: n }) {
		...
		function se(e) {
			e.pointerId === S && (h.value && re(), ie(!0));
		}
		function ce(e) {
			e.pointerId === S && ie(!0);
		}
		function Z(e) {
			e.target !== f.value || e.pointerId !== S || (h.value && re(), ie());
		}
		function le(e) {
		...
		return O(Li, {
			...
			b !== void 0 && cancelAnimationFrame(b), x?.disconnect(), ie(!0), X();
		}), t({
			getScroller: de,
			scrollTo: fe
		}), (e, t) => (D(), s("div", _({
...
}), [["__scopeId", "data-v-f222c54b"]]), qa = { class: "mat-chip-set__scroll-content" }, Ja = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatChipSet" }, {
	__name: "MatChipSet",
	props: {
		layout: {
			type: String,
		...
		modelValue: {
			...
			default: null,
			validator(e) {
				return e === null || Fi(e) || Array.isArray(e) && e.every(Fi);
			}
		}
	},
	emits: { "update:modelValue"(e) {
	...
	setup(e, { emit: t }) {
		...
		return O(Va, {
			...
			default: W(() => [c("div", qa, [P(e.$slots, "default", {}, void 0, !0)])]),
			_: 3
		})) : P(e.$slots, "default", { key: 1 }, void 0, !0)], 2));
	}
}), [["__scopeId", "data-v-e907c0ea"]]), Ya = Symbol("mde-vue-radio-group"), Xa = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatRadio",
	inheritAttrs: !1
}, {
	__name: "MatRadio",
	...
	setup(e, { emit: t }) {
		let n = $("radio", e), r = t, o = f(), s = h(Ya, null), l = j(null), u = i(() => n.value), d = i(() => n.disabled || !!s?.disabled.value), p = i(() => n.color ?? s?.color.value), m = i(() => s ? s.isSelected(n.value) : Object.is(n.modelValue, n.value));
		function g(e) {
...
}), [["__scopeId", "data-v-dae1f87b"]]), Za = ["aria-disabled"], Qa = { class: "mat-radio-group__label mat-sys-typescale-title-medium" }, $a = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatRadioGroup",
	inheritAttrs: !1
}, {
	...
	setup(e, { emit: t }) {
		...
		return O(Ya, {
			...
			style: d.value,
			role: "radiogroup"
		}), [c("legend", Qa, R(z(n).label), 1), P(e.$slots, "default", {}, void 0, !0)], 16, Za));
	}
}), [["__scopeId", "data-v-77c4f2f2"]]), eo = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSwitch",
	inheritAttrs: !1
}, {
	__name: "MatSwitch",
...
}), [["__scopeId", "data-v-6efac2c1"]]), to = Object.freeze(["horizontal", "vertical"]), no = Object.freeze([
	"extra-small",
	"small",
	"medium",
	"large",
	"extra-large"
]), ro = Object.freeze(["standard", "centered"]), io = 12;
function ao(e) {
...
function uo(e) {
	return Array.isArray(e) && e.length === 2 && e.every(ao);
}
function fo(e) {
...
function po(e, t) {
	return Number(e.toFixed(Math.min(io, t)));
}
function mo(e, t) {
	let n = ao(e) ? e : 0, r = ao(t) ? t : 100;
	return {
		min: n,
		max: r > n ? r : n + 1
	};
...
function _o(e, t, n) {
	let r = go(ao(e) ? e : t.min, t), i = Math.round((r - t.min) / n), a = Math.max(fo(t.min), fo(t.max), fo(n));
	return po(go(t.min + i * n, t), a);
}
function vo(e, t, n) {
	return _o(ao(e) ? e : (t.min + t.max) / 2, t, n);
}
function yo(e, t) {
	return po((go(e, t) - t.min) / (t.max - t.min) * 100, 3);
}
function bo(e) {
	return Number(e.toFixed(3)).toString();
}
function xo(e) {
	let t = Math.min(Math.max(e, 0), 100), n = bo(t), r = po(6 * (1 - t * 2 / 100), 3);
	return t === 0 ? "6px" : t === 100 ? "calc(100% - 6px)" : r === 0 ? `${n}%` : `calc(${n}% ${r > 0 ? "+" : "-"} ${bo(Math.abs(r))}px)`;
}
function So(e, t) {
	let n = Math.floor((e.max - e.min) / t), r = Math.max(fo(e.min), fo(e.max), fo(t)), i = Array.from({ length: n + 1 }, (n, i) => po(e.min + i * t, r));
...
function Co(e, t, n, r, i) {
	...
	return _o(n.min + (n.max - n.min) * u, n, r);
}
function wo(e, t, n, r) {
	if (t === "Home") return n.min;
	if (t === "End") return _o(n.max, n, r);
	let i = {
		ArrowDown: -1,
		ArrowLeft: -1,
		ArrowRight: 1,
	...
	if (i !== void 0) return _o(e + i * r, n, r);
}
function To(e, t, n, r) {
	let i = _o(e, n, r), a = _o(t, n, r);
	return i <= a ? [i, a] : [a, i];
}
//#endregion
...
var Eo = {
	...
	"aria-hidden": "true"
}, Do = { class: "mat-slider__inset-icon-layer" }, Oo = { class: "mat-slider__inset-icon-layer mat-slider__inset-icon-layer--active" }, ko = [
	"aria-label",
	"aria-orientation",
	"aria-valuemax",
	"aria-valuemin",
	...
	setup(e, { emit: n }) {
		let r = $("slider", e), l = n, f = ee(), p = V(), m = j(null), g = j(null), v = j(null), b = j(null), S = j(!1), w = j(void 0), E = j(void 0), O = j(!1), k = j(!1), A = j("active"), M = h(Ne, Me), { colorStyle: F } = dt(i(() => r.color)), I = i(() => mo(r.min, r.max)), L = i(() => ho(r.step)), B = i(() => _o(r.modelValue, I.value, L.value)), U = i(() => S.value ? E.value : B.value), G = i(() => vo(r.center, I.value, L.value)), te = i(() => r.variant === "centered" ? G.value : I.value.min), K = i(() => yo(U.value, I.value)), q = i(() => yo(te.value, I.value)), J = i(() => xo(K.value)), Y = i(() => r.variant === "standard" ? "0%" : xo(q.value)), ne = i(() => Math.sign(K.value - q.value)), X = i(() => ne.value >= 0 ? Y.value : `calc(${J.value} + var(--mat-slider-handle-track-gap))`), re = i(() => ne.value > 0 ? `max(0px, calc(${J.value} - ${Y.value} - var(--mat-slider-handle-track-gap)))` : ne.value < 0 ? `max(0px, calc(${Y.value} - ${J.value} - var(--mat-slider-handle-track-gap)))` : "0px"), ie = i(() => ne.value > 0 ? Y.value : `max(0px, calc(${J.value} - var(--mat-slider-handle-track-gap)))`), ae = i(() => ne.value < 0 ? Y.value : `calc(${J.value} + var(--mat-slider-handle-track-gap))`), oe = i(() => ne.value < 0 ? `calc(100% - ${Y.value})` : `max(0px, calc(100% - ${J.value} - var(--mat-slider-handle-track-gap)))`), se = i(() => r.showStopIndicator ? So(I.value, L.value) : r.variant === "centered" ? [I.value.min, I.value.max] : [I.value.max]), ce = i(() => r.insetIcon !== void 0 && [
			"medium",
			"large",
			"extra-large"
		].includes(r.size)), Z = i(() => r.size === "extra-large" ? 32 : 24), le = i(() => r.showValueIndicator && (S.value || k.value)), ue = i(() => ({
			...F.value,
		...
		function de() {
			if (!ce.value || r.variant !== "standard" || !m.value) {
				A.value = "active";
				return;
			}
		...
		function me(e) {
			return v.value ? pe(Co(e, v.value, I.value, L.value, r.orientation), e) : !1;
		}
		let he = zi((e) => {
		...
		function ye(e) {
			...
			let t = wo(B.value, e.key, I.value, L.value);
		...
		return (n, i) => (D(), s("div", _({
			...
			c("span", Eo, [
				...
				(D(!0), s(t, null, N(se.value, (e) => (D(), s("span", {
					key: e,
					class: y(["mat-slider__stop", { "mat-slider__stop--active": e >= Math.min(te.value, U.value) && e <= Math.max(te.value, U.value) }]),
					style: x({ "--mat-slider-stop-position": z(xo)(z(yo)(e, I.value)) })
				}, null, 6))), 128)),
				ce.value && z(r).variant === "standard" ? (D(), a(ht, {
					key: 0,
					...
					"icon",
					"optical-size"
				])) : ce.value ? (D(), s(t, { key: 1 }, [c("span", Do, [d(ht, {
					...
					size: "var(--mat-slider-current-inset-icon-size)",
					"aria-hidden": "true"
				}, null, 8, ["icon", "optical-size"])]), c("span", Oo, [d(ht, {
	...
	"step",
	"value"
], Po = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatRangeSlider",
	inheritAttrs: !1
}, {
	...
	setup(e, { emit: n }) {
		let r = $("rangeSlider", e), a = n, o = ee(), l = V(), f = j([]), p = j(null), m = j(null), g = j(null), v = j(0), b = j(void 0), S = j(!1), w = j(void 0), T = j(void 0), E = j(!1), O = h(Ne, Me), { colorStyle: k } = dt(i(() => r.color)), A = i(() => mo(r.min, r.max)), M = i(() => ho(r.step)), F = i(() => To(r.modelValue?.[0], r.modelValue?.[1], A.value, M.value)), I = i(() => S.value ? T.value : F.value), L = i(() => yo(I.value[0], A.value)), B = i(() => yo(I.value[1], A.value)), H = i(() => xo(L.value)), U = i(() => xo(B.value)), G = i(() => r.showStopIndicator ? So(A.value, M.value) : [A.value.min, A.value.max]), te = i(() => f.value[v.value] ?? null), K = i(() => I.value[v.value]), q = i(() => r.showValueIndicator && (S.value || b.value === v.value)), J = i(() => ({
			...k.value,
		...
		function re(e) {
			if (!p.value) return !1;
			let t = Co(e, p.value, A.value, M.value, r.orientation);
		...
		function oe(e) {
			!S.value || e.pointerId !== w.value || ie.schedule(e);
		}
		function se(e, t) {
			!S.value || e.pointerId !== w.value || (t ? (ie.flush(), E.value = re(e) || E.value) : ie.cancel(), t && E.value && a("change", e), S.value = !1, E.value = !1, w.value = void 0, T.value = void 0);
		}
		C(() => {
			ie.cancel();
		});
		function ce(e, t) {
			if (r.disabled) return;
			let n = wo(F.value[e], t.key, A.value, M.value);
		...
		return (e, n) => (D(), s("div", _(z(o), {
			...
			c("span", jo, [
				...
				(D(!0), s(t, null, N(G.value, (e) => (D(), s("span", {
					...
					style: x({ "--mat-range-slider-stop-position": z(xo)(z(yo)(e, A.value)) })
				}, null, 6))), 128)),
...
}), [["__scopeId", "data-v-6c96f4bf"]]), Fo = ["inert", "aria-hidden"], Io = { class: "mat-text-input__container" }, Lo = {
	key: 0,
	...
	key: 0,
	"aria-hidden": "true"
}, Uo = { class: "mat-text-input__control-row" }, Wo = {
	key: 0,
...
}, qo = { class: "mat-text-input__supporting-text" }, Jo = {
	key: 0,
	class: "mat-text-input__counter"
}, Yo = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: t }) {
		...
		H(() => n.modelValue, (e) => {
			...
			U(), !(n.control === "custom" || typeof globalThis.ResizeObserver != "function") && (L = new globalThis.ResizeObserver(te), L.observe(p.value.getInput()));
		}), C(() => {
			L?.disconnect();
		});
		function K() {
		...
		return (t, n) => (D(), s("div", {
			...
			e.variant === "outlined" ? (D(), s("fieldset", Lo, [E.value && e.label ? (D(), s("legend", Ro, [u(R(e.label), 1), e.required ? (D(), s("span", zo, " *")) : o("", !0)])) : o("", !0)])) : o("", !0),
			e.variant === "filled" ? (D(), s("span", Bo)) : o("", !0),
			t.$slots.leading ? (D(), s("span", Vo, [P(t.$slots, "leading", {}, void 0, !0)])) : o("", !0),
			(D(), a(F(e.control === "custom" ? "div" : "label"), {
				...
				default: W(() => [e.label ? (D(), s("span", {
				...
				}, [u(R(e.label), 1), e.required ? (D(), s("span", Ho, " *")) : o("", !0)], 2)) : o("", !0), c("span", Uo, [
					e.prefixText ? (D(), s("span", Wo, R(e.prefixText), 1)) : o("", !0),
					...
					e.suffixText ? (D(), s("span", Go, R(e.suffixText), 1)) : o("", !0)
				])]),
				_: 3
			}, 8, ["for"])),
			t.$slots.trailing ? (D(), s("span", Ko, [P(t.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
		]), k.value ? (D(), s("span", {
			key: 0,
			id: h,
			class: "mat-text-input__supporting mat-sys-typescale-body-small"
		}, [c("span", qo, R(O.value), 1), e.maxLength === void 0 ? o("", !0) : (D(), s("span", Jo, R(e.modelValue.length) + " / " + R(e.maxLength), 1))])) : o("", !0)], 14, Fo));
	}
}), [["__scopeId", "data-v-ca1b6083"]]), Xo = ["filled", "outlined"], Zo = {
	modelValue: {
		type: String,
		default: ""
	},
...
}), $o = 200, es = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenu",
	inheritAttrs: !1
}, {
	__name: "MatMenu",
	...
	emits: { "update:modelValue": (e) => typeof e == "boolean" },
	setup(e, { emit: n }) {
		let r = $("menu", e), a = n, c = ee(), l = V(), u = h(wa, null), f = h(Ca, null), p = h(It, null), m = j(null), g = j(null), y = j(null), b = L(null), S = i(() => y.value?.root ?? y.value?.$el ?? null), w = B().replace(/[^\w-]/g, "-"), k = i(() => c.id ?? `${w}-menu`), A = `--mat-menu-anchor-${w}`, M = j(!1), N = j("closed"), F = f?.pointerHistory ?? {
			current: {
				x: 0,
				y: 0
			},
		...
		}, I = j(0), R = /* @__PURE__ */ new Map(), U = null, G = !1, te = !1, K = !1, q = Pt(), J = Ft({ motion: q }), Y, ne, X = null, re = !1, ie = !1, ae = i(() => !!u), ce = i(() => !!l.activator), Z = i(() => !ae.value && !ce.value && we(r.anchor)), le = i(() => I.value > 0), ue = i(() => !ae.value && r.scrim), de = i(() => !ue.value || !!p), fe = i(() => ue.value ? "manual" : "auto"), pe = i(() => ae.value ? M.value : r.modelValue), me = i(() => r.variant ?? f?.variant.value ?? "standard"), he = i(() => r.color ?? f?.color.value), ge = i(() => r.closeOnClick), { colorStyle: _e } = dt(he), ve = i(() => {
			...
			let [e, t] = we(r.offset) ? r.offset : [0, 0], n = {
				...
				positionAnchor: Z.value ? "auto" : A
			};
			return Z.value && we(r.anchor) && (n.left = `${r.anchor[0]}px`, n.top = `${r.anchor[1]}px`), n;
		}), be = i(() => {
			let e = b.value;
			if (e) return {
		...
		function De() {
			let e = Te();
			return e ? U === e ? e : (Ee(), U = e, oe(e, A), e) : null;
		}
		function Oe() {
			q.cancel();
		}
		function Q() {
			!ue.value || !g.value || te || (te = !0, g.value.showPopover?.());
		}
		function ke() {
			te && (te = !1, g.value?.hidePopover?.());
		}
		function Ae() {
			S.value && G && (G = !1, K = !0, S.value.hidePopover?.()), ke(), N.value = "closed";
		}
		function je() {
			ke(), N.value = "closed";
		}
		...
		async function Le() {
			...
			if (!S.value || !t) {
				ae.value || (console.warn(ce.value ? "MatMenu: activator Slot 必须只渲染一个当前 document 中的 HTMLElement 根节点" : "MatMenu: modelValue 为 true 时必须通过 anchor 提供元素 id 或视口坐标"), a("update:modelValue", !1));
				return;
			}
			G || (Z.value && document.activeElement instanceof HTMLElement && (X = document.activeElement), Q(), G = !0, S.value.showPopover?.()), N.value = "open", ae.value && (u.submenuOpen.value = !0), Ce.refresh(), Ce.focusFirst(), Ie();
		}
		function Re() {
			let e = Te() ?? X;
			X = null, v(() => e?.focus());
		...
		function Be({ focus: e = !0, immediate: t = !1 } = {}) {
			ze({ immediate: t }), ae.value ? (M.value = !1, u.submenuOpen.value = !1) : a("update:modelValue", !1), Ne({ immediate: t }), e && Re();
		}
		function Ve() {
			if (f) {
				f.closeTree();
		...
		function We() {
			...
			Oa(Array.from(R.values()).filter((e) => !e.grouped), t);
		}
		function Ge(e) {
		...
		function Xe() {
			...
			for (let n of R.values()) {
				...
				if (Da(e, t, o, o.left < a.left ? "left" : "right")) return !0;
			}
			return !1;
		}
		function Ze(e) {
			let t = getComputedStyle(S.value).direction === "rtl" ? "ArrowRight" : "ArrowLeft";
			e.key === "ArrowDown" || e.key === "ArrowUp" ? (e.preventDefault(), Ce.move(e.target, e.key === "ArrowDown" ? 1 : -1)) : e.key === "Home" ? (e.preventDefault(), Ce.focusFirst()) : e.key === "End" ? (e.preventDefault(), Ce.focusLast()) : e.key === "Escape" || ae.value && e.key === t ? (e.preventDefault(), Be()) : e.key === "Tab" && Ve();
		}
		function Qe(e) {
			...
			let t = K;
			K = !1, ze(), ae.value && (M.value = !1, u.submenuOpen.value = !1), !(!pe.value || t) && (Me(), ae.value || a("update:modelValue", !1), Re());
		}
		O(Ca, {
			...
			We(), !(ae.value || !pe.value || Z.value) && Te() !== U && (Ee(), Le());
		}), C(() => {
		...
		function nt() {
			f || !de.value || ie || (document.addEventListener("pointerdown", Ue, !0), ie = !0);
		}
		function rt() {
			ie &&= (document.removeEventListener("pointerdown", Ue, !0), !1);
		}
		return H(pe, (e) => {
			e ? (et(), nt(), Le()) : (tt(), rt(), Ne());
		}), H(() => r.anchor, async () => {
			...
			ae.value || (S.value && G && (G = !1, K = !0, S.value.hidePopover?.()), ke(), rt(), await v(), pe.value && (nt(), await Le()));
		}), p && H(p.publicContext.layout, Ie), (e, n) => (D(), s(t, null, [
			!ae.value && ce.value ? (D(), s("span", {
				key: 0,
				ref_key: "activatorHost",
				ref: m,
				class: "mat-menu__activator"
			}, [P(e.$slots, "activator", {}, void 0, !0)], 512)) : o("", !0),
			!ae.value && z(r).scrim ? (D(), s("div", {
				key: 1,
...
}), [["__scopeId", "data-v-3766e101"]]), ts = { class: "mat-menu-item-host" }, ns = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenuItem",
	inheritAttrs: !1
}, {
	__name: "MatMenuItem",
	...
	setup(e, { emit: t }) {
		let n = $("menuItem", e), r = t, c = V(), u = h(Ca, null), f = h(Ta, null), p = h(Ne, Me), m = j(null), g = i(() => m.value?.root ?? m.value?.$el ?? null), v = j(!1), y = j(void 0), b = j("only"), x = i(() => !!f), S, w = i(() => !!c.submenu);
		...
		}), (e, t) => (D(), s("span", ts, [z(n).tooltip ? (D(), a(wn, {
			key: 0,
			content: z(n).tooltip
		}, {
			activator: W(() => [d(ke, _({
...
}), [["__scopeId", "data-v-76262001"]]), rs = ["aria-labelledby"], is = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenuGroup",
	inheritAttrs: !1
}, {
	__name: "MatMenuGroup",
	...
	setup(e) {
		let t = $("menuGroup", e), n = ee(), r = h(Ca, null), a = `${B().replace(/[^\w-]/g, "-")}-label`, c = i(() => t.label ? a : n["aria-labelledby"]), l = j(null), u = /* @__PURE__ */ new Set();
		function d() {
		...
		}, R(z(t).label), 1)) : o("", !0), P(e.$slots, "default", {}, void 0, !0)], 16, rs));
	}
}), [["__scopeId", "data-v-b34883b5"]]), as = [
	"id",
	"aria-describedby",
	"aria-label",
	"aria-disabled",
	...
	emits: {
		"update:modelValue": (e) => e === null || Fi(e) || Array.isArray(e) && e.every(Fi),
		change: (e) => e === null || Fi(e) || Array.isArray(e) && e.every(Fi)
	},
	setup(e, { emit: n }) {
		...
		function E(e, t) {
			...
			return typeof n != "string" || !Fi(i) ? null : {
		...
		return (e, n) => (D(), s("div", {
			...
			d(Yo, {
				...
				control: W(({ controlId: i, describedBy: o }) => [c("div", {
					...
					z(r).chips && M.value ? (D(), s("span", os, [(D(!0), s(t, null, N(k.value, (e) => (D(), a(Ga, {
						...
						"disabled",
						"onRemove"
					]))), 128))])) : M.value ? (D(), s("span", ss, R(A.value), 1)) : (D(), s("span", cs, R(z(r).placeholder), 1)),
			...
			c("select", _(T.value, {
				...
				value: "",
				selected: !M.value
			}, null, 8, us)), (D(!0), s(t, null, N(O.value.options, (e) => (D(), s("option", {
				key: `${typeof e.value}:${String(e.value)}`,
				disabled: e.disabled,
				selected: I(e.value),
				value: String(e.value)
			}, R(e.title), 9, ds))), 128))], 16, ls),
			d(es, {
				id: F,
				modelValue: g.value,
				...
				default: W(() => [O.value.groups.length === 0 ? (D(!0), s(t, { key: 0 }, N(O.value.ungrouped, (e) => (D(), a(ns, {
					key: `${typeof e.value}:${String(e.value)}`,
					disabled: e.disabled,
					...
					fn: W(() => [z(r).selectionIndicator === "check" ? (D(), a(ht, {
						...
						"optical-size": 20,
						size: "20px"
					})) : z(r).selectionIndicator === "checkbox" ? (D(), a(Fa, {
						key: 1,
						"aria-hidden": "true",
						inert: "",
						tabindex: "-1",
					...
					"tooltip",
					"onClick"
				]))), 128)) : O.value.ungrouped.length > 0 ? (D(), a(is, { key: 1 }, {
					default: W(() => [(D(!0), s(t, null, N(O.value.ungrouped, (e) => (D(), a(ns, {
						key: `${typeof e.value}:${String(e.value)}`,
						disabled: e.disabled,
						selected: z(r).selectionIndicator === "check" && I(e.value),
						tooltip: e.tooltip,
					...
					_: 1
				})) : o("", !0), (D(!0), s(t, null, N(O.value.groups, (e) => (D(), a(is, {
					key: e.label,
					label: e.label
				}, {
					default: W(() => [(D(!0), s(t, null, N(e.options, (e) => (D(), a(ns, {
						key: `${typeof e.value}:${String(e.value)}`,
						disabled: e.disabled,
						selected: z(r).selectionIndicator === "check" && I(e.value),
						tooltip: e.tooltip,
...
}), [["__scopeId", "data-v-aca83b85"]]), ps = /*@__PURE__*/ Object.assign({
	name: "MatTextarea",
	inheritAttrs: !1
}, {
	__name: "MatTextarea",
...
}), ms = { class: "mat-docked-container__panel" }, hs = ["id"], gs = { class: "mat-docked-container__body" }, _s = {
	key: 1,
	class: "mat-docked-container__actions"
}, vs = 200, ys = 150, bs = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: n }) {
		let r = Object.freeze({
			...
			medium: "328px",
			large: "560px"
		}), a = $("dockedContainer", e), l = n, f = ee(), p = V(), m = h(It, null), g = j(null), y = j(null), b = j(null), S = L(null), w = i(() => b.value?.root ?? b.value?.$el ?? null), O = B().replace(/[^\w-]/g, "-"), k = i(() => f.id ?? `${O}-docked-container`), A = i(() => `${O}-headline`), M = `--mat-docked-container-anchor-${O}`, N = j("closed"), F = null, I = !1, U = !1, G = !1, te = Pt(), K = Ft({ motion: te }), q, J, Y = null, ne = !1, X = i(() => !!p.activator), re = i(() => !X.value && ye(a.anchor)), ie = i(() => a.scrim), ae = i(() => !ie.value || !!m), ce = i(() => ie.value ? "manual" : "auto"), Z = i(() => a.modelValue), le = i(() => a.variant ?? "standard"), ue = i(() => a.color), de = i(() => a.headline !== void 0 || !!p.headline), { colorStyle: fe } = dt(ue), pe = i(() => {
			if (a.width !== void 0) {
				let e = Tt(a.width, {
					property: "inline-size",
					positive: !0
		...
		function we() {
			!ie.value || !y.value || U || (U = !0, y.value.showPopover?.());
		}
		function Te() {
		...
		async function Me() {
			...
			I || (re.value && document.activeElement instanceof HTMLElement && (Y = document.activeElement), we(), I = !0, w.value.showPopover?.()), je(), N.value = "opening", te.wait(w.value, ys, () => {
		...
		function Re(e) {
			...
			let t = G;
			G = !1, !(!Z.value || t) && (Oe(), l("update:modelValue", !1), Ne());
		}
		T(() => {
			window.addEventListener("resize", je), window.addEventListener("scroll", je, {
				capture: !0,
				passive: !0
			}), Z.value && ze(), typeof ResizeObserver < "u" && w.value && (J = new ResizeObserver(je), J.observe(w.value)), Z.value && Me();
		}), E(() => {
			!Z.value || re.value || be() !== F && (xe(), Me());
		}), C(() => {
		...
		function ze() {
			!ae.value || ne || (document.addEventListener("pointerdown", Ie, !0), ne = !0);
		}
		function Be() {
		...
		return H(Z, (e) => {
			...
			w.value && I && (I = !1, G = !0, w.value.hidePopover?.()), Te(), Be(), await v(), Z.value && (ze(), await Me());
			...
			d(gi, _({
				...
				default: W(() => [c("div", ms, [
					...
					}, [e.$slots.headline ? P(e.$slots, "headline", { key: 0 }, void 0, !0) : z(a).headline === void 0 ? o("", !0) : (D(), s(t, { key: 1 }, [u(R(z(a).headline), 1)], 64))], 8, hs)) : o("", !0),
					c("div", gs, [P(e.$slots, "default", {}, void 0, !0)]),
					e.$slots.actions ? (D(), s("footer", _s, [P(e.$slots, "actions", {}, void 0, !0)])) : o("", !0)
				])]),
				_: 3
			}, 16, [
				"id",
...
}), [["__scopeId", "data-v-33472a63"]]), xs = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSpacer",
	inheritAttrs: !1
}, {
	__name: "MatSpacer",
...
}), [["__scopeId", "data-v-cf9d6504"]]), Ss = { class: "mat-dialog__header" }, Cs = {
	key: 1,
	class: "mat-dialog__actions"
}, ws = { class: "mat-dialog__content-body" }, Ts = {
	key: 0,
	class: "mat-dialog__icon"
}, Es = { class: "mat-dialog__content-body" }, Ds = {
	key: 3,
	class: "mat-dialog__actions"
}, Os = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatDialog",
	inheritAttrs: !1
}, {
	__name: "MatDialog",
	...
	setup(e, { emit: r }) {
		let l = $("dialog", e), p = r, m = ee(), g = V(), y = f(), b = h(It, null), S = Object.prototype.hasOwnProperty.call(y?.vnode.props ?? {}, "attach"), w = j(null), E = j(null), O = j(!1), k = j("closed"), A = j(null), M = L(null), N = `${B().replace(/[^\w-]/g, "-")}-title`, F = i(() => E.value?.root ?? E.value?.$el ?? null), I = i(() => !!M.value), G = i(() => l.title !== void 0 || !!g.title), te = i(() => l.content !== void 0 || !!g.default), K = i(() => !l.fullScreen && (l.icon !== void 0 || !!g.icon)), q = i(() => !!g.activator), J = i(() => Yn.value.at(-1) === F.value), { colorStyle: Y } = dt(i(() => l.color)), ne = i(() => {
		...
		}), X = i(() => [m.style]), re = i(() => [Y.value, ne.value]), ie = !1, ae = Pt(), oe = Ft({ motion: ae }), se = null;
		mr(F, i(() => O.value && J.value));
		function ce() {
		...
		async function _e() {
			if (Z(), O.value && F.value?.open) {
				k.value = "opening", le(400, () => {
					k.value = "open", p("opened");
				});
				return;
			}
			let e = q.value ? ce() : null;
			if (q.value && !e) {
				he(), pe();
				return;
			}
			...
			se = e ?? (document.activeElement instanceof HTMLElement ? document.activeElement : null), M.value = n, A.value = r, O.value = !0, k.value = "opening", me(), await v(), !(!l.modelValue || !F.value) && (F.value.open || F.value.show(), dr(F.value, n ? fe(n.context) : void 0), ge(), le(400, () => {
				k.value = "open", p("opened");
			}));
		}
		function ve() {
			let e = F.value;
			e?.open && e.close(), e && fr(e), M.value = null, O.value = !1, k.value = "closed", v(() => {
				se?.isConnected && se.focus({ preventScroll: !0 }), se = null, p("closed");
			});
		}
		function ye() {
			!O.value || k.value === "closing" || oe.start({
				canStart: () => O.value && k.value !== "closing",
				duration: 200,
				getElement: () => F.value,
				isActive: () => ie && !l.modelValue && k.value === "closing" && O.value && !!F.value,
				onFinish: ve,
				onStart: () => {
					k.value = "closing";
				}
		...
		return T(() => {
			ie = !0, l.modelValue && _e();
		}), C(() => {
			ie = !1, Z(), F.value && (fr(F.value), F.value.open && F.value.close());
		}), H(() => l.modelValue, (e) => {
			ie && (e ? _e() : ye());
		}), H(() => l.attach, () => {
			...
			default: W(() => [c("div", {
				...
				style: x(re.value)
			}, [z(l).fullScreen ? (D(), s(t, { key: 0 }, [c("header", Ss, [
				d(In, {
				...
				d(xs),
				e.$slots.actions ? (D(), s("div", Cs, [P(e.$slots, "actions", {}, void 0, !0)])) : o("", !0)
			]), te.value ? (D(), a(Ka, {
				key: 0,
				...
				default: W(() => [c("div", ws, [z(l).content === void 0 ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(l).content), 1)], 64))])]),
				_: 3
			})) : o("", !0)], 64)) : (D(), s(t, { key: 1 }, [
				K.value ? (D(), s("div", Ts, [d(ht, {
					"optical-size": 24,
					size: "24px",
					"aria-hidden": "true"
				}, {
				...
				te.value ? (D(), a(Ka, {
					...
					default: W(() => [c("div", Es, [z(l).content === void 0 ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(l).content), 1)], 64))])]),
					_: 3
				})) : o("", !0),
				e.$slots.actions ? (D(), s("div", Ds, [P(e.$slots, "actions", {}, void 0, !0)])) : o("", !0)
			], 64))], 4)]),
			_: 3
		}, 16, [
			"class",
...
}), [["__scopeId", "data-v-7df0b89c"]]), ks = .25, As = [
	"min",
	"normal",
	"max"
];
function js({ availableExtent: e, contentExtent: t }) {
...
function Ms(e, t) {
	...
	As.includes(e.currentValue) || r.push({
...
function Ns({ availableExtent: e, extent: t, overshootLimit: n = 0 }) {
	let r = Math.max(0, e), i = Math.max(0, t);
	return i > r ? {
		offset: 0,
		size: r + Math.min((i - r) * ks, Math.max(0, n))
	} : {
		offset: Math.max(0, 64 - i),
		size: Math.min(r, Math.max(64, i))
	};
}
function Ps({ availableExtent: e, value: t }) {
	return t === "min" ? 64 : Math.max(0, e) / 2;
}
function Fs({ overshootLimit: e = 0, panelExtent: t, visibleExtent: n }) {
	let r = Math.max(0, t);
	if (n > r) {
		let t = Math.min((n - r) * ks, Math.max(0, e));
		return t > 0 ? -t : 0;
	}
	return Math.min(r, Math.max(0, r - n));
}
function Is({ distance: e, draggingDown: t, pointerType: n, velocity: r }) {
	return n !== "mouse" && t && e >= 48 && r >= .5;
}
//#endregion
//#region src/components/MatSheetBase.vue
var Ls = ["aria-label"], Rs = {
	key: 1,
	class: "mat-sheet__header"
}, zs = {
	key: 1,
	class: "mat-sheet__header-actions"
}, Bs = { class: "mat-sheet__content-body" }, Vs = {
	key: 3,
	class: "mat-sheet__footer"
}, Hs = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSheetBase",
	inheritAttrs: !1
}, {
	__name: "MatSheetBase",
	...
	setup(e, { emit: r }) {
		let l = e, p = r, m = ee(), g = V(), b = f(), S = h(It, null), w = Object.prototype.hasOwnProperty.call(b?.vnode.props ?? {}, "attach"), E = j(null), O = j(null), k = j(null), A = j(!1), M = j("closed"), N = j(null), F = L(null), I = j(typeof window > "u" ? 0 : window.innerWidth), z = 0, U = j(!1), G = j(0), te = `${B().replace(/[^\w-]/g, "-")}-title`, q = i(() => O.value?.root ?? O.value?.$el ?? null), J = i(() => !!F.value), Y = i(() => X.value ? k.value : q.value), ne = i(() => l.variant === "auto" ? I.value < jt(l.breakpoint, {
			positive: !0,
			fallback: 840
		}) ? "modal" : "standard" : l.variant), X = i(() => ne.value === "modal"), re = i(() => X.value && Yn.value.at(-1) === q.value), ie = i(() => !!g.activator), ae = i(() => l.title !== void 0 || !!g.title), oe = i(() => l.content !== void 0 || !!g.default), se = i(() => l.closable);
		function ce(e) {
			return e === "full" || e === !0 ? "full" : e === "min" || e === "max" ? e : e === "normal" || e === !1 || e === void 0 ? "normal" : wt(e, { allowNegative: !0 }) ? e : "normal";
		}
		let Z = i(() => l.direction === "bottom" ? ce(l.expanded) : l.expanded), le = i(() => l.direction !== "bottom" || Z.value === "min" || Z.value === "normal"), ue = i(() => l.direction === "bottom" && !le.value), de = i(() => l.direction === "bottom" ? Z.value === "min" ? !l.virtualExpand : Z.value !== "normal" && Z.value !== "max" : !1), fe = i(() => {
			if (!de.value || Z.value === "full") return;
			if (Z.value === "min") return "var(--mat-sheet-min-block-size)";
			let e = Tt(Z.value, {
				allowNegative: !0,
				property: "block-size"
			});
		...
		}), pe = i(() => l.direction === "bottom" && !l.virtualExpand && Z.value === "normal" ? "calc(var(--mat-sheet-full-block-size) / 2)" : void 0), me = i(() => [
			`mat-sheet__panel--${l.direction}`,
			`mat-sheet__panel--position-${l.position}`,
			{
				"mat-sheet__panel--sized": de.value,
				"mat-sheet__panel--virtual-expand": l.direction === "bottom" && l.virtualExpand,
				"mat-sheet__panel--dragging": U.value
			}
		]), he = i(() => le.value ? l.dragHandleLabel : X.value ? l.expandedDragHandleLabel : l.collapseDragHandleLabel), ge = i(() => ae.value || se.value || !!g.header || !!g.actions), _e = i(() => X.value ? "dialog" : "aside"), ve = i(() => {
			if (l.width !== void 0) return Tt(l.width, {
				property: "inline-size",
				positive: !0
			});
		}), ye = i(() => {
			if (ve.value) return { "--mat-sheet-preferred-width": ve.value };
		}), be = i(() => {
			let e = {};
			return fe.value && (e["--mat-sheet-expanded-block-size"] = fe.value), pe.value && (e["--mat-sheet-max-block-size"] = pe.value), G.value > 0 && (e["--mat-sheet-virtual-offset"] = `${G.value}px`), Object.keys(e).length > 0 ? e : void 0;
		}), xe = i(() => [
			m.style,
			ye.value,
			be.value
		]), Se = i(() => [ye.value, be.value]), Ce = !1, we = Pt(), Te = Ft({ motion: we }), Ee = null, De = !1, Oe = null, Q = 0, ke = 0, Ae = 0, je = 0, Me = 0, Ne = 0, Pe = null, Fe = 0, Ie = null, Le = 0, Re = 0, ze = null;
		mr(q, i(() => X.value && A.value && re.value));
		function Be() {
			we.cancel();
		}
		function Ve(e, t) {
		...
		let Ke = null;
		function qe() {
			return l.direction === "bottom" && l.virtualExpand && (Z.value === "min" || Z.value === "normal");
		}
		function Je() {
		...
		function Xe() {
			...
			let t = [
				...
				".mat-sheet__footer"
			].reduce((t, n) => t + (e.querySelector(n)?.getBoundingClientRect().height ?? 0), 0);
			return t > 0 ? t : e.getBoundingClientRect().height;
		}
		function Ze() {
			if (!qe()) {
				G.value = 0;
		...
		function $e() {
			if (Qe(), typeof ResizeObserver != "function" || l.direction !== "bottom" || !l.virtualExpand) return;
			let e = Y.value;
			e && (ze = new ResizeObserver(Ze), ze.observe(e));
		}
		function et(e) {
			l.direction !== "bottom" || !l.virtualExpand || ue.value || e.deltaY > 0 && (e.preventDefault(), p("update:expanded", "max"));
		}
		function tt(e) {
			l.direction !== "bottom" || !l.virtualExpand || ue.value || e.pointerType === "touch" && (Ke = e.clientY);
		}
		function nt(e) {
			l.direction !== "bottom" || !l.virtualExpand || ue.value || e.pointerType === "touch" && Ke !== null && Ke - e.clientY >= 8 && (Ke = null, p("update:expanded", "max"));
		}
		function rt(e) {
		...
		function at(e, t) {
			if (z = e, q.value?.style.setProperty("--mat-sheet-drag-offset", `${e}px`), t === null) {
		...
		function lt() {
			if (!X.value || m["aria-label"] || m["aria-labelledby"] || l.direction === "side" && ae.value) return;
		...
		async function pt() {
			if (Be(), St(), ot(), A.value) {
				M.value = "opening", await v(), Ze(), $e(), Ve(400, () => {
					M.value = "open", p("opened");
				});
				return;
			}
			let e = ie.value ? He() : null;
			if (ie.value && !e) {
				ct(), it();
				return;
			}
			if (X.value) {
				let t = Ue(), n = We(t), r = n ? n.target : t;
				if (!r) {
					ut(), it();
					return;
				}
				F.value = n, N.value = r, Ee = e ?? (document.activeElement instanceof HTMLElement ? document.activeElement : null);
			} else F.value = null;
			De = X.value, A.value = !0, M.value = "opening", lt(), await v(), !(!l.modelValue || !q.value) && (X.value && ft(), Ze(), $e(), Ve(400, () => {
				M.value = "open", p("opened");
			}));
		}
		function $() {
			De && Ee?.isConnected && Ee.focus({ preventScroll: !0 }), Ee = null, De = !1;
		}
		function mt() {
			let e = q.value;
			e instanceof HTMLDialogElement && (e.open && e.close(), fr(e)), F.value = null, A.value = !1, M.value = "closed", St(), Qe(), G.value = 0, ot(), v(() => {
				$(), p("closed");
			});
		}
		function ht() {
			A.value && M.value !== "closing" && Te.start({
				canStart: () => A.value && M.value !== "closing",
				duration: 200,
				getElement: () => q.value,
				isActive: () => Ce && !l.modelValue && M.value === "closing" && A.value && !!q.value,
				onFinish: mt,
				onStart: () => {
					M.value = "closing";
				}
		...
		function _t(e) {
			e.key === "Escape" && (e.preventDefault(), it());
		}
		function vt(e) {
		...
		function yt(e) {
			if (e.pointerId === Oe) {
				...
				at(l.position === "start" ? Math.max(0, Q - e.clientX) : Math.max(0, e.clientX - Q), null);
			}
		}
		let bt = zi(yt);
		function xt(e) {
			e.pointerId === Oe && bt.schedule(e);
		}
		function St({ keepDragging: e = !1 } = {}) {
			Oe = null, U.value = e, window.removeEventListener("pointermove", xt), window.removeEventListener("pointerup", Ot), window.removeEventListener("pointercancel", kt);
		}
		function Ct() {
			it(), v(() => {
				l.modelValue && (St(), ot());
		...
		function Et({ distance: e, velocity: t }) {
			let n = Ms({
				availableExtent: Me,
				contentExtent: je,
				currentExtent: Ae,
			...
			if (n.close || r) {
				St({ keepDragging: !0 }), Ct();
				return;
			}
			let i = n.value === Z.value || n.size === Ae;
			St(), ot(), i || p("update:expanded", n.value);
		}
		function Dt({ distance: e, threshold: t, velocity: n }) {
			let r = e >= t || e >= 20 && n >= .35;
			if (St(), r) {
				it();
				return;
		...
		function Ot(e) {
			...
			bt.flush();
			let t = Math.max(1, performance.now() - Le), n = l.direction === "bottom" ? Math.abs(Re) : z, r = n / t;
			if (l.direction === "bottom") {
				Et({
					distance: n,
					velocity: r
			...
			Dt({
				distance: n,
				threshold: Math.min(120, Math.max(48, ke * .15)),
				velocity: r
			});
		}
		function kt() {
		...
		function At(e) {
			!l.draggable || e.button !== 0 || Oe !== null || (bt.cancel(), Oe = e.pointerId, Q = l.direction === "bottom" ? e.clientY : e.clientX, ke = l.direction === "bottom" ? Y.value?.getBoundingClientRect().height ?? 0 : Y.value?.getBoundingClientRect().width ?? 0, Pe = e.pointerType ?? null, Le = performance.now(), Re = 0, l.direction === "bottom" ? (Fe = G.value, Ae = Math.max(0, ke - Fe), je = Xe(), Me = Ye(), Ne = Je(), at(0, l.virtualExpand ? null : ke)) : at(0, null), U.value = !0, window.addEventListener("pointermove", xt), window.addEventListener("pointerup", Ot), window.addEventListener("pointercancel", kt));
		}
		function Mt(e) {
			l.direction !== "side" || e.pointerType !== "touch" || e.target instanceof Element && e.target.closest("button, a, input, textarea, select, [contenteditable=\"true\"]") || At(e);
		}
		function Nt(e) {
			Ie = e.target instanceof Node ? e.target : null, X.value || Mt(e);
		}
		function Lt(e) {
			X.value && Mt(e);
		}
		...
		function zt() {
			I.value = window.innerWidth, Ze();
		}
		async function Vt(e, t) {
			if (!A.value || !l.modelValue || e === t) return;
			Be();
			let n = q.value;
			if (t === "modal" && n instanceof HTMLDialogElement && (n.open && n.close(), fr(n), $(), F.value = null), e === "modal") {
				let e = Ue(), t = We(e), n = t ? t.target : e;
				if (!n) {
					ut(), it();
					return;
				}
				F.value = t, N.value = n, Ee = document.activeElement instanceof HTMLElement ? document.activeElement : null, De = !0, lt();
			}
			M.value = "open", await v(), e === "modal" && l.modelValue && ft(), Ze(), $e();
		}
		return T(() => {
			Ce = !0, zt(), window.addEventListener("resize", zt), l.modelValue && pt();
		}), C(() => {
			bt.cancel(), Ce = !1, Be(), St(), Qe(), window.removeEventListener("resize", zt);
			let e = q.value;
			e instanceof HTMLDialogElement && (fr(e), e.open && e.close());
		}), H(() => l.modelValue, (e) => {
			Ce && (e ? pt() : ht());
		}), H(ne, Vt), H([() => l.virtualExpand, Z], async () => {
			await v(), Ze(), $e();
		}), H(() => l.attach, () => {
		...
		}, { immediate: !0 }), (r, i) => (D(), s(t, null, [ie.value ? (D(), s("span", {
			key: 0,
			ref_key: "activatorHost",
			ref: E,
			...
			style: xe.value,
			"aria-labelledby": r.$attrs["aria-labelledby"] ?? (e.direction === "side" && ae.value ? te : void 0),
			...
			default: W(() => [c("div", {
				...
				ref: k,
				class: y(["mat-sheet__panel", me.value]),
				style: x(Se.value),
				onPointerdown: Rt,
				onPointermove: nt,
				onPointerup: rt,
				...
				e.direction === "bottom" && e.dragHandle ? (D(), s("button", {
					...
					"aria-label": he.value,
					onKeydown: st,
					onPointerdown: K(At, ["stop"])
				}, [P(r.$slots, "drag-handle", {}, () => [i[0] ||= c("span", { class: "mat-sheet__drag-handle" }, null, -1)], !0)], 40, Ls)) : o("", !0),
				e.direction === "side" && ge.value ? (D(), s("header", Rs, [P(r.$slots, "header", {}, () => [
					ae.value ? (D(), s("h2", {
						key: 0,
						id: te,
					...
					r.$slots.actions ? (D(), s("div", zs, [P(r.$slots, "actions", {}, void 0, !0)])) : o("", !0),
					se.value ? (D(), a(In, {
						key: 2,
				...
				oe.value ? (D(), a(Ka, {
					...
					default: W(() => [c("div", Bs, [e.direction !== "bottom" && e.content !== void 0 ? (D(), s(t, { key: 0 }, [u(R(e.content), 1)], 64)) : r.$slots.default ? P(r.$slots, "default", { key: 1 }, void 0, !0) : e.content === void 0 ? o("", !0) : (D(), s(t, { key: 2 }, [u(R(e.content), 1)], 64))])]),
					_: 3
				})) : o("", !0),
				r.$slots.footer ? (D(), s("div", Vs, [P(r.$slots, "footer", {}, void 0, !0)])) : o("", !0)
			], 38)]),
			_: 3
		}, 16, [
			"as",
...
}), [["__scopeId", "data-v-9c1d1e01"]]), Us = /*@__PURE__*/ Object.assign({
	name: "MatBottomSheet",
	inheritAttrs: !1
}, {
...
}), Gs = { class: "mat-container__content" }, Ks = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatContainer",
	inheritAttrs: !1
}, {
	__name: "MatContainer",
	...
	setup(e) {
		let t = $("container", e);
		return (e, n) => (D(), s("div", _(e.$attrs, { class: ["mat-container", { "mat-container--fluid": z(t).fluid }] }), [c("div", Gs, [P(e.$slots, "default", {}, void 0, !0)])], 16));
	}
}), [["__scopeId", "data-v-f2274c15"]]), qs = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatLayout",
	inheritAttrs: !1
}, {
	__name: "MatLayout",
	...
	setup(e) {
		...
		let y = Hn({ scheduleMeasure: g }), b = y.registerEdge, x = {
...
}), [["__scopeId", "data-v-2fd5a61b"]]), Js = /*@__PURE__*/ Object.assign({
	...
	setup(e, { expose: n, emit: r }) {
		let i = $("virtualScroll", e), o = r, l = j(null), u = Ri({
			root: l,
			props: i,
			enabled: !0,
			pinEdges: !1,
...
}), [["__scopeId", "data-v-9159f242"]]), Xs = ["aria-valuenow"], Zs = 48, Qs = 24, $s = 240, ec = 650, tc = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatLoading",
	inheritAttrs: !1
}, {
	__name: "MatLoading",
	...
	setup(e) {
		let t = $("loading", e), { colorStyle: n } = dt(i(() => t.color)), r = j(0), a, o = 0, c, l, u = i(() => {
			...
			return Math.min(Math.max(e, Qs), $s);
			...
			...f.value,
			...g.value
		})), y = i(() => u.value * (38 / 48)), b = i(() => p.value ? h.value >= 1 ? "soft-burst" : "circle" : ai[r.value]), S = i(() => {
		...
		function k(e) {
			...
			c !== void 0 && (o += e - c), c = e;
			let t = Math.floor(o / ec) % ai.length;
...
}), [["__scopeId", "data-v-47a074d9"]]), nc = { class: "mat-pull-to-refresh__indicator" }, rc = 80, ic = .5, ac = 4, oc = 600, sc = 1600, cc = 80, lc = 700, uc = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatPullToRefresh" }, {
	...
	setup(e, { emit: t }) {
		let n = 2 * Math.sqrt(lc) * .9, r = e, a = $("pullToRefresh", r), o = t, l = h(Li, null), u = l?.scroller ?? j(null), f = l?.orientation ?? j("vertical"), p = i(() => f.value === "horizontal"), m = i(() => jt(a.triggerDistance, {
			positive: !0,
			fallback: rc
		...
		function ce(e) {
			!T || a.disabled || _.value || g.value !== "idle" || e.button !== 0 || (E = e.pointerId, O = e.clientX, k = e.clientY, A = ae(), M = !1, N = !1);
		}
		function Z(e) {
		...
		function me(e) {
			...
			e.preventDefault(), se(), F * ic >= m.value && X(!0);
		}
		function he() {
			P && (P = !1, F = 0, re());
		}
		function ge() {
			te();
			let e = T;
			e && (e.removeEventListener("pointerdown", ce), e.removeEventListener("pointermove", Z), e.removeEventListener("pointerup", ue), e.removeEventListener("pointercancel", de), e.removeEventListener("lostpointercapture", fe), e.removeEventListener("touchmove", pe), e.removeEventListener("scroll", he), e.removeEventListener("wheel", me), e.removeEventListener("click", _e, !0), T = null);
		}
		function _e(e) {
			I && (W(), e.preventDefault(), e.stopImmediatePropagation());
		}
		return H(() => u.value ?? null, (e) => {
			ge(), w.value = 0, e && (T = e, oe(), e.addEventListener("pointerdown", ce), e.addEventListener("pointermove", Z), e.addEventListener("pointerup", ue), e.addEventListener("pointercancel", de), e.addEventListener("lostpointercapture", fe), e.addEventListener("touchmove", pe), e.addEventListener("scroll", he), e.addEventListener("wheel", me, { passive: !1 }), e.addEventListener("click", _e, !0));
		}, {
			immediate: !0,
			flush: "post"
		}), H(p, () => {
...
}), [["__scopeId", "data-v-c84588cf"]]), dc = ["aria-valuemax", "aria-valuenow"], fc = ["width", "height"], pc = { key: 0 }, mc = ["width", "height"], hc = { class: "mat-progress__linear-bar mat-progress__linear-bar--primary" }, gc = ["d"], _c = { class: "mat-progress__linear-bar mat-progress__linear-bar--secondary" }, vc = ["d"], yc = ["d", "mask"], bc = { class: "mat-progress__linear-bar mat-progress__linear-bar--primary" }, xc = ["d"], Sc = { class: "mat-progress__linear-bar mat-progress__linear-bar--secondary" }, Cc = ["d"], wc = ["d"], Tc = {
	key: 1,
	class: "mat-progress__linear-stop"
}, Ec = ["viewBox"], Dc = { class: "mat-progress__circular-linear-rotate" }, Oc = { class: "mat-progress__circular-rotate-arc" }, kc = [
	"cx",
	"cy",
	"r"
], Ac = ["d"], jc = 4, Mc = 48, Nc = 24, Pc = 240, Fc = 4, Ic = 4.8, Lc = 3, Rc = 40, zc = 15, Bc = 18, Vc = 20.4, Hc = 2, Uc = 4, Wc = .001, Gc = 100, Kc = 300, qc = 900, Jc = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatProgress",
	inheritAttrs: !1
}, {
	__name: "MatProgress",
	...
	setup(e) {
		...
		function u(e, t, n, r, i) {
			...
			for (let e = s + 2; e < c; e += 2) {
				let t = (e - s) / Rc * Math.PI * 2, n = o - Math.sin(t - i) * r;
				l.push(`L ${a(e)} ${a(n)}`);
			}
			let u = (c - s) / Rc * Math.PI * 2, d = o - Math.sin(u - i) * r;
		...
		let f = $("progress", e), { colorStyle: p } = dt(i(() => f.color)), m = j(null), h = j(Gc), g = j(+(f.shape === "wavy")), v = j(0), y = `mat-progress-linear-mask-${B()}`, b, S, w, E = i(() => r(f.max) ? f.max : 1), O = i(() => f.variant === "circular"), k = i(() => f.shape === "wavy"), A = i(() => {
			let e = jt(f.size, {
				allowNegative: !0,
				fallback: Mc
			});
			return Math.min(Math.max(e, Nc), Pc);
		}), M = i(() => A.value / 12), N = i(() => M.value * 2), P = i(() => A.value / Mc), F = i(() => 1.6 * P.value), I = i(() => zc * P.value), L = i(() => Hc * P.value), R = i(() => O.value ? f.thickness === "heavy" ? N.value : M.value : f.thickness === "heavy" ? Ic : Fc), ee = i(() => {
			let e = n(f.value) ? f.value : 0;
			return Math.min(Math.max(e, 0), E.value);
		}), V = i(() => Number((ee.value / E.value * 100).toFixed(3))), U = i(() => R.value + Lc * 2 * g.value), W = i(() => Math.min(100, R.value / h.value * 100)), G = i(() => {
			let e = h.value - R.value;
			return e <= 0 ? 1 : h.value / e;
		}), te = i(() => V.value === 100 ? 100 : Math.min(100, Math.max(V.value, W.value + Wc))), K = i(() => u(h.value, U.value, R.value, 0, 0)), q = i(() => u(h.value, U.value, R.value, Lc * g.value, v.value)), J = i(() => A.value / 2), Y = i(() => (Bc + (Vc - Bc) * g.value) * P.value), ne = i(() => `0 0 ${A.value} ${A.value}`), X = i(() => d(J.value, Y.value, F.value * g.value, v.value, I.value)), re = i(() => {
			let e = Math.PI * 2 * Y.value;
			return (jc + R.value) / e * 100;
		}), ie = i(() => Math.min(12, re.value)), ae = i(() => {
		...
		}), oe = i(() => f.indeterminate ? {} : { strokeDasharray: `${a(V.value === 0 ? Wc : V.value)} 200` }), se = i(() => ({
			...p.value,
			"--mat-progress-circular-gap-progress": a(ie.value),
			"--mat-progress-circular-margin": `${L.value}px`,
			"--mat-progress-circular-radius": `${Y.value}px`,
			"--mat-progress-circular-size": `${A.value}px`,
			"--mat-progress-indicator-gap-size": `${jc}px`,
			"--mat-progress-linear-cap-progress": a(W.value),
			"--mat-progress-linear-path-scale": a(G.value),
			"--mat-progress-linear-segment-end": a(te.value),
			"--mat-progress-linear-segment-end-position": `${a(te.value)}%`,
			"--mat-progress-linear-size": `${U.value}px`,
			"--mat-progress-progress": `${V.value}`,
			"--mat-progress-stop-indicator-size": `${Uc}px`,
		...
		function ce(e) {
			...
			if (w = e, t > 0 && r !== 0) {
				let e = Math.min(Math.abs(r), t / Kc);
				g.value += Math.sign(r) * e;
			}
			t > 0 && f.waveMotion && g.value > 0 && (v.value += t / qc * Math.PI * 2, v.value %= Math.PI * 2);
			let i = g.value !== n, a = f.waveMotion && g.value > 0;
			i || a ? S = globalThis.requestAnimationFrame(ce) : w = void 0;
		}
		function Z() {
			...
			S === void 0 && (w = void 0, S = globalThis.requestAnimationFrame(ce));
		}
		return H(k, Z), H(() => f.waveMotion, Z), T(() => {
			Z(), !(!m.value || typeof globalThis.ResizeObserver != "function") && (b = new globalThis.ResizeObserver(([e]) => {
			...
			(D(), s("svg", {
				...
				z(f).indeterminate ? (D(), s("defs", pc, [c("mask", {
					id: y,
				...
				z(f).indeterminate ? (D(), s(t, { key: 2 }, [c("g", bc, [c("path", {
			...
			z(f).indeterminate ? o("", !0) : (D(), s("span", Tc))
		], 512))], 16, dc));
	}
}), [["__scopeId", "data-v-90a3c307"]]), Yc = Symbol("mat-snackbar-externally-managed"), Xc = [], Zc = null;
function Qc() {
	Zc || Xc.length === 0 || (Zc = Xc.shift(), Zc.activate());
}
function $c(e) {
	e === Zc || Xc.includes(e) || (Xc.push(e), Qc());
}
function el(e) {
	let t = Xc.indexOf(e);
	t !== -1 && Xc.splice(t, 1);
...
var nl = { class: "mat-snackbar__text" }, rl = {
	key: 0,
...
}, ol = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSnackbar",
	inheritAttrs: !1
}, {
	__name: "MatSnackbar",
	...
	setup(e, { emit: r }) {
		...
		function ae() {
			b.value && (b.value = !1, x.value = "closed", f("closed"), y || tl(q));
		}
		function oe() {
			if (J(), !b.value) {
				y || el(q);
		...
		function Z() {
			!b.value || x.value === "closing" || (ce(), f("action"));
		}
		async function le() {
			if (!I || !l.modelValue || S.value || !w.value) {
				w.value || (ie(), se()), y || tl(q);
				return;
			}
			J(), Y(), b.value = !0, x.value = "opening", await v(), !(!I || !b.value || x.value === "closing") && ne(400, () => {
		...
		return T(() => {
			I = !0, g || (G = _n(K), K()), l.modelValue && ue();
		}), C(() => {
			I = !1, G?.(), G = null, J(), Y(), y || (b.value ? tl(q) : el(q));
		}), H(() => l.modelValue, (e) => {
			if (I) {
				if (e) {
					S.value = !1, ue();
			...
			"aria-live": "polite",
			role: "status"
		}), [c("div", nl, [e.$slots.default ? P(e.$slots, "default", { key: 0 }, void 0, !0) : (D(), s(t, { key: 1 }, [u(R(z(l).text), 1)], 64))]), k.value ? (D(), s("div", rl, [E.value ? (D(), s("div", il, [e.$slots.action ? P(e.$slots, "action", {
			key: 0,
			action: Z
		}, void 0, !0) : (D(), a(ke, {
			key: 1,
			...
			_: 1
		}, 8, ["use-cursor"]))])) : o("", !0), O.value ? (D(), s("div", al, [e.$slots.close ? P(e.$slots, "close", {
			key: 0,
			close: ce
		}, void 0, !0) : (D(), a(ke, {
			key: 1,
...
}), [["__scopeId", "data-v-6a4f08b6"]]), sl = ["aria-orientation"], cl = { class: "mat-toolbar__surface" }, ll = { class: "mat-toolbar__content" }, ul = 200, dl = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatToolbar",
	inheritAttrs: !1
}, {
	__name: "MatToolbar",
	...
	setup(e) {
		...
		let u = $("toolbar", e), d = ee(), p = V(), m = f(), g = h(It, null), y = m?.vnode.props ?? {}, b = Object.prototype.hasOwnProperty.call(y, "attach"), S = j(u.modelValue), w = j(u.modelValue ? "open" : "closed"), E = j(null), O = j(null), k = j({
			blockSize: 0,
			inlineSize: 0
		...
		]), q = L(null), J, Y, ne = !1, X = !1, re = Pt(), ie = Ft({ motion: re }), ae = !1;
		function oe() {
			re.cancel();
		}
		function se(e) {
			re.wait(E.value, ul, e);
		}
		async function ce() {
			oe(), S.value = !0, w.value = "opening", await v(), !(!X || !S.value || !u.modelValue || w.value !== "opening") && se(() => {
		...
		function le() {
			ae || !p.fab || N.value || (ae = !0, console.warn("MatToolbar: fab Slot 仅支持 floating variant"));
		}
		function ue() {
		...
		function pe() {
			Y?.disconnect(), Y = void 0, ne = !1, window.removeEventListener("resize", ue), J?.unregister(), J = void 0, q.value?.unregister(), q.value = null;
		}
		async function me() {
			if (await v(), X) {
				if (!S.value || !E.value) {
				...
				ne || (ne = !0, Y = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(ue), Y?.observe(E.value), window.addEventListener("resize", ue)), R.value ? (J?.unregister(), J = void 0, !N.value && !q.value && (q.value = g.publicContext.registerEdge({
					edge: "bottom",
					element: E.value
				})), N.value && q.value && (q.value.unregister(), q.value = null)) : (q.value?.unregister(), q.value = null, J ||= mn(E.value, {
					getRect: de,
					isBottom: () => I.value
		...
		}), [c("div", cl, [c("div", ll, [P(r.$slots, "default", {}, void 0, !0)])]), N.value && z(p).fab ? (D(), s("div", {
			key: 0,
			ref_key: "fabElement",
			ref: O,
			class: "mat-toolbar__fab"
		}, [P(r.$slots, "fab", {}, void 0, !0)], 512)) : o("", !0)], 16, sl)) : o("", !0)], 8, ["to", "disabled"]))], 64));
	}
}), [["__scopeId", "data-v-49a9f065"]]), fl = Symbol("mat-panes"), pl = [
	"compact",
	"medium",
	"expanded",
	"large",
	...
	emits: {
		...
		"update:breakpoint": (e) => pl.includes(e)
	},
	setup(e, { emit: t }) {
		...
		function Z(e = !1) {
			let t = ce(globalThis.window === void 0 ? 0 : globalThis.window.innerWidth);
		...
		return O(fl, {
			...
			Z(!0), se(), oe(!0), globalThis.window !== void 0 && globalThis.window.addEventListener("resize", le);
		}), C(() => {
...
}), [["__scopeId", "data-v-e119bd21"]]), hl = ["id"], gl = {
	key: 0,
	...
	setup(e) {
		let n = $("pane", e), r = h(fl, null), a = j(null), l = i(() => n.resizeLabel), u, d = i(() => r?.getPaneStyle(n.id) ?? { "--mat-pane-weight": 1 }), f = i(() => !!r?.hasBoundary(n.id)), p = i(() => !!r?.isHandleVisible(n.id)), m = i(() => r?.getHandleAttributes(n.id) ?? {}), g = i(() => !!r?.isBoundaryActive(n.id));
		function v() {
		...
		return T(v), H(() => n.id, v), C(() => u?.()), (i, l) => (D(), s(t, null, [c("div", _({
			...
			class: "mat-pane",
			style: d.value
		}), [P(i.$slots, "default", {}, void 0, !0)], 16, hl), f.value ? (D(), s("div", gl, [p.value ? (D(), s("div", {
			key: 0,
		...
		}, null, 42, _l)) : o("", !0)])) : o("", !0)], 64));
	}
}), [["__scopeId", "data-v-1bf28501"]]), yl = Symbol("mat-navigation-rail"), bl = { class: "mat-navigation-item__indicator mat-navigation-rail-item__indicator mat-navigation-bar-item__indicator" }, xl = {
	key: 0,
	class: "mat-navigation-item__icon-wrap mat-navigation-rail-item__icon-wrap mat-navigation-bar-item__icon-wrap"
}, Sl = { class: "mat-navigation-item__label-wrap mat-navigation-rail-item__label-wrap mat-navigation-bar-item__label-wrap" }, Cl = {
	key: 0,
	...
	key: 1,
	class: "mat-navigation-item__trailing mat-navigation-rail-item__trailing"
}, Dl = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: n }) {
		let r = [
			...
			"bottom-start",
			"start"
		], l = $("navigationItem", e), u = n, d = V(), f = h(Ne, Me), p = h(yl, null), m = i(() => p?.expanded.value ?? !1), g = i(() => p?.fullWidth.value ?? !1), v = i(() => p?.orientation.value === "horizontal"), b = i(() => p?.isSelected(l.value) ?? !1), x = i(() => !!(d.icon || l.icon && l.icon.trim())), S = i(() => x.value || !m.value), C = i(() => x.value ? l.icon : "circle"), w = i(() => {
			let e = l.badge;
			return e ? {
		...
		}), T = i(() => Pn("label", m.value && !v.value ? "large" : "medium")), E = i(() => Pn("label", "medium")), O = i(() => ({
		...
		return (e, n) => (D(), a(ke, _(e.$attrs, {
			...
			default: W(() => [
				c("span", bl, [
					S.value ? (D(), s("span", xl, [w.value ? (D(), a(Ba, {
						key: 0,
						color: w.value.color,
					...
					c("span", Sl, [c("span", { class: y([
						"mat-navigation-item__label",
						"mat-navigation-rail-item__label",
						"mat-navigation-bar-item__label",
						T.value
					]) }, [P(e.$slots, "default", {}, void 0, !0)], 2)]),
					g.value ? (D(), s(t, { key: 1 }, [e.$slots.trailing ? (D(), s("span", Cl)) : o("", !0), e.$slots.trailing ? (D(), s("span", wl, [P(e.$slots, "trailing", {
						expanded: m.value,
						selected: b.value
					}, void 0, !0)])) : o("", !0)], 64)) : o("", !0)
				]),
				...
				g.value ? o("", !0) : (D(), s(t, { key: 0 }, [e.$slots.trailing ? (D(), s("span", Tl)) : o("", !0), e.$slots.trailing ? (D(), s("span", El, [P(e.$slots, "trailing", {
					expanded: m.value,
					selected: b.value
				}, void 0, !0)])) : o("", !0)], 64))
			]),
...
}), [["__scopeId", "data-v-93081cfe"]]), Ol = /*@__PURE__*/ Object.assign({
...
}), kl = { class: "mat-navigation-rail__layout" }, Al = {
	key: 0,
	...
	setup(e, { expose: n, emit: l }) {
		let u = $("navigationRail", e), f = l, p = h(Ne, Me), v = V(), b = ee(), S = h(Un, null), w = i(() => {
			let e = { ...b };
			return delete e.app, e;
		}), T = j(null), E = i(() => u.mode === void 0 ? S ? "docked" : "flow" : u.mode), k = i(() => u.layout === "modal"), A = i(() => u.hideOnCollapse && !u.expanded), M = j(u.expanded), N = j(!A.value), F = i(() => N.value && !!v.header), I = i(() => u.expanded), L = i(() => u.open === void 0 ? u.hideOnCollapse || k.value ? u.expanded : !0 : u.open), R = Pt(), B = Ft({ motion: R });
		function U() {
		...
		H(() => u.expanded, U);
		function G(e) {
			return e.type === Ol || e.type?.name === "MatNavigationRailItem" || e.type === Dl || e.type?.name === "MatNavigationItem";
		}
		function te(e) {
			if (G(e)) return !0;
		...
		function K(e) {
			return g(e) ? e.type === t && Array.isArray(e.children) ? m(t, { key: e.key }, e.children.map(K)) : G(e) || I.value || te(e) ? e : r(e, { hidden: !0 }) : e;
		}
		function q() {
			return v.default?.({
				expanded: u.expanded,
		...
		return O(yl, {
			...
			default: W(() => [d(Ka, {
				...
				default: W(() => [c("div", kl, [F.value && N.value ? (D(), s("div", Al, [P(e.$slots, "header", { expanded: z(u).expanded }, void 0, !0)])) : o("", !0), N.value ? (D(), s("div", jl, [c("div", { class: y(["mat-navigation-rail__destinations", [`mat-navigation-rail__destinations--${z(u).alignment}`, { "mat-navigation-rail__destinations--show-custom-content": I.value }]]) }, [d(q)], 2)])) : o("", !0)])]),
				_: 3
			})]),
			_: 3
		}, 16, [
...
}), [["__scopeId", "data-v-bef8c7df"]]), Nl = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { expose: t, emit: n }) {
		let r = $("navigationBar", e), o = n, s = h(Ne, Me), l = h(qn, null), u = j(null), d = f()?.vnode.props ?? {}, p = i(() => Object.prototype.hasOwnProperty.call(d, "attach") && d.attach !== void 0), m = i(() => p.value ? r.attach : void 0), g = i(() => {
...
}), [["__scopeId", "data-v-a6a8d1ff"]]), Pl = /*@__PURE__*/ Object.assign({
...
}), [["__scopeId", "data-v-beef4203"]]), Il = ["aria-hidden"], Ll = { class: "mat-navigation-group__items" }, Rl = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: t }) {
		...
		}, [c("div", Ll, [P(e.$slots, "default", {}, void 0, !0)])], 8, Il)], 16));
	}
}), [["__scopeId", "data-v-260c72e4"]]), zl = /* @__PURE__ */ new WeakMap();
function Bl(e) {
...
function Vl(e, t) {
	...
	let { handler: n, options: r } = Bl(t.value), i = new IntersectionObserver((t, r) => {
		let i = zl.get(e);
		if (!i || i.observer !== r) return;
		let a = t.some((e) => e.isIntersecting), o = !i.initialized;
		i.initialized = !0, n && !(i.quiet && o) && n(a, t, r), i.once && a && (r.unobserve(e), zl.delete(e));
	}, r);
	zl.set(e, {
		handler: n,
		observer: i,
...
function Hl(e) {
	let t = zl.get(e);
	t && (t.observer.unobserve(e), zl.delete(e));
}
var Ul = {
	mounted: Vl,
	updated(e, t) {
		zl.has(e) && (Hl(e), Vl(e, t));
	},
	unmounted: Hl
}, Wl = Object.freeze({
...
//#endregion
//#region src/theme.js
var Xl = "#20a6fc", Zl = "(prefers-color-scheme: dark)";
function Ql(e) {
	if (![
		"light",
		"dark",
...
function ru(e = {}) {
	...
	let t = e.mode ?? "system", n = e.seedColor ?? Xl, r = e.schemeVariant ?? "tonal-spot", i = e.contrastLevel ?? 0, a = e.target ?? document.documentElement;
	Ql(t), nu(n), $l(r), eu(i), tu(a);
	let o = j(t), s = j(it(n)), c = j(r), l = j(i), u = j("light"), d = null, f = !1, p = !1;
	function m() {
		return !d && typeof window.matchMedia == "function" && (d = window.matchMedia(Zl)), d;
	}
	function h() {
	...
	function g() {
		...
		Object.entries($e).forEach(([t, n]) => {
			a.style.setProperty(`--mat-sys-color-${n}`, ie(e[t]));
...
function lu(e) {
	...
	return Object.freeze({
		openDelay: cu(e, "openDelay"),
		closeDelay: cu(e, "closeDelay")
	});
}
function uu(e) {
...
function fu(e = {}) {
	...
	return {
		...
		install(e) {
			iu.forEach(([t, n, r]) => {
				e.component(t, r), e.component(n, r), (Wl[t] ?? []).forEach((t) => {
					e.component(t, r);
				});
			}), e.directive("intersection", Ul), e.directive("state-layer", Oe), e.provide(Ne, t), e.provide(ct, n), ql(t, n);
		}
	};
}
function pu() {
...
function _u() {
	...
	async function n(n, r = {}) {
		...
		try {
			...
			o(), t === s && (t = null), e === l && (e = null), Qr(c), await v();
		}
	}
	return Object.freeze({
		get supported() {
...
var vu = _u, yu = {
...
}, bu = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatImperativeDialogHost" }, {
	...
	setup(e) {
		...
		return (n, r) => (D(), a(Os, _({
			...
			actions: W(() => [d(xs), (D(!0), s(t, null, N(e.options.actions, (t, n) => (D(), a(In, {
				key: n,
				color: t.color,
			...
			default: W(() => [p.value ? (D(), s(t, { key: 0 }, [e.options.content ? (D(), s("p", yu, R(e.options.content), 1)) : o("", !0), d(Qo, {
				modelValue: f.value,
...
function Ou(e) {
	...
	if (e.variant !== void 0 && !xu.includes(e.variant)) throw TypeError("dialog action variant 无效");
...
function ku(e) {
	...
	if (e.width !== void 0 && !wu(e.width)) throw TypeError("dialog width 无效");
...
function Mu(e = {}) {
	try {
		if (Eu(e), e.confirmText !== void 0 && (typeof e.confirmText != "string" || e.confirmText.trim().length === 0)) throw TypeError("alert confirmText 必须是非空字符串");
		return Au({
			...e,
			actions: [{
...
var Fu = /*@__PURE__*/ Object.assign({ name: "MatImperativeSnackbarHost" }, {
...
function Bu(e) {
	if (zu(e), typeof e.text != "string" || e.text.trim().length === 0) throw TypeError("snackbar text 必须是非空字符串");
	...
	if (e.position !== void 0 && !Iu.includes(e.position)) throw TypeError("snackbar position 无效");
...
function Vu() {
	return Lu?.isConnected ? Lu : (Lu = document.createElement("div"), Lu.dataset.matSnackbarHost = "", document.body.append(Lu), Lu);
}
function Hu() {
	!Lu || Lu.childNodes.length > 0 || (Lu.remove(), Lu = null);
}
function Uu(e) {
	try {
		Ru();
		...
		return new Promise((e, n) => {
			...
			function a() {
				...
				r = !0;
				let t = Lu;
				t && M(null, t), e(), tl(i), Hu();
			}
			function o(e) {
				if (r) return;
				r = !0;
				let t = Lu;
				t && M(null, t), n(e), tl(i), Hu();
			}
			i = { activate() {
				try {
					let e = Vu();
...
var Wu = Uu;
//#endregion
export { Ul as Intersection, Or as MatAppBar, Kn as MatAppRoot, gr as MatAside, ni as MatAvatar, Ba as MatBadge, Us as MatBottomSheet, In as MatBtn, Pr as MatBtnGroup, Ci as MatCard, Ti as MatCardActionArea, ki as MatCardActions, Di as MatCardContent, vi as MatCardHeadline, bi as MatCardMedia, Si as MatCardSubhead, Fa as MatCheckbox, Ga as MatChip, Ja as MatChipSet, Ks as MatContainer, Os as MatDialog, ka as MatDivider, bs as MatDockedContainer, pi as MatDynamicText, aa as MatExpansion, Sa as MatExpansionPanel, Vr as MatFab, Kr as MatFabMenu, Mt as MatHover, ht as MatIcon, Jr as MatImage, kr as MatInputBase, qs as MatLayout, ra as MatList, ya as MatListGroup, ga as MatListItem, tc as MatLoading, es as MatMenu, is as MatMenuGroup, ns as MatMenuItem, Nl as MatNavigationBar, Pl as MatNavigationBarItem, Fl as MatNavigationDrawer, Rl as MatNavigationGroup, Dl as MatNavigationItem, Ml as MatNavigationRail, Ol as MatNavigationRailItem, vl as MatPane, ml as MatPanes, Jc as MatProgress, uc as MatPullToRefresh, Xa as MatRadio, $a as MatRadioGroup, Po as MatRangeSlider, Ka as MatScrollArea, Mr as MatSearch, fs as MatSelect, oi as MatShape, $r as MatSharedElement, $r as MdeSharedElement, Ws as MatSideSheet, Ao as MatSlider, ol as MatSnackbar, xs as MatSpacer, hi as MatSplitBtn, eo as MatSwitch, Js as MatTableWrapper, si as MatText, Qo as MatTextField, ps as MatTextarea, dl as MatToolbar, wn as MatTooltip, Ys as MatVirtualScroll, Ys as MdeVirtualScroll, Oe as StateLayer, Mu as alert, Nu as confirm, fu as createMatUi, ju as dialog, Pu as prompt, Uu as snackbar, Wu as toast, Jn as useLayout, Vt as useMatApp, $ as useMatProps, pu as useMatTheme, _u as useMatViewTransition, vu as useMdeViewTransition };
