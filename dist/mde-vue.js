...
var Oe = {
	...
	setup(e, { expose: t, emit: n }) {
		...
		return t({ root: u }), (t, n) => W((D(), a(F(c.value), _({
			ref_key: "root",
			ref: u
		}, t.$attrs, {
...
function at({ seedColor: e, isDark: t, schemeVariant: n, contrastLevel: r }) {
	...
	let a = new i(q.fromInt(ne(it(e))), t, r, "2025", "phone");
...
var Ot = /*@__PURE__*/ Object.assign({
	...
	setup(e, { emit: t }) {
		let n = $("hover", e), r = t, a = B(), s = f()?.vnode.props ?? {}, c = Object.prototype.hasOwnProperty.call(s, "modelValue") || Object.prototype.hasOwnProperty.call(s, "model-value"), l = j(!1), u = j(null), d = L(null), p = i(() => c ? n.modelValue : u.value), m, h = null;
		function g() {
...
var Mt = Symbol("mat-app-root"), Nt = /* @__PURE__ */ new WeakMap();
function Pt(e, t) {
	Nt.set(e, t);
}
function Ft(e) {
...
function Yt(e, t, n, r, i, a, o, s) {
	let c = Gt(e, t, n, r, o), l = Math.max(a, i.width - r.width - a), u = Math.max(a, i.height - r.height - a), d = {
		left: Ut(c.left, a, l),
		top: Ut(c.top, a, u)
	}, f = qt(d, r);
	return Jt(f, n) || s.some((e) => Jt(f, Bt(e))) ? null : d;
}
function Xt({ avoidRects: e = [], gap: t = 4, location: n = "top", margin: r = 8, targetRect: i, tooltipRect: a, viewport: o = {
	height: window.innerHeight,
	width: window.innerWidth
} }) {
	let s = Bt(i), c = Bt(a), [l, u = "center"] = (Rt.includes(n) ? n : "top").split("-"), d = u === "start" || u === "end" ? u : "center", f = l === "top" || l === "bottom" ? c.height : c.width, p = Wt(l, s, o, r, t), m = zt[l], h = Wt(m, s, o, r, t), g = f > p && h > p ? m : l, _ = Math.max(r, o.width - c.width - r), v = Math.max(r, o.height - c.height - r), y = Kt(g), b = e.map((e) => Bt(e)), x = y.find((e) => Wt(e, s, o, r, t) >= f && Yt(e, d, s, c, o, r, t, b)) ?? y.find((e) => Yt(e, d, s, c, o, r, t, b)) ?? g, S = d === "center" ? x : `${x}-${d}`, C = Gt(x, d, s, c, t);
	return {
		left: Math.round(Ut(C.left, r, _)),
		location: S,
		top: Math.round(Ut(C.top, r, v))
	};
}
//#endregion
//#region src/components/tooltip-stack.js
var Zt = null, Qt = "pointer";
...
var rn = /* @__PURE__ */ new Map(), an = /* @__PURE__ */ new Set(), on = 0;
function sn(e) {
	let t = Number(e?.left) || 0, n = Number(e?.top) || 0, r = Number.isFinite(Number(e?.width)) ? Number(e.width) : Math.max(0, (Number(e?.right) || t) - t), i = Number.isFinite(Number(e?.height)) ? Number(e.height) : Math.max(0, (Number(e?.bottom) || n) - n);
	return {
		bottom: Number.isFinite(Number(e?.bottom)) ? Number(e.bottom) : n + i,
...
function ln() {
	rn.forEach((e, t) => {
		e.element.isConnected || rn.delete(t);
	});
}
function un(e, t = {}) {
	...
	return rn.set(n, r), cn(), {
		unregister() {
			i && (i = !1, rn.delete(n), cn());
		},
		update() {
			i && cn();
		}
...
function fn(e = window.innerHeight) {
	ln();
	let t = Number.isFinite(Number(e)) ? Number(e) : 0;
	return Math.max(0, ...[...rn.values()].filter((e) => e.isBottom()).flatMap((e) => {
		try {
			return [Math.max(0, t - sn(e.getRect()).top)];
		} catch {
			return [];
		}
	}));
...
var mn = ["id", "data-location"], hn = {
	key: 0,
	class: "mat-tooltip__subhead mat-sys-typescale-title-small"
}, gn = { class: "mat-tooltip__content mat-sys-typescale-body-medium" }, _n = {
	key: 1,
	class: "mat-tooltip__actions"
}, vn = 600, yn = 150, bn = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatTooltip",
	inheritAttrs: !1
}, {
	__name: "MatTooltip",
	...
	emits: { "update:modelValue": (e) => typeof e == "boolean" },
	setup(e, { emit: r }) {
		let l = e, d = r, p = $("tooltip", l), m = ee(), g = B(), y = f(), b = h(Mt, null), x = j(null), O = L(null), k = { value: O }, A = L(null), M = j(!1), N = j(null), F = j(!1), I = j(!1), H = j(!1), U = j("closed"), W = j("top"), G = j({}), K = j(!1), q = `${te().replace(/[^\w-]/g, "-")}-tooltip`, J = i(() => typeof m.id == "string" ? m.id : q), Y = i(() => p.content === void 0 ? !!g.default : p.content.length > 0), X = i(() => p.subhead === void 0 ? !!g.subhead : p.subhead.length > 0), Z = i(() => p.rich || X.value || !!g.action), ne = i(() => !!g.activator), re = y?.vnode.props ?? {}, ie = Object.prototype.hasOwnProperty.call(re, "modelValue") || Object.prototype.hasOwnProperty.call(re, "model-value"), ae, oe, se = At(), ce = jt({ motion: se }), le, ue = !1, de, fe, pe = null, me = null, he = null, ge = null, _e = null, ve = !1, ye = !0, be = !1, xe = !1, Se = !1, Ce = { close: Ye };
		function we(e) {
		...
		function Ke() {
			...
			}, he = pn(Ge), typeof ResizeObserver < "u" && (fe = new ResizeObserver(Ge), fe.observe(O.value), fe.observe(N.value)));
		}
		function qe() {
			F.value = !1, U.value = "closed", I.value = !1, H.value = !1, A.value = null, M.value = !1;
		}
		function Je({ immediate: e = !1 } = {}) {
			if (Fe(), Ie(), Re(), Ue(), Ve(), tn(Ce), !F.value) {
				qe();
				return;
			}
		...
		function Ye() {
			ie && (K.value = !0, d("update:modelValue", !1)), Je();
		}
		function Xe() {
			Se || (Se = !0, console.warn(ne.value ? "MatTooltip: activator Slot 必须只渲染一个当前 document 中的 HTMLElement 根节点" : "MatTooltip: target 必须指向当前 document 中存在的 HTMLElement"));
		}
		...
		function Qe() {
			if (Ie(), ie || I.value || K.value || !Y.value) return;
			let e = nn() ? 0 : Ne();
			if (e === 0) {
				ut();
				return;
		...
		function rt(e) {
			O.value?.contains(e.relatedTarget) || Z.value && N.value?.contains(e.relatedTarget) || (xe = !1, et());
		}
		function it() {
			Z.value && (be = !0, et());
		}
		...
		async function ut() {
			if (!ve || !ye || K.value || !Y.value) return;
			...
			Fe(), Ie(), Le(), en(Ce), A.value = e, M.value = e === b?.freeLayer.value, W.value = p.location, G.value = {
				left: "0px",
				top: "0px"
			}, H.value = !1, U.value = "opening", F.value = !0, I.value = !0, await v(), !(!ve || !ye || !I.value) && (He(), We(), Ke(), ze());
		}
		return T(async () => {
			...
			!I.value || !ge || (Ve(), He());
		}), b && V(b.publicContext.layout, Ge), (r, i) => (D(), s(t, null, [
			!z(ie) && Y.value ? (D(), a(Ot, {
				key: 0,
				target: k,
			...
			F.value && A.value ? (D(), a(n, {
				...
				X.value ? (D(), s("span", hn, [z(p).subhead === void 0 ? P(r.$slots, "subhead", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(p).subhead), 1)], 64))])) : o("", !0),
				c("span", gn, [z(p).content === void 0 ? P(r.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(p).content), 1)], 64))]),
				r.$slots.action ? (D(), s("span", _n, [P(r.$slots, "action", {}, void 0, !0)])) : o("", !0)
			], 64)) : z(p).content === void 0 ? P(r.$slots, "default", { key: 2 }, void 0, !0) : (D(), s(t, { key: 1 }, [u(R(z(p).content), 1)], 64))], 16, mn)], 8, ["to"])) : o("", !0)
		], 64));
	}
}), [["__scopeId", "data-v-cc34425b"]]), xn = Symbol("mde-vue-button-group"), Sn = Symbol("mde-vue-split-button");
//#endregion
//#region src/components/use-button.js
function Cn(e, t) {
	let n = h(Ne, Me), r = h(xn, null), a = h(Sn, null), o = i(() => a?.size.value ?? e.size ?? r?.size.value ?? "small"), s = i(() => a ? "round" : e.shape ?? r?.shape.value ?? "round"), c = i(() => a?.variant.value ?? e.variant), l = i(() => a?.color.value ?? e.color ?? r?.color.value), u = i(() => e.disabled || !!a?.disabled.value || !!r?.disabled.value), d = i(() => !!(r && r.selection.value !== "none")), f = i(() => a?.role === "trailing" ? a.expanded.value : d.value ? r.isSelected(e.value) : e.selected), p = i(() => a?.role === "trailing" || d.value || e.toggle), { colorStyle: m, hasExplicitColor: g } = dt(l);
	function _(n) {
...
function On(e) {
	return Tn.includes(e) || Object.hasOwn(En, e);
}
function kn(e) {
	return En[e] ?? e;
}
...
var jn = {
...
}, Mn = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBtn",
	inheritAttrs: !1
}, {
	__name: "MatBtn",
	...
	setup(e, { emit: n }) {
		let r = $("btn", e), c = n, l = ee(), d = B(), f = j(null), p = te(), { colorStyle: m, effectiveColor: h, effectiveDisabled: v, effectiveSelected: y, effectiveShape: b, effectiveSize: x, effectiveToggle: S, effectiveVariant: C, handleClick: w, hasExplicitColor: E, split: O, useCursor: k } = Cn(r, c), A = i(() => He(h.value)), M = i(() => !A.value || C.value === "text"), N = i(() => M.value ? m.value : {}), F = i(() => M.value && E.value), I = i(() => S.value && C.value !== "text"), L = i(() => I.value && y.value), V = i(() => r.icon === !0 || typeof r.icon == "string" && r.icon.trim().length > 0), W = i(() => r.fill === void 0 ? +!!L.value : r.fill);
		function G(e) {
			return e.flatMap((e) => typeof e == "string" || typeof e == "number" ? [String(e)] : g(e) ? e.type === t && Array.isArray(e.children) ? G(e.children) : typeof e.children == "string" || typeof e.children == "number" ? [String(e.children)] : Array.isArray(e.children) ? G(e.children) : [] : []).join("").trim();
		}
		let K = i(() => r.icon === !0 ? G(d.default?.() ?? []) : ""), q = i(() => typeof r.icon == "string" ? r.icon.trim() : K.value), J = i(() => l["aria-label"] ?? r.label), Y = i(() => V.value ? l.title ?? r.label : void 0), X = i(() => !V.value && (r.prefix !== void 0 || !!d.prefix)), Z = i(() => !V.value && (r.suffix !== void 0 || !!d.suffix)), ne = i(() => L.value && !!d.selected), re = i(() => ({
			"extra-small": 20,
			small: V.value ? 24 : 20,
			medium: 24,
			large: 32,
		...
		return T(() => {
			...
			r.toggle && r.variant === "text" && console.warn("MatBtn: text 形态不支持 toggle，当前按普通文本按钮处理"), A.value && C.value !== "text" && console.warn("MatBtn: on-* 内容色只支持 text 形态，当前按默认配色处理"), V.value && (!J.value || J.value.trim().length === 0) && console.warn("MatBtn: 图标模式必须提供非空 label 或 aria-label");
		}), (e, n) => (D(), a(Ae, _({
			...
			class: ["mat-btn", [
				...
				ie.value,
				{
					...
					"mat-btn--icon": V.value,
					[`mat-btn--width-${z(r).width}`]: V.value,
			...
			style: N.value,
			"aria-label": V.value ? J.value : z(l)["aria-label"],
			...
			block: z(r).block,
			disabled: z(v),
			title: V.value ? void 0 : z(l).title,
			type: z(r).type,
			"use-cursor": z(k),
			onClick: z(w)
		}), {
			default: U(() => [
				...
				V.value ? o("", !0) : (D(), s("span", jn, [ne.value ? P(e.$slots, "selected", { key: 0 }, void 0, !0) : P(e.$slots, "default", { key: 1 }, void 0, !0)])),
				Z.value ? (D(), a(ht, {
					key: 3,
					as: "span",
...
}), [["__scopeId", "data-v-3f1b245d"]]), Nn = ["data-scrollable"], Pn = { class: "mat-app-root__overlay" }, Fn = { class: "mat-app-root__bottom-stack" }, In = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAppRoot",
	inheritAttrs: !1
}, {
	__name: "MatAppRoot",
	...
	setup(e) {
		...
		if (h(Mt, null)) throw Error("MatAppRoot 不允许嵌套");
		let a = ee(), o = j(null), l = j(null), u = j(null), d = j(null), f = j(null), p = j(null), m = j(null), g = j(null), y = k({
			size: {
				width: 0,
				height: 0
			},
		...
		function H({ edge: e, element: n } = {}) {
			...
			return E.push(i), N?.observe(n), B(), Object.freeze({
				insets: A(r),
				unregister: () => {
					i.active && (i.active = !1, N?.unobserve?.(n), B());
				},
				update: () => {
					i.active && B();
				}
		...
		return T(async () => {
			M = !0, Pt(o.value, G), N = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(B), N?.observe(o.value), E.forEach((e) => {
				e.active && N?.observe(e.element);
			}), K(), await v(), B();
		}), C(() => {
			M = !1, Ft(o.value), N?.disconnect(), N = void 0, q(), F !== void 0 && (typeof window.cancelAnimationFrame == "function" ? window.cancelAnimationFrame(F) : window.clearTimeout(F));
		}), V([() => r.fillViewport, () => r.scrollable], B), (e, t) => (D(), s("div", _({
			ref_key: "rootElement",
			ref: o
		}, e.$attrs, {
...
var zn = L([]), Bn = L(0), Vn = Symbol("mat-dialog-document-scope"), Hn = /* @__PURE__ */ new WeakMap(), Un = /* @__PURE__ */ new Map();
function Wn(e) {
	return Un.has(e) || Un.set(e, {
		count: 0,
		inert: !1,
		inertElement: null,
...
function Gn(e, t) {
	let n = Wn(e);
	!t || t === n.inertElement || (n.inertElement && !n.inert && n.inertElement.removeAttribute("inert"), Un.set(e, {
		...n,
...
function Kn(e) {
	let t = Un.get(e);
	t?.inertElement && (t.inert || t.inertElement.removeAttribute("inert"), Un.set(e, {
		...t,
		inert: !1,
		inertElement: null
	}));
...
function qn(e) {
	let t = Wn(e), n = document.documentElement, r = n.clientWidth > 0 ? Math.max(0, window.innerWidth - n.clientWidth) : 0, i = getComputedStyle(n).scrollbarGutter, a = r > 0 && !i.includes("stable") ? "stable" : null;
	Un.set(e, {
		...t,
		lockedScrollbarGutter: a,
		overflow: n.style.overflow,
		scrollbarGutter: n.style.scrollbarGutter
	}), a && (n.style.scrollbarGutter = a, Bn.value = r), n.style.overflow = "hidden";
}
function Jn(e) {
	let t = Un.get(e);
	if (!t) return;
	let n = document.documentElement;
	n.style.overflow === "hidden" && (n.style.overflow = t.overflow), t.lockedScrollbarGutter !== null && n.style.scrollbarGutter === t.lockedScrollbarGutter && (n.style.scrollbarGutter = t.scrollbarGutter), t.lockedScrollbarGutter !== null && (Bn.value = 0);
}
function Yn(e) {
	let t = e, n = Wn(e), r = getComputedStyle(t), i = (Number.parseFloat(r.borderLeftWidth) || 0) + (Number.parseFloat(r.borderRightWidth) || 0), a = Math.max(0, t.offsetWidth - t.clientWidth - i) > 0 && !r.scrollbarGutter.includes("stable") ? "stable" : null;
	Un.set(e, {
		...n,
		lockedScrollbarGutter: a,
...
function Zn(e) {
	let t = Un.get(e);
	!t || t.count > 0 || (e === Vn ? Jn(e) : Xn(e), Kn(e), Un.delete(e));
}
function Qn() {
	[...Un.keys()].forEach((e) => {
		e === Vn ? Jn(e) : Xn(e), Kn(e);
...
function $n({ inertElement: e = null, scrollElement: t } = {}) {
	let n = t instanceof HTMLElement ? t : Vn, r = Wn(n);
	r.count === 0 ? (n === Vn ? qn(n) : Yn(n), Gn(n, e)) : e && r.inertElement !== e && Gn(n, e);
	let i = Wn(n);
	Un.set(n, {
		...i,
		count: i.count + 1
...
function er(e) {
	let t = e?.scrollElement instanceof HTMLElement ? e.scrollElement : Vn, n = Un.get(t);
	n && (Un.set(t, {
		...n,
...
function tr(e, t) {
	let n = zn.value.filter((e) => e.isConnected);
	if (n.length === 0 && Qn(), n.includes(e)) {
		zn.value = n;
		return;
	}
	Hn.set(e, t), zn.value = [...n, e], $n(t);
}
function nr(e) {
	let t = Hn.get(e);
	Hn.delete(e), zn.value = zn.value.filter((t) => t !== e && t.isConnected), t && er(t), zn.value.length === 0 && Qn();
}
//#endregion
//#region src/components/mat-aside/MatAside.vue
var rr = 200, ir = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAside",
	inheritAttrs: !1
}, {
	__name: "MatAside",
	props: {
		...
		blockSize: {
			type: [Number, String],
			default: void 0,
			validator: (e) => e === void 0 || e === "auto" || bt(e, { property: "block-size" })
		},
		safeArea: {
			type: [
				Boolean,
			...
			default: !0,
			validator: (e) => typeof e == "boolean" || bt(e, {
				property: "block-size",
				allowUndefined: !1
			})
		},
	...
	setup(e, { expose: r, emit: l }) {
		...
		let d = $("aside", e), p = l, m = ee(), g = f(), b = j(null), S = L(null), w = i(() => d.open === void 0 ? d.modelValue === void 0 || !!d.modelValue : !!d.open), E = j(!d.unmountOnClose || w.value), O = j(w.value ? "open" : "closed"), k = At(), A = jt({ motion: k }), M = !1, N, I = h(Ln, null), R = h(Mt, null), te = g?.vnode.props ?? {}, B = i(() => Object.prototype.hasOwnProperty.call(te, "attach") && te.attach !== void 0), H = i(() => d.app && !!R && !B.value), W = i(() => d.app ? H.value ? "docked" : "fixed" : d.mode), G = i(() => {
			let e = d.location;
		...
		}), K = i(() => d.blockSize === void 0 || d.blockSize === "auto"), q = j({
			blockSize: 0,
			inlineSize: 0
		}), J = i(() => !!d.modal), Y = i(() => J.value && zn.value.at(-1) === b.value), X = i(() => {
			if (K.value) return "auto";
			...
			return e !== null && t !== null ? `${e + t}px` : `calc(${X.value} + ${Z.value})`;
		}), re = i(() => G.value === "top" || G.value === "bottom" ? "8" : "7"), ie = j({
			top: 0,
			bottom: 0,
			left: 0,
			right: 0,
		...
		let ae = i(() => [
			"mat-aside",
			`mat-aside--${G.value}`,
			G.value === "start" ? "mat-aside--left" : null,
			G.value === "end" ? "mat-aside--right" : null,
			`mat-aside--mode-${W.value}`,
			`mat-aside--${O.value}`,
			{
				"mat-aside--bordered": d.bordered,
				"mat-aside--auto-size": K.value,
				"mat-aside--modal": J.value,
				"mat-aside--modal-scoped": J.value && se.value,
				"mat-aside--top-scrim": Y.value,
				"mat-aside--no-transition": !d.transition,
				"mat-aside--app": d.app
			}
		]), oe = i(() => [m.style, {
			"--mat-aside-block-size": K.value ? "auto" : X.value,
			"--mat-aside-safe-area-size": Z.value,
			"--mat-aside-total-block-size": K.value ? "auto" : ne.value,
			"--mat-aside-insets-top": `${ie.value.top}px`,
			"--mat-aside-insets-bottom": `${ie.value.bottom}px`,
			"--mat-aside-insets-left": `${ie.value.left}px`,
			"--mat-aside-insets-right": `${ie.value.right}px`,
			"--mat-aside-insets-offset": `${ie.value.offset}px`,
			zIndex: d.zIndex === void 0 ? J.value ? "calc(var(--mat-sys-z-index-dialog) + 1)" : re.value : String(d.zIndex)
		}]), se = i(() => W.value !== "fixed" && !!(I?.rootElement?.value || R && !B.value && R.rootElement?.value)), ce = i(() => {
			if (B.value && d.attach) {
			...
			if (W.value !== "fixed") {
				if (I?.rootElement?.value) return I.rootElement.value;
				if (R && !B.value && R.rootElement?.value) return R.rootElement.value;
			}
			return "body";
		}), le = i(() => {
			let e = G.value === "start" || G.value === "end", t = w.value && O.value !== "closed", n;
			return n = t ? d.placeholderSize === void 0 ? K.value ? e ? `${q.value.inlineSize}px` : `${q.value.blockSize}px` : ne.value : xt(d.placeholderSize, {
		...
		function ue() {
			return R && !B.value ? {
				inertElement: R.contentElement?.value ?? null,
				scrollElement: R.documentMode?.value ? null : R.contentElement?.value ?? null
			} : I ? {
				inertElement: I.contentElement?.value ?? null,
				scrollElement: I.rootElement?.value ?? null
			} : {
				inertElement: null,
				scrollElement: null
			};
		...
		function de() {
			if (!M || !b.value || !E.value || !J.value || !w.value || O.value === "closed") {
				b.value && nr(b.value);
				return;
			}
			tr(b.value, ue());
		...
		function me() {
			!J.value || !d.closeOnBack || pe();
		}
		function he(e) {
			J.value && Y.value && e.key === "Escape" && (e.preventDefault(), pe());
		}
		function ge() {
			if (!M || !b.value) return;
			let e = b.value.getBoundingClientRect(), t = Math.max(0, Math.ceil(Number(e.height) || 0)), n = Math.max(0, Math.ceil(Number(e.width) || 0));
			q.value.blockSize === t && q.value.inlineSize === n || (q.value = {
				blockSize: t,
				inlineSize: n
			}, S.value?.update());
		}
		function _e() {
			...
			S.value?.unregister(), S.value = null, !(d.placeholder || W.value === "flow" || W.value === "sticky" || d.modal) && (d.app && R ? S.value = R.publicContext.registerEdge({
				edge: G.value,
				element: b.value
			}) : I ? S.value = I.publicContext.registerEdge({
				edge: G.value,
				element: b.value
			}) : R && (S.value = R.publicContext.registerEdge({
				edge: G.value,
				element: b.value
			})));
		}
		function ve() {
			if (k.cancel(), E.value = !0, !d.transition) {
				O.value = "open", v().then(() => {
					_e(), de(), p("opened");
				});
				return;
			...
			O.value = "opening", v().then(() => {
				_e(), de(), !(!M || !E.value || !w.value) && k.wait(b.value, rr, () => {
		...
		function ye() {
			...
			if (!d.transition) {
				O.value = "closed", d.unmountOnClose && (E.value = !1), S.value?.unregister(), S.value = null, fe(), p("closed");
				return;
			}
			A.start({
				canStart: () => E.value && O.value !== "closing",
				duration: rr,
				getElement: () => b.value,
				isActive: () => M && !w.value && E.value,
				onStart: () => {
					O.value = "closing", S.value?.unregister(), S.value = null;
				},
				onFinish: () => {
					d.unmountOnClose && (E.value = !1), O.value = "closed", fe(), p("closed");
				}
			});
		}
		return V(w, (e) => {
			...
			M = !0, typeof window < "u" && window.addEventListener("keydown", he), E.value && (await v(), _e(), de(), N = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(ge), b.value && (N?.observe(b.value), ge()));
		}), C(() => {
			M = !1, typeof window < "u" && window.removeEventListener("keydown", he), N?.disconnect(), N = void 0, S.value?.unregister(), S.value = null, fe();
		}), r({
			hostElement: b,
			activeInsets: ie,
			phase: O
		}), (e, r) => z(d).placeholder && (E.value || !z(d).unmountOnClose) ? (D(), s(t, { key: 0 }, [P(e.$slots, "placeholder", { style: x(le.value) }, () => [c("span", {
			class: "mat-aside__placeholder",
			"aria-hidden": "true",
			style: x(le.value)
		}, null, 4)], !0), W.value === "fixed" ? (D(), a(n, {
			key: 0,
			to: ce.value,
			disabled: !ce.value
		}, [J.value && E.value && O.value !== "closed" ? (D(), s("button", {
			key: 0,
			class: y(["mat-aside__scrim", [z(d).scrimClass, {
				"mat-aside__scrim--top": Y.value,
			...
			"class",
			"style"
		])) : o("", !0)], 8, ["to", "disabled"])) : E.value ? (D(), a(F(z(d).as), _({
			key: 1,
			ref_key: "hostElement",
			ref: b
		}, e.$attrs, {
			...
			default: U(() => [J.value && E.value && O.value !== "closed" ? (D(), a(n, {
				key: 0,
				to: ce.value,
				disabled: !ce.value
			}, [c("button", {
				class: y(["mat-aside__scrim", [z(d).scrimClass, {
					"mat-aside__scrim--top": Y.value,
					"mat-aside__scrim--closing": O.value === "closing",
					"mat-aside__scrim--docked": se.value
				}]]),
				type: "button",
				tabindex: "-1",
				"aria-hidden": "true",
...
}), [["__scopeId", "data-v-fde578c9"]]), ar = /* @__PURE__ */ new WeakMap(), or = /* @__PURE__ */ new WeakMap();
function sr(e, t, n) {
...
function cr(e, t, n, r) {
	...
	}, e.set(t, i)), i.names.add(r), sr(t, n, i), () => {
...
function lr({ name: e, scope: t, source: n }) {
	let r = ar.get(n)?.initialAxis ?? n.style.scrollTimelineAxis, i = cr(ar, n, "scrollTimelineName", e), a = ar.get(n);
	a.initialAxis = r;
	let o = n.style;
	o.scrollTimelineAxis = "block";
	let s = cr(or, t, "timelineScope", e);
	return () => {
...
var fr = {
	...
	setup(e, { expose: n, emit: r }) {
		let a = [
			...
			"image",
			"search"
		], u = ["start", "center"], p = $("appBar", e), m = r, g = ee(), b = f(), S = h(Mt, null), w = b?.vnode.props ?? {}, E = i(() => Object.prototype.hasOwnProperty.call(w, "attach") && w.attach !== void 0), O = i(() => E.value ? p.attach : void 0), k = j(null), A = i(() => {
		...
		]), H = i(() => [g.style, { "--mat-app-bar-timeline": M }]), W = i(() => N.value === "medium-flexible" ? An("headline", "small") : N.value === "large-flexible" ? An("headline", "medium") : An("title", "large")), G = !1, K, q;
		function J() {
		...
		async function Z() {
			...
			if (!G || !e) return;
			X();
			let t = Y(p.scrollTarget), n = R.value && S.rootElement.value?.dataset.scrollable === "true" ? S.contentElement.value : null, r = t ?? n ?? ur(e);
			if (!r) return;
			let i = dr(r, e);
			J() && i && (K = lr({
				name: M,
		...
		return T(() => {
			...
			default: U(() => [
				e.$slots.leading ? (D(), s("div", fr, [P(e.$slots, "leading", {}, void 0, !0)])) : o("", !0),
				c("div", pr, [c("div", { class: y(["mat-app-bar__primary", W.value]) }, [P(e.$slots, "default", {}, void 0, !0)], 2), e.$slots.subtitle ? (D(), s("div", mr, [P(e.$slots, "subtitle", {}, void 0, !0)])) : o("", !0)]),
				n[2] ||= c("span", {
					class: "mat-app-bar__spacer",
					"aria-hidden": "true"
				}, null, -1),
				e.$slots.trailing ? (D(), s("div", hr, [P(e.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
			]),
			_: 3
		}, 16, [
			"app",
...
}), [["__scopeId", "data-v-abe3039f"]]), _r = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatInputBase",
	inheritAttrs: !1
}, {
	__name: "MatInputBase",
...
}), [["__scopeId", "data-v-ace9bd51"]]), vr = { class: "mat-search__leading" }, yr = {
	key: 0,
	class: "mat-search__trailing"
}, br = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSearch",
	inheritAttrs: !1
}, {
	__name: "MatSearch",
	...
	setup(e, { expose: t, emit: n }) {
		...
		return t({
			...
			c("span", vr, [P(e.$slots, "leading", {}, () => [d(Mn, {
				disabled: z(r).disabled,
				icon: "search",
				label: z(r).label,
				size: "small",
			...
			e.$slots.trailing ? (D(), s("span", yr, [P(e.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
		], 16));
	}
}), [["__scopeId", "data-v-7c60e904"]]), xr = 150, Sr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBtnGroup",
	inheritAttrs: !1
}, {
	__name: "MatBtnGroup",
	...
	setup(e, { emit: t }) {
		let n = $("btnGroup", e), r = t, a = j(null), o = j(null), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakMap(), d = /* @__PURE__ */ new Set(), f, p, m, h = xr, g = !0, y = !1, { colorStyle: b } = dt(i(() => n.color));
		function x(e) {
		...
		function A() {
			return k(getComputedStyle(a.value).getPropertyValue("--mat-btn-group-size-animation-duration")) ?? xr;
		}
		function M() {
		...
		function R() {
			...
			}), d.clear(), o.value && delete o.value.dataset.matGroupPressed, m &&= (m.style.removeProperty("--mat-button-visual-scale"), void 0), o.value = null, h = xr, g = !0, y = !1;
		}
		function ee() {
			if (!o.value) return;
		...
		function H(e) {
			...
			}), t.dataset.matGroupPressed = "", t.style.setProperty("--mat-button-visual-scale", ".96"), m = t, o.value = t, B(t, new Map([...d].map((e) => [e, l.get(e)])), y, f);
		}
		function U() {
...
function Er(e) {
	return typeof e == "string" && wr.includes(e);
}
//#endregion
//#region src/components/mat-fab/MatFab.vue
var Dr = ["aria-hidden"], Or = ["aria-hidden"], kr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatFab",
	inheritAttrs: !1
}, {
	__name: "MatFab",
	...
	setup(t, { emit: r }) {
		let c = $("fab", t), l = r, f = ee(), p = B(), m = h(Ne, Me), g = h(Mt, null), v = j(null), y = te(), b = i(() => (p.default?.() ?? []).some((t) => t.type === e ? !1 : typeof t.children != "string" || t.children.trim().length > 0)), x = i(() => c.expanded && b.value), S = i(() => typeof c.icon == "string" && c.icon.trim().length > 0), C = i(() => !x.value), w = i(() => C.value ? f.title ?? c.label : void 0), T = i(() => C.value ? c.label : f["aria-label"]), E = i(() => ({
			small: 24,
			medium: 28,
			large: 36
		})[c.size]), O = i(() => {
		...
		return H(() => {
			...
			default: U(() => [
				...
				}, [P(e.$slots, "default", {}, void 0, !0)], 8, Or)) : o("", !0),
				C.value && w.value ? (D(), a(bn, {
					key: 2,
					content: w.value,
					id: `${z(y)}-tooltip`,
					target: v.value
			...
			default: U(() => [
				...
				b.value ? (D(), s("span", {
					...
					class: "mat-fab__label",
					"aria-hidden": x.value ? void 0 : "true"
				}, [P(e.$slots, "default", {}, void 0, !0)], 8, Dr)) : o("", !0),
				C.value && w.value ? (D(), a(bn, {
					key: 2,
					content: w.value,
					id: `${z(y)}-tooltip`,
...
}), [["__scopeId", "data-v-7cc5cf2e"]]), Ar = ["aria-hidden"], jr = { class: "mat-fab-menu__trigger-box" }, Mr = ["aria-hidden"], Nr = { class: "mat-fab-menu__trigger-box" }, Pr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatFabMenu",
	inheritAttrs: !1
}, {
	__name: "MatFabMenu",
	...
	setup(e, { emit: t }) {
		let r = $("fabMenu", e), l = t, f = h(Ne, Me), p = h(Mt, null), m = j(null), g = j(null), v = j(!1), y = te(), b = i(() => r.modelValue !== void 0), x = i(() => b.value ? !!r.modelValue : v.value), S = i(() => r.closeLabel || "关闭"), w = i(() => r.color.replace(/-container$/, "")), E = i(() => `${w.value}-container`), O = i(() => ({
		...
		return T(() => {
			...
			"aria-hidden": x.value ? void 0 : "true",
			onClick: F
		}, [P(e.$slots, "default", {}, void 0, !0)], 8, Ar), c("div", jr, [P(e.$slots, "trigger", {
			open: x.value,
			toggle: N,
			size: z(r).size,
			color: z(r).color
			...
			"aria-hidden": x.value ? void 0 : "true",
			onClick: F
		}, [P(e.$slots, "default", {}, void 0, !0)], 8, Mr), c("div", Nr, [P(e.$slots, "trigger", {
			open: x.value,
			toggle: N,
			size: z(r).size,
			color: z(r).color
...
}), [["__scopeId", "data-v-85f7f726"]]), Fr = ["src"], Ir = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatImage",
	inheritAttrs: !1
}, {
	__name: "MatImage",
...
}), [["__scopeId", "data-v-d5f3cb83"]]), Lr = L(/* @__PURE__ */ new Set()), Rr = 0;
function zr(e) {
	return Rr += 1, Lr.value = new Set(e), Rr;
}
function Br(e) {
	e === Rr && (Lr.value = /* @__PURE__ */ new Set());
}
//#endregion
...
var Vr = /*@__PURE__*/ Object.assign({
	...
	setup(e) {
		let t = $("sharedElement", e), n = ee(), r = i(() => !t.disabled && Lr.value.has(t.name) ? t.name : void 0), o = i(() => [n.style, { viewTransitionName: r.value }]);
...
}, Wr = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatAvatar",
	inheritAttrs: !1
}, {
	__name: "MatAvatar",
	...
	setup(e) {
		...
		return (e, n) => (D(), s("span", _(e.$attrs, {
			...
			"aria-hidden": "true"
		}, null, 8, ["icon"])) : (D(), s("span", Ur, [P(e.$slots, "default", {}, void 0, !0)]))], 16));
	}
}), [["__scopeId", "data-v-a04143bf"]]), Gr = Object.freeze({
...
Object.freeze(Object.keys(Gr));
function Kr(e) {
	return typeof e == "string" && Object.hasOwn(Gr, e);
}
var qr = Object.freeze([
	...
	setup(e) {
		let t = $("shape", e), { colorStyle: n } = dt(i(() => t.color)), r = i(() => xt(t.size, {
			...
			positive: !0,
			fallback: "48px"
		})), o = i(() => Kr(t.name) ? t.name : "circle"), s = i(() => ({
			...n.value,
			inlineSize: r.value,
			blockSize: r.value,
			clipPath: Gr[o.value]
	...
	setup(e) {
		let t = $("text", e), n = i(() => An(t.type, t.size, t.emphasized));
		return (e, r) => (D(), a(F(z(t).as), { class: y(n.value) }, {
			default: U(() => [P(e.$slots, "default")]),
			_: 3
		}, 8, ["class"]));
	}
}), Xr = ["data-char", "onAnimationend"], Zr = { class: "mat-dynamic-text__stage" }, Qr = {
	key: 1,
	class: "mat-dynamic-text__char mat-dynamic-text__char--exiting"
}, $r = 25, ei = 300, ti = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatDynamicText" }, {
	...
	setup(e) {
		...
		function _(e, t) {
			let n = t * $r + ei, r = setTimeout(() => g(e), n);
			u.set(e, r);
		}
		function v(e, t) {
			let n = m(e), i = t && !p();
		...
		return l.value = v(n.text, n.appear), V(() => n.text, (e, t) => {
			...
			}, [c("span", Zr, [e.char ? (D(), s("span", {
				key: 0,
				class: y(["mat-dynamic-text__char", e.animating ? "mat-dynamic-text__char--entering" : "mat-dynamic-text__char--idle"])
			}, R(e.char), 3)) : o("", !0), e.oldChar ? (D(), s("span", Qr, R(e.oldChar), 1)) : o("", !0)])], 44, Xr))), 128))]),
			_: 1
		}, 8, ["aria-label"]));
	}
}), [["__scopeId", "data-v-314708d8"]]), ni = /*@__PURE__*/ Object.assign({ name: "MatSplitSegment" }, {
	...
	setup(e, { emit: t }) {
		let n = $("splitBtn", e), r = t, a = j(null), o = B(), { colorStyle: l, hasExplicitColor: u } = dt(i(() => n.color));
		O(Sn, {
			color: i(() => n.color),
...
}), [["__scopeId", "data-v-30ec286f"]]), ii = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSurfaceBase",
	inheritAttrs: !1
}, {
...
}), [["__scopeId", "data-v-73d1306b"]]), ai = { class: "mat-card-headline mat-sys-typescale-title-large" }, oi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardHeadline" }, {
	__name: "MatCardHeadline",
	setup(e) {
		return (e, t) => (D(), s("div", ai, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-53a5927c"]]), si = { class: "mat-card-media" }, ci = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardMedia" }, {
	__name: "MatCardMedia",
	setup(e) {
		return (e, t) => (D(), s("div", si, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-c38ab1c6"]]), li = { class: "mat-card-subhead mat-sys-typescale-body-medium" }, ui = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardSubhead" }, {
	__name: "MatCardSubhead",
	setup(e) {
		return (e, t) => (D(), s("div", li, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-c437408b"]]), di = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatCard",
	inheritAttrs: !1
}, {
	__name: "MatCard",
...
}), [["__scopeId", "data-v-cb7bd9d9"]]), fi = { class: "mat-card-action-area__content" }, pi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: t }) {
		...
		return (e, t) => (D(), a(ke, _(e.$attrs, {
			...
			default: U(() => [c("span", fi, [P(e.$slots, "default", {}, void 0, !0)])]),
			_: 3
		}, 16, [
			"disabled",
			"href",
...
}), [["__scopeId", "data-v-c7ecd12e"]]), mi = { class: "mat-card-content" }, hi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardContent" }, {
	__name: "MatCardContent",
	setup(e) {
		return (e, t) => (D(), s("div", mi, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-9ba80632"]]), gi = { class: "mat-card-actions" }, _i = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatCardActions" }, {
	__name: "MatCardActions",
	setup(e) {
		return (e, t) => (D(), s("div", gi, [P(e.$slots, "default", {}, void 0, !0)]));
	}
}), [["__scopeId", "data-v-69850177"]]), vi = [
	"none",
	"single-action",
	"multi-action",
	"single-select",
	"multi-select"
], yi = Symbol("mat-list"), bi = Symbol("mat-list-group-activator");
function xi(e) {
...
function wi(e) {
	return typeof e == "boolean" || Array.isArray(e) && e.every(Ci);
}
//#endregion
//#region src/components/scroll-area-context.js
var Ti = Symbol("mat-scroll-area");
//#endregion
//#region src/components/mat-virtual-scroll/use-virtual-scroll.js
function Ei({ root: e, props: t, enabled: n = !0, pinEdges: r = !1, emit: a }) {
	let o = j(null), s = h(Ti, null), c = i(() => !!z(n)), l = i(() => !!z(r)), u = i(() => Dt(t.itemHeight, {
		positive: !0,
		fallback: void 0
...
var Oi = 500, ki = 8, Ai = 48, ji = 24, Mi = "color-mix(\n  in srgb,\n  var(--mat-list-drag-content-color) calc(var(--mat-sys-state-dragged-state-layer-opacity) * 100%),\n  var(--mat-list-drag-container-color)\n)", Ni = "data-mat-list-drag-selection-lock", Pi = 0;
function Fi(e) {
	e.cancelable && e.preventDefault();
}
function Ii() {
	Pi === 0 && (document.documentElement.setAttribute(Ni, ""), document.addEventListener("selectstart", Fi, !0)), Pi += 1, globalThis.getSelection?.()?.removeAllRanges();
}
function Li() {
	Pi !== 0 && (--Pi, Pi === 0 && (document.documentElement.removeAttribute(Ni), document.removeEventListener("selectstart", Fi, !0)));
}
function Ri(e) {
...
function Vi(e, t) {
	let { style: n } = e;
	n.setProperty("--mat-list-drag-container-color", t.backgroundColor), n.setProperty("--mat-list-drag-content-color", t.color), n.background = Mi;
}
function Hi(e, t) {
	...
	Bi(n), n.setAttribute("aria-hidden", "true"), n.setAttribute("data-mat-list-drag-preview", ""), n.setAttribute("inert", "");
...
function Wi(e) {
	...
	function m() {
		...
		}).map((e) => Ri(e.value.value)).sort().join("|");
	...
	function x() {
		o && (o.source.style.display = o.sourceDisplay, o.placeholder.remove(), o.preview.remove(), Li(), o = void 0, t.value = !1);
	}
	function S() {
		b(), l?.cancel(), x(), y();
	}
	...
	function E(e) {
		...
		if (e < n.top + Ai ? r = -Math.ceil(ji * ((n.top + Ai - e) / Ai)) : e > n.bottom - Ai && (r = Math.ceil(ji * ((e - n.bottom + Ai) / Ai))), r === 0) return 0;
		let i = t.scrollTop;
	...
	function k() {
		...
		let h = m.getBoundingClientRect(), g = document.createElement(m.tagName.toLowerCase()), _ = Hi(m, h), v = m.matches(".mat-list-item__surface") ? m : m.querySelector(".mat-list-item__surface") ?? m, y = getComputedStyle(v), b = m.style.display, x = u.indexOf(n.record);
		g.setAttribute("aria-hidden", "true"), g.setAttribute("data-mat-list-drag-placeholder", ""), g.style.blockSize = `${h.height}px`, g.style.inlineSize = `${h.width}px`, Vi(g, y), e.root.value.insertBefore(g, m), m.style.display = "none", o = {
			...
			scrollContainer: zi(m),
			value: n.record.value.value
		}, a = void 0, Ii(), t.value = !0;
		try {
	...
	function A(e) {
		if (a && e.pointerId === a.pointerId) {
			Math.hypot(e.clientX - a.clientX, e.clientY - a.clientY) > ki && S();
			return;
		}
	...
	function I(t) {
		...
		i?.record && (S(), a = {
			...
			clientX: t.clientX,
			clientY: t.clientY,
			timer: globalThis.setTimeout(k, Oi)
		}, O());
	}
	function L(e) {
...
var Gi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatList",
	inheritAttrs: !1
}, {
	__name: "MatList",
	...
	emits: {
		...
		"update:expanded"(e) {
			return Array.isArray(e) && e.every(Ci);
		},
		reorder(e) {
	...
	setup(e, { expose: n, emit: r }) {
		let c = $("list", e), l = r, u = j(null), d = i(() => xi(c.interaction)), f = i(() => d.value ? "div" : "ul"), { colorStyle: p } = dt(i(() => c.color)), { colorStyle: m } = dt(i(() => c.activeColor)), h = i(() => Object.fromEntries(Object.entries(m.value).map(([e, t]) => [e.replace("accent", "active"), t]))), g = i(() => ({
			...p.value,
			...h.value
		})), y = [], b = [
		...
		}), { calculate: R, getItemKey: ee, getScroller: te, paddingBottom: B, paddingTop: H, refresh: W, scrollTo: G, scrollToIndex: K, setItemRef: q, visibleItems: J } = Ei({
			root: u,
			props: c,
			enabled: i(() => c.virtual),
			pinEdges: i(() => c.virtual),
			emit: l
		}), Y = i(() => c.items ? c.items.length : 0), X = i(() => Y.value > 0 ? {
			item: c.items[0],
			index: 0
		} : null), Z = i(() => {
			if (Y.value > 1) {
		...
		return O(yi, {
			...
			requestSelection: C,
			registerDragItem: ne.registerItem,
			requestDragValidation: ne.queueValidation,
			unregisterGroupValue: A,
			unregisterDragItem: ne.unregisterItem
			...
			class: ["mat-list", [`mat-list--${z(c).variant}`, {
				...
				"mat-list--dragging": z(ne).dragging.value
			}]],
			style: g.value,
			...
			onClickCapture: z(ne).handleClickCapture,
			onFocusin: z(L).handleFocusIn,
			onKeydown: re,
			onPointerdown: z(ne).handlePointerDown
		}), {
			default: U(() => [z(c).virtual ? Y.value > 0 ? (D(), s(t, { key: 1 }, [
				X.value ? P(e.$slots, "default", {
					key: 0,
					item: X.value.item,
					index: X.value.index,
					itemRef: (e) => z(q)(X.value.index, e),
					isFirst: !0,
					isLast: Y.value === 1
				}, void 0, !0) : o("", !0),
				Y.value >= 3 && z(H) > 0 ? (D(), s("div", {
					key: 1,
					class: "mat-list__spacer",
					style: x({ height: `${z(H)}px` }),
					"aria-hidden": "true"
				}, null, 4)) : o("", !0),
				(D(!0), s(t, null, N(Y.value >= 3 ? z(J) : [], (t) => P(e.$slots, "default", {
				...
				Y.value >= 3 && z(B) > 0 ? (D(), s("div", {
					key: 2,
					class: "mat-list__spacer",
					style: x({ height: `${z(B)}px` }),
					"aria-hidden": "true"
				}, null, 4)) : o("", !0),
				Z.value ? P(e.$slots, "default", {
					key: 3,
					item: Z.value.item,
					index: Z.value.index,
					itemRef: (e) => z(q)(Z.value.index, e),
					isFirst: !1,
					isLast: !0
				}, void 0, !0) : o("", !0)
...
}), [["__scopeId", "data-v-fa306a6f"]]), Ki = Symbol("mat-expansion"), qi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatExpansion",
	inheritAttrs: !1
}, {
	__name: "MatExpansion",
	props: {
		modelValue: {
			...
			default: void 0,
			validator(e) {
				return e == null ? !0 : Array.isArray(e) ? e.every(Ci) : Ci(e);
			}
		},
		multiple: {
			type: Boolean,
...
}), [["__scopeId", "data-v-f96e5c0a"]]), Ji = ["data-line-count"], Yi = ["inert"], Xi = ["inert"], Zi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatItemContentBase" }, {
	...
	setup(e) {
		return (t, n) => (D(), s("span", {
			...
			}, [P(t.$slots, "leading", {}, void 0, !0)], 10, Yi)) : o("", !0),
			c("span", {
			...
			t.$slots.trailing && !e.separateTrailing ? (D(), s("span", {
				...
				inert: e.presentationSlots ? "" : void 0
			}, [P(t.$slots, "trailing", {}, void 0, !0)], 10, Xi)) : o("", !0)
		], 10, Ji));
	}
}), [["__scopeId", "data-v-3223d16a"]]), Qi = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatListItemContent" }, {
...
}), [["__scopeId", "data-v-c5a4a0b9"]]), $i = [
	"id",
	"aria-disabled",
	"data-mat-list-disabled"
], ea = ["aria-disabled", "data-mat-list-disabled"], ta = ["aria-disabled", "data-mat-list-disabled"], na = ["inert"], ra = ["inert"], ia = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatListItem",
	inheritAttrs: !1
}, {
	__name: "MatListItem",
	...
	setup(e, { emit: t }) {
		...
		return T(async () => {
		...
		]), 1032, ["line-count"])], 16, $i)) : z(f) ? (D(), a(ke, _({
			key: 1,
			ref_key: "itemRoot",
			ref: O
		}, e.$attrs, {
		...
		]), 1032, ["line-count"])], 16, ea)), [[z(Oe), { color: "var(--mat-action-state-color, currentcolor)" }]]) : g.value ? W((D(), s("li", {
			key: 3,
			ref_key: "itemRoot",
			ref: O,
			...
			onPointerdown: H
		}, [P(e.$slots, "trailing", {}, void 0, !0)], 40, na)) : o("", !0)], 10, ta)), [[z(Oe), b.value ? { color: "var(--mat-action-state-color, currentcolor)" } : void 0]]) : (D(), a(ke, _({
			key: 4,
			ref_key: "itemRoot",
			ref: O
		}, e.$attrs, {
			...
			default: U(() => [d(Qi, {
				...
				inert: z(n).disabled ? "" : void 0,
				onPointerdown: H
			}, [P(e.$slots, "trailing", {}, void 0, !0)], 40, ra)) : o("", !0)]),
			_: 3
		}, 16, [
			"class",
			"data-mat-list-disabled",
...
}), [["__scopeId", "data-v-5efcd385"]]), aa = /*@__PURE__*/ Object.assign({ name: "MatListGroupActivatorProvider" }, {
	...
	setup(e) {
		return O(bi, e.context), (e, t) => P(e.$slots, "default");
	}
}), oa = [
	"role",
	"aria-hidden",
	...
	setup(n) {
		let r = $("listGroup", n), o = h(yi, null), s = B(), l = j(null), u = j(!1), f = j(null), p = Symbol("mat-list-group"), m = te().replace(/[^\w-]/g, "-"), y = `mat-list-group-${m}-content`, b = `mat-list-group-${m}-label`, x = !1, S, w = i(() => r.value !== void 0), O = i(() => o?.isSelectable.value ?? !1), k = i(() => w.value ? o?.isGroupExpanded(r.value) ?? !1 : u.value);
		function A(n) {
		...
		let M = i(() => {
			...
			let t = e[0].type;
			return t === ia || typeof t == "object" && (t.name === "MatListItem" || t.__name === "MatListItem");
	...
	setup(e, { emit: t }) {
		let n = $("expansionPanel", e), r = t, o = f(), c = h(Ki, null), l = "expansion-panel-" + te().replace(/[^\w-]/g, "-"), p = i(() => n.value === void 0 ? l : n.value), m = i(() => n.disabled || !!c?.disabled.value), g = i(() => n.color || c?.color.value), v = i(() => c?.variant.value ?? "segmented"), { colorStyle: b, hasExplicitColor: x } = dt(i(() => n.color || c?.color.value)), S = i(() => {
			let e = o?.vnode?.props ?? {};
		...
		return (e, t) => z(c) ? (D(), a(sa, _({ key: 0 }, e.$attrs, {
			value: p.value,
			as: z(n).as,
			...
			activator: U(({ expanded: t }) => [P(e.$slots, "activator", { expanded: t }, () => [d(ia, { disabled: m.value }, {
				trailing: U(() => [d(ht, {
					icon: "expand_more",
			...
			default: U(() => [z(n).split ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s("div", ca, [P(e.$slots, "default", {}, void 0, !0)]))]),
			_: 3
		}, 16, [
			"value",
			"as",
			...
			default: U(() => [d(sa, _(e.$attrs, {
				...
				default: U(() => [z(n).split ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s("div", la, [P(e.$slots, "default", {}, void 0, !0)]))]),
				_: 3
			}, 16, [
				"value",
				"class",
...
}), [["__scopeId", "data-v-75c0236c"]]), da = Symbol("mat-menu"), fa = Symbol("mat-menu-item"), pa = Symbol("mat-menu-group");
function ma(e, t, n) {
	return Math.abs((e.x * (t.y - n.y) + t.x * (n.y - e.y) + n.x * (e.y - t.y)) / 2);
}
function ha(e, t, n, r = "right") {
	let i = r === "left" ? n.right : n.left, a = {
		...
		x: i,
		y: n.bottom
	}, s = ma(t, a, o), c = ma(e, a, o), l = ma(t, e, o), u = ma(t, a, e);
...
var _a = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatDivider",
	inheritAttrs: !1
}, {
	__name: "MatDivider",
	...
	setup(e) {
		let t = $("divider", e), n = h(yi, null), r = h(da, null), o = i(() => !!n), s = i(() => !!r), c = i(() => n?.isSelectable.value ?? !1), l = i(() => t.inset === !0 ? "middle" : t.inset === !1 ? "none" : t.inset), u = i(() => o.value ? c.value ? "div" : "li" : s.value ? "div" : "hr");
...
}), [["__scopeId", "data-v-88c82c06"]]), va = { class: "mat-selection-control__target" }, ya = [
	"aria-checked",
	"checked",
	"disabled",
	"indeterminate",
	...
	setup(e, { expose: t, emit: n }) {
		let r = e, a = n, l = ee(), u = B(), d = j(null), f = h(Ne, Me), { colorStyle: p } = dt(i(() => r.color)), m = i(() => {
			let e = {};
			return [
				"class",
				"inert",
		...
		return t({
			...
			c("span", ba, [P(t.$slots, "indicator", {}, void 0, !0)])
		]), z(u).default ? (D(), s("span", xa, [P(t.$slots, "default", {}, void 0, !0)])) : o("", !0)], 16));
	}
}), [["__scopeId", "data-v-5041102c"]]), Ca = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatCheckbox",
	inheritAttrs: !1
}, {
	__name: "MatCheckbox",
...
var Ea = ["data-dot"], Da = ["data-dot"], Oa = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatBadge",
	inheritAttrs: !1
}, {
	__name: "MatBadge",
	...
	setup(e) {
		...
		}), R(u.value), 17, Ea)) : a.value ? o("", !0) : (D(), s("span", _({ key: 1 }, z(n), { class: "mat-badge" }), [P(e.$slots, "default", {}, void 0, !0), l.value ? (D(), s("span", {
			key: 0,
			class: y(["mat-badge__indicator", [`mat-badge__indicator--${z(t).location}`, { "mat-badge__indicator--dot": z(t).dot }]]),
			style: x(f.value),
			"aria-hidden": "true",
			"data-dot": z(t).dot ? "" : void 0
		}, R(u.value), 15, Da)) : o("", !0)], 16));
	}
}), [["__scopeId", "data-v-9406a351"]]), ka = Symbol("mat-chip-set"), Aa = {
	key: 0,
	...
	"aria-hidden": "true",
	inert: ""
}, Ma = { class: "mat-chip__label" }, Na = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatChip",
	inheritAttrs: !1
}, {
	__name: "MatChip",
	...
	setup(e, { emit: t }) {
		let n = $("chip", e), r = t, l = B(), u = h(Ne, Me), d = h(ka, null), f = i(() => ["filter", "input"].includes(n.variant)), p = i(() => !!d && f.value && n.value !== void 0 && d.selection.value !== "none"), m = i(() => p.value ? d.isSelected(n.value) : f.value && n.selected), g = i(() => !!l.avatar), v = i(() => !g.value && !!l.leading), y = i(() => n.variant === "filter" && m.value && !g.value && !v.value && !n.hideSelectedIcon), b = i(() => g.value || v.value || y.value), x = i(() => n.variant === "input"), { colorStyle: S, hasExplicitColor: C } = dt(i(() => n.color));
		function w(e) {
		...
		return (e, t) => (D(), a(ke, _(e.$attrs, {
			...
			default: U(() => [
				g.value ? (D(), s("span", Aa, [P(e.$slots, "avatar", {}, void 0, !0)])) : v.value || y.value ? (D(), s("span", ja, [v.value ? P(e.$slots, "leading", { key: 0 }, void 0, !0) : (D(), a(ht, {
					key: 1,
					as: "span",
					icon: "check",
					"optical-size": 20,
				...
				c("span", Ma, [P(e.$slots, "default", {}, void 0, !0)]),
				x.value ? (D(), s("span", {
					key: 2,
...
}), [["__scopeId", "data-v-f6054847"]]), Pa = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatScrollArea",
	inheritAttrs: !1
}, {
	...
	setup(e, { expose: t, emit: n }) {
		let r = $("scrollArea", e), { colorStyle: a, hasExplicitColor: o } = dt(i(() => r.color)), l = n, u = ee(), d = j(null), f = j(null), p = j(!1), m = j(!1), h = j(!1), g = j(!1), y = j(!1), b, x, S, w = 0, k = 0, A = !1, M, N = i(() => [
			...
			"x",
			"h"
		].includes(r.orientation) ? "horizontal" : "vertical"), F = i(() => r.dragScroll && N.value === "horizontal"), I = i(() => wt(r.reachThreshold, 0)), L = i(() => wt(r.shadowOffset, 0)), R = i(() => wt(r.shadowLength, 16)), te = i(() => r.barWidth === "hidden" ? 0 : r.barWidth === "thin" ? 8 : 16), B = j({
			left: 0,
			right: 0,
			top: 0,
			bottom: 0
		...
		function H() {
			...
			n.left === r.left && n.right === r.right && n.top === r.top && n.bottom === r.bottom || (B.value = n);
		}
		let U = i(() => {
			...
			"--mat-scroll-area-root-padding-left": `${B.value.left}px`,
			"--mat-scroll-area-root-padding-right": `${B.value.right}px`,
			"--mat-scroll-area-root-padding-top": `${B.value.top}px`,
			"--mat-scroll-area-root-padding-bottom": `${B.value.bottom}px`
		...
		function le(e) {
			A && (Z(), e.preventDefault(), e.stopImmediatePropagation());
		}
		function ue() {
		...
		return O(Ti, {
			...
			b !== void 0 && cancelAnimationFrame(b), x?.disconnect(), re(!0), Z();
		}), t({
			getScroller: de,
			scrollTo: fe
		}), (e, t) => (D(), s("div", _({
...
}), [["__scopeId", "data-v-235ce304"]]), Fa = { class: "mat-chip-set__scroll-content" }, Ia = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatChipSet" }, {
	__name: "MatChipSet",
	props: {
		layout: {
			type: String,
		...
		modelValue: {
			...
			default: null,
			validator(e) {
				return e === null || Ci(e) || Array.isArray(e) && e.every(Ci);
			}
		}
	},
	emits: { "update:modelValue"(e) {
	...
	setup(e, { emit: t }) {
		...
		return O(ka, {
			...
			default: U(() => [c("div", Fa, [P(e.$slots, "default", {}, void 0, !0)])]),
			_: 3
		})) : P(e.$slots, "default", { key: 1 }, void 0, !0)], 2));
	}
}), [["__scopeId", "data-v-e907c0ea"]]), La = Symbol("mde-vue-radio-group"), Ra = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatRadio",
	inheritAttrs: !1
}, {
	__name: "MatRadio",
	...
	setup(e, { emit: t }) {
		let n = $("radio", e), r = t, o = f(), s = h(La, null), l = j(null), u = i(() => n.value), d = i(() => n.disabled || !!s?.disabled.value), p = i(() => n.color ?? s?.color.value), m = i(() => s ? s.isSelected(n.value) : Object.is(n.modelValue, n.value));
		function g(e) {
...
}), [["__scopeId", "data-v-dae1f87b"]]), za = ["aria-disabled"], Ba = { class: "mat-radio-group__label mat-sys-typescale-title-medium" }, Va = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatRadioGroup",
	inheritAttrs: !1
}, {
	...
	setup(e, { emit: t }) {
		...
		return O(La, {
			...
			style: d.value,
			role: "radiogroup"
		}), [c("legend", Ba, R(z(n).label), 1), P(e.$slots, "default", {}, void 0, !0)], 16, za));
	}
}), [["__scopeId", "data-v-77c4f2f2"]]), Ha = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSwitch",
	inheritAttrs: !1
}, {
	__name: "MatSwitch",
...
}), [["__scopeId", "data-v-6efac2c1"]]), Ua = Object.freeze(["horizontal", "vertical"]), Wa = Object.freeze([
	"extra-small",
	"small",
	"medium",
	"large",
	"extra-large"
]), Ga = Object.freeze(["standard", "centered"]), Ka = 12;
function qa(e) {
...
function Qa(e) {
	return Array.isArray(e) && e.length === 2 && e.every(qa);
}
function $a(e) {
...
function eo(e, t) {
	return Number(e.toFixed(Math.min(Ka, t)));
}
function to(e, t) {
	let n = qa(e) ? e : 0, r = qa(t) ? t : 100;
	return {
		min: n,
		max: r > n ? r : n + 1
	};
...
function io(e, t, n) {
	let r = ro(qa(e) ? e : t.min, t), i = Math.round((r - t.min) / n), a = Math.max($a(t.min), $a(t.max), $a(n));
	return eo(ro(t.min + i * n, t), a);
}
function ao(e, t, n) {
	return io(qa(e) ? e : (t.min + t.max) / 2, t, n);
}
function oo(e, t) {
	return eo((ro(e, t) - t.min) / (t.max - t.min) * 100, 3);
}
function so(e) {
	return Number(e.toFixed(3)).toString();
}
function co(e) {
	let t = Math.min(Math.max(e, 0), 100), n = so(t), r = eo(6 * (1 - t * 2 / 100), 3);
	return t === 0 ? "6px" : t === 100 ? "calc(100% - 6px)" : r === 0 ? `${n}%` : `calc(${n}% ${r > 0 ? "+" : "-"} ${so(Math.abs(r))}px)`;
}
function lo(e, t) {
	let n = Math.floor((e.max - e.min) / t), r = Math.max($a(e.min), $a(e.max), $a(t)), i = Array.from({ length: n + 1 }, (n, i) => eo(e.min + i * t, r));
...
function uo(e, t, n, r, i) {
	...
	return io(n.min + (n.max - n.min) * u, n, r);
}
function fo(e, t, n, r) {
	if (t === "Home") return n.min;
	if (t === "End") return io(n.max, n, r);
	let i = {
		ArrowDown: -1,
		ArrowLeft: -1,
		ArrowRight: 1,
	...
	if (i !== void 0) return io(e + i * r, n, r);
}
function po(e, t, n, r) {
	let i = io(e, n, r), a = io(t, n, r);
	return i <= a ? [i, a] : [a, i];
}
//#endregion
...
var mo = {
	...
	"aria-hidden": "true"
}, ho = { class: "mat-slider__inset-icon-layer" }, go = { class: "mat-slider__inset-icon-layer mat-slider__inset-icon-layer--active" }, _o = [
	"aria-label",
	"aria-orientation",
	"aria-valuemax",
	"aria-valuemin",
	...
	"step",
	"value"
], vo = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSlider",
	inheritAttrs: !1
}, {
	__name: "MatSlider",
	...
	setup(e, { emit: n }) {
		let r = $("slider", e), l = n, f = ee(), p = B(), m = j(null), g = j(null), v = j(null), b = j(null), S = j(!1), w = j(void 0), E = j(void 0), O = j(!1), k = j(!1), A = j("active"), M = h(Ne, Me), { colorStyle: F } = dt(i(() => r.color)), I = i(() => to(r.min, r.max)), L = i(() => no(r.step)), te = i(() => io(r.modelValue, I.value, L.value)), H = i(() => S.value ? E.value : te.value), W = i(() => ao(r.center, I.value, L.value)), G = i(() => r.variant === "centered" ? W.value : I.value.min), K = i(() => oo(H.value, I.value)), q = i(() => oo(G.value, I.value)), J = i(() => co(K.value)), Y = i(() => r.variant === "standard" ? "0%" : co(q.value)), X = i(() => Math.sign(K.value - q.value)), Z = i(() => X.value >= 0 ? Y.value : `calc(${J.value} + var(--mat-slider-handle-track-gap))`), ne = i(() => X.value > 0 ? `max(0px, calc(${J.value} - ${Y.value} - var(--mat-slider-handle-track-gap)))` : X.value < 0 ? `max(0px, calc(${Y.value} - ${J.value} - var(--mat-slider-handle-track-gap)))` : "0px"), re = i(() => X.value > 0 ? Y.value : `max(0px, calc(${J.value} - var(--mat-slider-handle-track-gap)))`), ie = i(() => X.value < 0 ? Y.value : `calc(${J.value} + var(--mat-slider-handle-track-gap))`), ae = i(() => X.value < 0 ? `calc(100% - ${Y.value})` : `max(0px, calc(100% - ${J.value} - var(--mat-slider-handle-track-gap)))`), oe = i(() => r.showStopIndicator ? lo(I.value, L.value) : r.variant === "centered" ? [I.value.min, I.value.max] : [I.value.max]), se = i(() => r.insetIcon !== void 0 && [
			"medium",
			"large",
			"extra-large"
			...
			"--mat-slider-active-visible-start": Z.value,
			...
			"--mat-slider-inset-icon-position": A.value === "inactive" ? `calc(${J.value} + (var(--mat-slider-handle-width) / 2) + var(--mat-slider-handle-track-gap))` : "var(--mat-slider-inset-icon-offset)",
		...
		function de() {
			...
			let e = m.value.getBoundingClientRect(), t = r.orientation === "vertical" ? e.height : e.width, n = r.size === "extra-large" ? 32 : 24, i = Number.parseFloat(getComputedStyle(m.value).getPropertyValue("--mat-slider-handle-width")) || 4, a = 6 + (t - 12) * K.value / 100, o = 12 + n;
		...
		function pe(e, t) {
			let n = S.value ? E.value : te.value;
			return e === void 0 || e === n ? !1 : (S.value && (E.value = e), l("update:modelValue", e), l("input", t), !0);
		}
		function me(e) {
			return v.value ? pe(uo(e, v.value, I.value, L.value, r.orientation), e) : !1;
		}
		let he = Di((e) => {
			O.value = me(e) || O.value;
		});
		function ge(e) {
			r.disabled || (he.cancel(), w.value = e.pointerId, E.value = te.value, O.value = !1, S.value = !0, b.value?.focus(), v.value?.setPointerCapture?.(e.pointerId), O.value = me(e));
		}
		function _e(e) {
		...
		function ye(e) {
			...
			let t = fo(te.value, e.key, I.value, L.value);
		...
		return (n, i) => (D(), s("div", _({
			...
			c("span", mo, [
				...
				(D(!0), s(t, null, N(oe.value, (e) => (D(), s("span", {
					key: e,
					class: y(["mat-slider__stop", { "mat-slider__stop--active": e >= Math.min(G.value, H.value) && e <= Math.max(G.value, H.value) }]),
					style: x({ "--mat-slider-stop-position": z(co)(z(oo)(e, I.value)) })
				}, null, 6))), 128)),
				se.value && z(r).variant === "standard" ? (D(), a(ht, {
					...
					"icon",
					"optical-size"
				])) : se.value ? (D(), s(t, { key: 1 }, [c("span", ho, [d(ht, {
					...
					size: "var(--mat-slider-current-inset-icon-size)",
					"aria-hidden": "true"
				}, null, 8, ["icon", "optical-size"])]), c("span", go, [d(ht, {
			...
			d(bn, {
				...
				default: U(() => [z(p)["indicator-label"] ? P(n.$slots, "indicator-label", {
					key: 0,
					modelValue: H.value
				}, void 0, !0) : (D(), s(t, { key: 1 }, [u(R(H.value), 1)], 64))]),
				_: 3
			}, 8, [
				"location",
				"model-value",
	...
	setup(e, { emit: n }) {
		let r = $("rangeSlider", e), a = n, o = ee(), l = B(), f = j([]), p = j(null), m = j(null), g = j(null), v = j(0), b = j(void 0), S = j(!1), w = j(void 0), T = j(void 0), E = j(!1), O = h(Ne, Me), { colorStyle: k } = dt(i(() => r.color)), A = i(() => to(r.min, r.max)), M = i(() => no(r.step)), F = i(() => po(r.modelValue?.[0], r.modelValue?.[1], A.value, M.value)), I = i(() => S.value ? T.value : F.value), L = i(() => oo(I.value[0], A.value)), te = i(() => oo(I.value[1], A.value)), V = i(() => co(L.value)), H = i(() => co(te.value)), W = i(() => r.showStopIndicator ? lo(A.value, M.value) : [A.value.min, A.value.max]), G = i(() => f.value[v.value] ?? null), K = i(() => I.value[v.value]), q = i(() => r.showValueIndicator && (S.value || b.value === v.value)), J = i(() => ({
			...k.value,
		...
		function ne(e) {
			if (!p.value) return !1;
			let t = uo(e, p.value, A.value, M.value, r.orientation);
			return Z(v.value, t, e);
		}
		let re = Di((e) => {
		...
		function ie(e) {
			...
			re.cancel();
			let t = uo(e, p.value, A.value, M.value, r.orientation);
			t !== void 0 && (v.value = X(t), w.value = e.pointerId, T.value = [...F.value], E.value = !1, S.value = !0, Y(v.value)?.focus(), p.value.setPointerCapture?.(e.pointerId), E.value = Z(v.value, t, e));
		}
		function ae(e) {
		...
		function se(e, t) {
			if (r.disabled) return;
			let n = fo(F.value[e], t.key, A.value, M.value);
			n !== void 0 && (t.preventDefault(), v.value = e, Z(e, n, t) && a("change", t));
		}
		function ce(e) {
			v.value = e, b.value = e;
		}
		...
		return (e, n) => (D(), s("div", _(z(o), {
			...
			c("span", yo, [
				...
				(D(!0), s(t, null, N(W.value, (e) => (D(), s("span", {
					...
					style: x({ "--mat-range-slider-stop-position": z(co)(z(oo)(e, A.value)) })
				}, null, 6))), 128)),
			...
			d(bn, {
				...
				default: U(() => [z(l)["indicator-label"] ? P(e.$slots, "indicator-label", {
					key: 0,
					index: v.value,
					modelValue: K.value
...
}), [["__scopeId", "data-v-6c96f4bf"]]), Co = ["inert", "aria-hidden"], wo = { class: "mat-text-input__container" }, To = {
	key: 0,
	...
	key: 0,
	"aria-hidden": "true"
}, jo = { class: "mat-text-input__control-row" }, Mo = {
	key: 0,
...
}, Fo = { class: "mat-text-input__supporting-text" }, Io = {
	key: 0,
	class: "mat-text-input__counter"
}, Lo = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	emits: { "update:modelValue": (e) => typeof e == "string" },
	setup(e, { emit: t }) {
		let n = e, r = t, l = ee(), d = j(!1), f = j(n.modelValue), p = j(), m = te(), h = `${m}-supporting`, g = i(() => l.id || m), { colorStyle: b } = dt(i(() => n.color)), S = i(() => !!l.placeholder), w = i(() => n.control === "custom" ? n.customFocused : d.value), E = i(() => w.value || f.value.length > 0 || S.value), O = i(() => n.error ? n.errorText : n.supportingText), k = i(() => !!O.value || n.maxLength !== void 0), A = i(() => {
		...
		return (t, n) => (D(), s("div", {
			...
			e.variant === "outlined" ? (D(), s("fieldset", To, [E.value && e.label ? (D(), s("legend", Eo, [u(R(e.label), 1), e.required ? (D(), s("span", Do, " *")) : o("", !0)])) : o("", !0)])) : o("", !0),
			e.variant === "filled" ? (D(), s("span", Oo)) : o("", !0),
			t.$slots.leading ? (D(), s("span", ko, [P(t.$slots, "leading", {}, void 0, !0)])) : o("", !0),
			(D(), a(F(e.control === "custom" ? "div" : "label"), {
				...
				default: U(() => [e.label ? (D(), s("span", {
				...
				}, [u(R(e.label), 1), e.required ? (D(), s("span", Ao, " *")) : o("", !0)], 2)) : o("", !0), c("span", jo, [
					e.prefixText ? (D(), s("span", Mo, R(e.prefixText), 1)) : o("", !0),
					...
					e.suffixText ? (D(), s("span", No, R(e.suffixText), 1)) : o("", !0)
				])]),
				_: 3
			}, 8, ["for"])),
			t.$slots.trailing ? (D(), s("span", Po, [P(t.$slots, "trailing", {}, void 0, !0)])) : o("", !0)
		]), k.value ? (D(), s("span", {
			key: 0,
			id: h,
			class: "mat-text-input__supporting mat-sys-typescale-body-small"
		}, [c("span", Fo, R(O.value), 1), e.maxLength === void 0 ? o("", !0) : (D(), s("span", Io, R(e.modelValue.length) + " / " + R(e.maxLength), 1))])) : o("", !0)], 14, Co));
	}
}), [["__scopeId", "data-v-ca1b6083"]]), Ro = ["filled", "outlined"], zo = {
	modelValue: {
		type: String,
		default: ""
	},
...
}), Vo = 200, Ho = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenu",
	inheritAttrs: !1
}, {
	__name: "MatMenu",
	...
	emits: { "update:modelValue": (e) => typeof e == "boolean" },
	setup(e, { emit: n }) {
		let r = $("menu", e), a = n, c = ee(), l = B(), u = h(fa, null), f = h(da, null), p = h(Mt, null), m = j(null), g = j(null), y = j(null), b = L(null), S = i(() => y.value?.root ?? y.value?.$el ?? null), w = te().replace(/[^\w-]/g, "-"), k = i(() => c.id ?? `${w}-menu`), A = `--mat-menu-anchor-${w}`, M = j(!1), N = j("closed"), F = f?.pointerHistory ?? {
			current: {
				x: 0,
				y: 0
			},
		...
		}, I = j(0), R = /* @__PURE__ */ new Map(), H = null, W = !1, G = !1, K = !1, q = At(), J = jt({ motion: q }), Y, X, Z = null, ne = !1, re = !1, ie = i(() => !!u), se = i(() => !!l.activator), ce = i(() => !ie.value && !se.value && we(r.anchor)), le = i(() => I.value > 0), ue = i(() => !ie.value && r.scrim), de = i(() => !ue.value || !!p), fe = i(() => ue.value ? "manual" : "auto"), pe = i(() => ie.value ? M.value : r.modelValue), me = i(() => r.variant ?? f?.variant.value ?? "standard"), he = i(() => r.color ?? f?.color.value), ge = i(() => r.closeOnClick), { colorStyle: _e } = dt(he), ve = i(() => {
		...
		function Ae() {
			S.value && W && (W = !1, K = !0, S.value.hidePopover?.()), ke(), N.value = "closed";
		}
		function je() {
			ke(), N.value = "closed";
		}
		...
		function Ne({ immediate: e = !1 } = {}) {
			if (!(!S.value || !W)) {
				if (K = !0, ze({ immediate: !0 }), e) {
					Oe(), Ae();
					return;
				}
				N.value !== "closing" && J.start({
		...
		async function Le() {
			...
			W || (ce.value && document.activeElement instanceof HTMLElement && (Z = document.activeElement), Q(), W = !0, S.value.showPopover?.()), N.value = "open", ie.value && (u.submenuOpen.value = !0), Ce.refresh(), Ce.focusFirst(), Ie();
		}
		function Re() {
			let e = Te() ?? Z;
			Z = null, v(() => e?.focus());
		...
		function Ue(e) {
			let t = e.target;
			!(t instanceof Node) || S.value?.contains(t) || g.value?.contains(t) || H?.contains(t) || Be();
		}
		function We() {
			let e = S.value, t = e ? Array.from(e.querySelectorAll("[data-mat-menu-item]")) : [];
			ga(Array.from(R.values()).filter((e) => !e.grouped), t);
		}
		function Ge(e) {
		...
		function Xe() {
			...
			for (let n of R.values()) {
				...
				if (ha(e, t, o, o.left < a.left ? "left" : "right")) return !0;
			}
			return !1;
		}
		function Ze(e) {
		...
		function Qe(e) {
			...
			let t = K;
			K = !1, ze(), ie.value && (M.value = !1, u.submenuOpen.value = !1), !(!pe.value || t) && (Me(), ie.value || a("update:modelValue", !1), Re());
		}
		O(da, {
			...
			Ce.observe(), window.addEventListener("resize", Ie), window.addEventListener("scroll", Ie, {
				capture: !0,
				passive: !0
			}), pe.value && (et(), nt()), typeof ResizeObserver < "u" && (X = new ResizeObserver(Ie), X.observe(S.value)), pe.value && Le();
		}), E(() => {
			We(), !(ie.value || !pe.value || ce.value) && Te() !== H && (Ee(), Le());
		}), C(() => {
			Oe(), Y !== void 0 && cancelAnimationFrame(Y), X?.disconnect(), window.removeEventListener("resize", Ie), window.removeEventListener("scroll", Ie, { capture: !0 }), tt(), rt(), Ne({ immediate: !0 }), ke(), Ee(), u?.unregisterSubmenu();
		});
		function $e(e) {
		...
		function et() {
			f || ne || (document.addEventListener("pointermove", $e, !0), ne = !0);
		}
		function tt() {
			ne &&= (document.removeEventListener("pointermove", $e, !0), !1);
		}
		function nt() {
			f || !de.value || re || (document.addEventListener("pointerdown", Ue, !0), re = !0);
		}
		function rt() {
			re &&= (document.removeEventListener("pointerdown", Ue, !0), !1);
		}
		return V(pe, (e) => {
			e ? (et(), nt(), Le()) : (tt(), rt(), Ne());
		}), V(() => r.anchor, async () => {
			...
			ie.value || (S.value && W && (W = !1, K = !0, S.value.hidePopover?.()), ke(), rt(), await v(), pe.value && (nt(), await Le()));
		}), p && V(p.publicContext.layout, Ie), (e, n) => (D(), s(t, null, [
...
}), [["__scopeId", "data-v-3766e101"]]), Uo = { class: "mat-menu-item-host" }, Wo = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenuItem",
	inheritAttrs: !1
}, {
	__name: "MatMenuItem",
	...
	setup(e, { emit: t }) {
		let n = $("menuItem", e), r = t, c = B(), u = h(da, null), f = h(pa, null), p = h(Ne, Me), m = j(null), g = i(() => m.value?.root ?? m.value?.$el ?? null), v = j(!1), y = j(void 0), b = j("only"), x = i(() => !!f), S, w = i(() => !!c.submenu);
		...
		}), (e, t) => (D(), s("span", Uo, [z(n).tooltip ? (D(), a(bn, {
			key: 0,
			content: z(n).tooltip
		}, {
			activator: U(() => [d(ke, _({
				...
				default: U(() => [d(Zi, {
					...
					trailing: U(() => [e.$slots.trailing ? P(e.$slots, "trailing", { key: 0 }, void 0, !0) : w.value ? (D(), a(ht, {
						key: 1,
						as: "span",
...
}), [["__scopeId", "data-v-76262001"]]), Go = ["aria-labelledby"], Ko = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatMenuGroup",
	inheritAttrs: !1
}, {
	__name: "MatMenuGroup",
	...
	setup(e) {
		let t = $("menuGroup", e), n = ee(), r = h(da, null), a = `${te().replace(/[^\w-]/g, "-")}-label`, c = i(() => t.label ? a : n["aria-labelledby"]), l = j(null), u = /* @__PURE__ */ new Set();
		function d() {
		...
		}, R(z(t).label), 1)) : o("", !0), P(e.$slots, "default", {}, void 0, !0)], 16, Go));
	}
}), [["__scopeId", "data-v-b34883b5"]]), qo = [
	"id",
	"aria-describedby",
	"aria-label",
	"aria-disabled",
	...
	emits: {
		"update:modelValue": (e) => e === null || Ci(e) || Array.isArray(e) && e.every(Ci),
		change: (e) => e === null || Ci(e) || Array.isArray(e) && e.every(Ci)
	},
	setup(e, { emit: n }) {
		let r = $("select", e), f = n, p = ee(), m = h(Ne, Me), g = j(!1), b = j(!1), S = j(null), C = te().replace(/[^\w-]/g, "-"), w = i(() => p.id ?? `${C}-select`), T = i(() => ({
			form: p.form,
			name: p.name
		}));
		function E(e, t) {
			...
			return typeof n != "string" || !Ci(i) ? null : {
		...
		function H(e) {
			[
				...
				"ArrowDown",
				"ArrowUp"
			].includes(e.key) && (e.preventDefault(), g.value || B());
		}
		function W(e) {
		...
		return (e, n) => (D(), s("div", {
			...
			d(Lo, {
				...
				control: U(({ controlId: i, describedBy: o }) => [c("div", {
					...
					z(r).chips && M.value ? (D(), s("span", Jo, [(D(!0), s(t, null, N(k.value, (e) => (D(), a(Na, {
						...
						"disabled",
						"onRemove"
					]))), 128))])) : M.value ? (D(), s("span", Yo, R(A.value), 1)) : (D(), s("span", Xo, R(z(r).placeholder), 1)),
			...
			c("select", _(T.value, {
				...
				value: "",
				selected: !M.value
			}, null, 8, Qo)), (D(!0), s(t, null, N(O.value.options, (e) => (D(), s("option", {
				key: `${typeof e.value}:${String(e.value)}`,
				disabled: e.disabled,
				selected: I(e.value),
				value: String(e.value)
			}, R(e.title), 9, $o))), 128))], 16, Zo),
			d(Ho, {
				id: F,
				modelValue: g.value,
				...
				default: U(() => [O.value.groups.length === 0 ? (D(!0), s(t, { key: 0 }, N(O.value.ungrouped, (e) => (D(), a(Wo, {
					key: `${typeof e.value}:${String(e.value)}`,
					disabled: e.disabled,
					...
					name: "leading",
					fn: U(() => [z(r).selectionIndicator === "check" ? (D(), a(ht, {
						key: 0,
						"aria-hidden": "true",
						as: "span",
						icon: "check",
						"optical-size": 20,
						size: "20px"
					})) : z(r).selectionIndicator === "checkbox" ? (D(), a(Ca, {
						key: 1,
						"aria-hidden": "true",
						inert: "",
						tabindex: "-1",
					...
					"tooltip",
					"onClick"
				]))), 128)) : O.value.ungrouped.length > 0 ? (D(), a(Ko, { key: 1 }, {
					default: U(() => [(D(!0), s(t, null, N(O.value.ungrouped, (e) => (D(), a(Wo, {
						key: `${typeof e.value}:${String(e.value)}`,
						disabled: e.disabled,
						selected: z(r).selectionIndicator === "check" && I(e.value),
						tooltip: e.tooltip,
					...
					_: 1
				})) : o("", !0), (D(!0), s(t, null, N(O.value.groups, (e) => (D(), a(Ko, {
					key: e.label,
					label: e.label
				}, {
					default: U(() => [(D(!0), s(t, null, N(e.options, (e) => (D(), a(Wo, {
						key: `${typeof e.value}:${String(e.value)}`,
						disabled: e.disabled,
						selected: z(r).selectionIndicator === "check" && I(e.value),
						tooltip: e.tooltip,
...
}), [["__scopeId", "data-v-aca83b85"]]), ts = /*@__PURE__*/ Object.assign({
	name: "MatTextarea",
	inheritAttrs: !1
}, {
	__name: "MatTextarea",
...
}), ns = { class: "mat-docked-container__panel" }, rs = ["id"], is = { class: "mat-docked-container__body" }, as = {
	key: 1,
	class: "mat-docked-container__actions"
}, os = 200, ss = 150, cs = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { emit: n }) {
		let r = Object.freeze({
			...
			medium: "328px",
			large: "560px"
		}), a = $("dockedContainer", e), l = n, f = ee(), p = B(), m = h(Mt, null), g = j(null), y = j(null), b = j(null), S = L(null), w = i(() => b.value?.root ?? b.value?.$el ?? null), O = te().replace(/[^\w-]/g, "-"), k = i(() => f.id ?? `${O}-docked-container`), A = i(() => `${O}-headline`), M = `--mat-docked-container-anchor-${O}`, N = j("closed"), F = null, I = !1, H = !1, W = !1, G = At(), K = jt({ motion: G }), q, J, Y = null, X = !1, Z = i(() => !!p.activator), ne = i(() => !Z.value && ye(a.anchor)), re = i(() => a.scrim), ie = i(() => !re.value || !!m), se = i(() => re.value ? "manual" : "auto"), ce = i(() => a.modelValue), le = i(() => a.variant ?? "standard"), ue = i(() => a.color), de = i(() => a.headline !== void 0 || !!p.headline), { colorStyle: fe } = dt(ue), pe = i(() => {
			if (a.width !== void 0) {
				let e = xt(a.width, {
					property: "inline-size",
					positive: !0
			...
			let [e, t] = ye(a.offset) ? a.offset : [0, 0], n = {
				...
				positionAnchor: ne.value ? "auto" : M
			};
			return ne.value && ye(a.anchor) && (n.left = `${a.anchor[0]}px`, n.top = `${a.anchor[1]}px`), n;
		}), ge = i(() => {
			let e = S.value;
			if (e) return {
		...
		function we() {
			!re.value || !y.value || H || (H = !0, y.value.showPopover?.());
		}
		function Te() {
		...
		function je() {
			Ae(), q !== void 0 && cancelAnimationFrame(q), q = requestAnimationFrame(ke);
		}
		async function Me() {
			Ce(), W = !1, await v();
			let e = ne.value ? null : Se(), t = ne.value || !!e;
			if (!w.value || !t) {
			...
			I || (ne.value && document.activeElement instanceof HTMLElement && (Y = document.activeElement), we(), I = !0, w.value.showPopover?.()), je(), N.value = "opening", G.wait(w.value, ss, () => {
		...
		function Re(e) {
			...
			let t = W;
			W = !1, !(!ce.value || t) && (Oe(), l("update:modelValue", !1), Ne());
		}
		T(() => {
			window.addEventListener("resize", je), window.addEventListener("scroll", je, {
				capture: !0,
				passive: !0
			}), ce.value && ze(), typeof ResizeObserver < "u" && w.value && (J = new ResizeObserver(je), J.observe(w.value)), ce.value && Me();
		}), E(() => {
			!ce.value || ne.value || be() !== F && (xe(), Me());
		}), C(() => {
			Ce(), q !== void 0 && cancelAnimationFrame(q), J?.disconnect(), window.removeEventListener("resize", je), window.removeEventListener("scroll", je, { capture: !0 }), Be(), Q({ immediate: !0 }), Te(), xe();
		});
		function ze() {
			!ie.value || X || (document.addEventListener("pointerdown", Ie, !0), X = !0);
		}
		function Be() {
			X &&= (document.removeEventListener("pointerdown", Ie, !0), !1);
		}
		return V(ce, (e) => {
			e ? (ze(), Me()) : (Be(), Q(), Ne());
		}), V(() => a.anchor, async () => {
			...
			w.value && I && (I = !1, W = !0, w.value.hidePopover?.()), Te(), Be(), await v(), ce.value && (ze(), await Me());
		}), m && V(m.publicContext.layout, je), (e, n) => (D(), s(t, null, [
			Z.value ? (D(), s("span", {
				key: 0,
				ref_key: "activatorHost",
				ref: g,
			...
			d(ii, _({
				...
				class: ["mat-docked-container", [`mat-docked-container--${le.value}`, {
					"mat-docked-container--coordinate": ne.value,
				...
				default: U(() => [c("div", ns, [
					...
					}, [e.$slots.headline ? P(e.$slots, "headline", { key: 0 }, void 0, !0) : z(a).headline === void 0 ? o("", !0) : (D(), s(t, { key: 1 }, [u(R(z(a).headline), 1)], 64))], 8, rs)) : o("", !0),
					c("div", is, [P(e.$slots, "default", {}, void 0, !0)]),
					e.$slots.actions ? (D(), s("footer", as, [P(e.$slots, "actions", {}, void 0, !0)])) : o("", !0)
				])]),
				_: 3
			}, 16, [
				"id",
...
function us(e, t) {
	...
	function i() {
		let t = e.value;
		return t ? [...t.querySelectorAll(ls)].filter((e) => e instanceof HTMLElement) : [];
	}
	function a(t) {
		if (t.key !== "Tab") return;
		let n = i(), r = e.value;
...
var ds = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSpacer",
	inheritAttrs: !1
}, {
	__name: "MatSpacer",
...
}), [["__scopeId", "data-v-cf9d6504"]]), fs = { class: "mat-dialog__header" }, ps = {
	key: 1,
	class: "mat-dialog__actions"
}, ms = { class: "mat-dialog__content-body" }, hs = {
	key: 0,
	class: "mat-dialog__icon"
}, gs = { class: "mat-dialog__content-body" }, _s = {
	key: 3,
	class: "mat-dialog__actions"
	...
	setup(e, { emit: r }) {
		let l = $("dialog", e), p = r, m = ee(), g = B(), y = f(), b = h(Mt, null), S = Object.prototype.hasOwnProperty.call(y?.vnode.props ?? {}, "attach"), w = j(null), E = j(null), O = j(!1), k = j("closed"), A = j(null), M = L(null), N = `${te().replace(/[^\w-]/g, "-")}-title`, F = i(() => E.value?.root ?? E.value?.$el ?? null), I = i(() => !!M.value), W = i(() => l.title !== void 0 || !!g.title), G = i(() => l.content !== void 0 || !!g.default), K = i(() => !l.fullScreen && (l.icon !== void 0 || !!g.icon)), q = i(() => !!g.activator), J = i(() => zn.value.at(-1) === F.value), { colorStyle: Y } = dt(i(() => l.color)), X = i(() => {
		...
		}), Z = i(() => [m.style]), ne = i(() => [Y.value, X.value]), re = !1, ie = At(), ae = jt({ motion: ie }), oe = null;
		us(F, i(() => O.value && J.value));
		function se() {
		...
		async function _e() {
			...
			oe = e ?? (document.activeElement instanceof HTMLElement ? document.activeElement : null), M.value = n, A.value = r, O.value = !0, k.value = "opening", me(), await v(), !(!l.modelValue || !F.value) && (F.value.open || F.value.show(), tr(F.value, n ? fe(n.context) : void 0), ge(), le(400, () => {
				k.value = "open", p("opened");
			}));
		}
		function ve() {
			let e = F.value;
			e?.open && e.close(), e && nr(e), M.value = null, O.value = !1, k.value = "closed", v(() => {
		...
		function ye() {
			!O.value || k.value === "closing" || ae.start({
				...
				duration: 200,
				getElement: () => F.value,
				isActive: () => re && !l.modelValue && k.value === "closing" && O.value && !!F.value,
				onFinish: ve,
				onStart: () => {
					k.value = "closing";
				}
		...
		return T(() => {
			re = !0, l.modelValue && _e();
		}), C(() => {
			re = !1, ce(), F.value && (nr(F.value), F.value.open && F.value.close());
		}), V(() => l.modelValue, (e) => {
			re && (e ? _e() : ye());
		}), V(() => l.attach, () => {
			...
			default: U(() => [c("div", {
				...
				style: x(ne.value)
			}, [z(l).fullScreen ? (D(), s(t, { key: 0 }, [c("header", fs, [
				d(Mn, {
				...
				default: U(() => [c("div", ms, [z(l).content === void 0 ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(l).content), 1)], 64))])]),
				_: 3
			})) : o("", !0)], 64)) : (D(), s(t, { key: 1 }, [
				K.value ? (D(), s("div", hs, [d(ht, {
					"optical-size": 24,
					size: "24px",
					"aria-hidden": "true"
				}, {
				...
				G.value ? (D(), a(Pa, {
					...
					default: U(() => [c("div", gs, [z(l).content === void 0 ? P(e.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(z(l).content), 1)], 64))])]),
					_: 3
				})) : o("", !0),
				e.$slots.actions ? (D(), s("div", _s, [P(e.$slots, "actions", {}, void 0, !0)])) : o("", !0)
			], 64))], 4)]),
			_: 3
		}, 16, [
			"class",
...
}), [["__scopeId", "data-v-7df0b89c"]]), ys = ["aria-label"], bs = {
	key: 1,
	class: "mat-sheet__header"
}, xs = {
	key: 1,
	class: "mat-sheet__header-actions"
}, Ss = { class: "mat-sheet__content-body" }, Cs = {
	key: 3,
	class: "mat-sheet__footer"
}, ws = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatSheetBase",
	inheritAttrs: !1
}, {
	__name: "MatSheetBase",
	...
	setup(e, { emit: r }) {
		let l = e, p = r, m = ee(), g = B(), b = f(), S = h(Mt, null), w = Object.prototype.hasOwnProperty.call(b?.vnode.props ?? {}, "attach"), E = j(null), O = j(null), k = j(null), A = j(!1), M = j("closed"), N = j(null), F = L(null), I = j(typeof window > "u" ? 0 : window.innerWidth), z = 0, H = j(!1), W = `${te().replace(/[^\w-]/g, "-")}-title`, G = i(() => O.value?.root ?? O.value?.$el ?? null), q = i(() => !!F.value), J = i(() => X.value ? k.value : G.value), Y = i(() => l.variant === "auto" ? I.value < Dt(l.breakpoint, {
			positive: !0,
			fallback: 840
		}) ? "modal" : "standard" : l.variant), X = i(() => Y.value === "modal"), Z = i(() => X.value && zn.value.at(-1) === G.value), ne = i(() => !!g.activator), re = i(() => l.title !== void 0 || !!g.title), ie = i(() => l.content !== void 0 || !!g.default), ae = i(() => l.closable), oe = i(() => [
		...
		]), se = i(() => l.expanded ? X.value ? l.expandedDragHandleLabel : l.collapseDragHandleLabel : l.dragHandleLabel), ce = i(() => re.value || ae.value || !!g.header || !!g.actions), le = i(() => X.value ? "dialog" : "aside"), ue = i(() => {
		...
		}), fe = i(() => [m.style]), pe = i(() => [de.value]), me = !1, he = At(), ge = jt({ motion: he }), _e = null, ve = !1, ye = null, be = 0, xe = 0, Se = 0, Ce = 0, we = !1;
		us(G, i(() => X.value && A.value && Z.value));
		function Te() {
			he.cancel();
		}
		function Ee(e, t) {
		...
		function Me(e) {
			l.direction !== "bottom" || !l.virtualExpand || l.expanded || e.pointerType === "touch" && (Ae = e.clientY);
		}
		function Ne(e) {
			l.direction !== "bottom" || !l.virtualExpand || l.expanded || e.pointerType === "touch" && Ae !== null && Ae - e.clientY >= 8 && (Ae = null, p("update:expanded", !0));
		}
		function Pe(e) {
			e.pointerType === "touch" && (Ae = null);
		}
		function Fe() {
			p("update:modelValue", !1);
		}
		function Ie(e, t) {
			if (z = e, G.value?.style.setProperty("--mat-sheet-drag-offset", `${e}px`), t === null) {
		...
		function ze(e) {
			e.key !== "Enter" && e.key !== " " || (e.preventDefault(), Re());
		}
		function Be() {
			console.warn(`${l.componentName}: activator Slot 必须只渲染一个当前 document 中的 HTMLElement 根节点`);
		}
		function Ve() {
			!X.value || re.value || m["aria-label"] || m["aria-labelledby"] || console.warn(`${l.componentName}: 必须通过 title、title Slot、aria-label 或 aria-labelledby 提供可访问名称`);
		}
		function He() {
		...
		async function Ge() {
			if (Te(), A.value) {
				M.value = "opening", Ee(400, () => {
					M.value = "open", p("opened");
				});
				return;
			}
			let e = ne.value ? De() : null;
			if (ne.value && !e) {
				Be(), Fe();
				return;
			}
			if (X.value) {
				let t = Oe(), n = Q(t), r = n ? n.target : t;
				if (!r) {
					He(), Fe();
					return;
				}
				F.value = n, N.value = r, _e = e ?? (document.activeElement instanceof HTMLElement ? document.activeElement : null);
			} else F.value = null;
			ve = X.value, A.value = !0, M.value = "opening", Ve(), await v(), !(!l.modelValue || !G.value) && (X.value && We(), Ee(400, () => {
				M.value = "open", p("opened");
			}));
		}
		function Ke() {
		...
		function qe() {
			let e = G.value;
			e instanceof HTMLDialogElement && (e.open && e.close(), nr(e)), F.value = null, A.value = !1, M.value = "closed", Le(), v(() => {
				Ke(), p("closed");
			});
		}
		function Je() {
			A.value && M.value !== "closing" && ge.start({
				canStart: () => A.value && M.value !== "closing",
				duration: 200,
				getElement: () => G.value,
				isActive: () => me && !l.modelValue && M.value === "closing" && A.value && !!G.value,
				onFinish: qe,
				onStart: () => {
					M.value = "closing";
				}
		...
		function Ze(e) {
			!X.value || !l.closeOnBack || e.target !== G.value || Fe();
		}
		function Qe(e) {
			if (e.pointerId === ye) {
				if (l.direction === "bottom") {
					if (Ce = e.clientY - be, l.virtualExpand) {
						if (!l.expanded) {
							let e = -xe * .75;
							Ie(Ce < e ? e + (Ce - e) * .2 : Ce, null);
							return;
						}
						Ie(Ce < 0 ? Ce * .2 : Ce, null);
						return;
					}
					if (!l.expanded && Ce < 0 || l.expanded && Ce > 0) {
						Ie(0, Math.max(0, xe - Ce));
						return;
					}
					Ie(Math.max(0, Ce), xe);
					return;
				}
				Ie(l.position === "start" ? Math.max(0, be - e.clientX) : Math.max(0, e.clientX - be), null);
			}
		}
		let $e = Di(Qe);
		function et(e) {
			e.pointerId === ye && $e.schedule(e);
		}
		function tt() {
			ye = null, H.value = !1, window.removeEventListener("pointermove", et), window.removeEventListener("pointerup", nt), window.removeEventListener("pointercancel", rt);
		}
		function nt(e) {
			if (e.pointerId !== ye) return;
			$e.flush();
			let t = J.value, n = l.direction === "bottom" ? t?.getBoundingClientRect().height ?? 0 : t?.getBoundingClientRect().width ?? 0, r = Math.max(1, performance.now() - Se), i = l.direction === "bottom" ? Math.abs(Ce) : z, a = i / r, o = i >= Math.min(120, Math.max(48, n * .15)) || i >= 20 && a >= .35;
			if (we = i >= 4, tt(), l.direction === "bottom" && o) {
				if (!l.expanded && Ce < 0) {
					Le(), p("update:expanded", !0);
					return;
				}
				if (l.expanded && Ce > 0) {
					Le(), p("update:expanded", !1);
					return;
				}
				if (!l.expanded && Ce > 0) {
					Ie(z, null), Fe();
		...
		function it(e) {
			!l.draggable || e.button !== 0 || ye !== null || ($e.cancel(), ye = e.pointerId, be = l.direction === "bottom" ? e.clientY : e.clientX, xe = l.direction === "bottom" ? J.value?.getBoundingClientRect().height ?? 0 : J.value?.getBoundingClientRect().width ?? 0, Se = performance.now(), Ce = 0, Ie(0, l.direction === "bottom" && !l.virtualExpand ? xe : null), H.value = !0, window.addEventListener("pointermove", et), window.addEventListener("pointerup", nt), window.addEventListener("pointercancel", rt));
		}
		function at(e) {
			l.direction !== "side" || e.pointerType !== "touch" || e.target instanceof Element && e.target.closest("button, a, input, textarea, select, [contenteditable=\"true\"]") || it(e);
		}
		function ot(e) {
			X.value || at(e);
		}
		...
		async function ut(e, t) {
			...
			Te();
			let n = G.value;
			if (t === "modal" && n instanceof HTMLDialogElement && (n.open && n.close(), nr(n), Ke(), F.value = null), e === "modal") {
				let e = Oe(), t = Q(e), n = t ? t.target : e;
				if (!n) {
					He(), Fe();
					return;
				}
				F.value = t, N.value = n, _e = document.activeElement instanceof HTMLElement ? document.activeElement : null, ve = !0, Ve();
			}
			M.value = "open", await v(), e === "modal" && l.modelValue && We();
		}
		return T(() => {
			me = !0, lt(), window.addEventListener("resize", lt), l.modelValue && Ge();
		}), C(() => {
			$e.cancel(), me = !1, Te(), tt(), window.removeEventListener("resize", lt);
			let e = G.value;
			e instanceof HTMLDialogElement && (nr(e), e.open && e.close());
		}), V(() => l.modelValue, (e) => {
			me && (e ? Ge() : Je());
		}), V(Y, ut), V(() => l.attach, () => {
			l.modelValue && A.value && X.value && console.warn(`${l.componentName}: 打开期间修改 attach 将在下次打开时生效`);
		}), V(() => l.closeLabel, (e) => {
			...
			style: fe.value,
			"aria-labelledby": r.$attrs["aria-labelledby"] ?? (re.value ? W : void 0),
			...
			default: U(() => [c("div", {
				...
				e.direction === "bottom" && e.dragHandle ? (D(), s("button", {
					...
					onClick: Re,
					onKeydown: ze,
					onPointerdown: K(it, ["stop"])
				}, [P(r.$slots, "drag-handle", {}, () => [i[0] ||= c("span", { class: "mat-sheet__drag-handle" }, null, -1)], !0)], 40, ys)) : o("", !0),
				ce.value ? (D(), s("header", bs, [P(r.$slots, "header", {}, () => [
					re.value ? (D(), s("h2", {
						key: 0,
						id: W,
					...
					r.$slots.actions ? (D(), s("div", xs, [P(r.$slots, "actions", {}, void 0, !0)])) : o("", !0),
					ae.value ? (D(), a(Mn, {
						key: 2,
				...
				ie.value ? (D(), a(Pa, {
					...
					default: U(() => [c("div", Ss, [e.content === void 0 ? P(r.$slots, "default", { key: 1 }, void 0, !0) : (D(), s(t, { key: 0 }, [u(R(e.content), 1)], 64))])]),
					_: 3
				})) : o("", !0),
				r.$slots.footer ? (D(), s("div", Cs, [P(r.$slots, "footer", {}, void 0, !0)])) : o("", !0)
			], 38)]),
			_: 3
		}, 16, [
			"as",
...
}), [["__scopeId", "data-v-e5da24a5"]]), Ts = /*@__PURE__*/ Object.assign({
	name: "MatBottomSheet",
	inheritAttrs: !1
}, {
...
}), Ds = { class: "mat-container__content" }, Os = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatContainer",
	inheritAttrs: !1
}, {
	__name: "MatContainer",
	...
	setup(e) {
		let t = $("container", e);
		return (e, n) => (D(), s("div", _(e.$attrs, { class: ["mat-container", { "mat-container--fluid": z(t).fluid }] }), [c("div", Ds, [P(e.$slots, "default", {}, void 0, !0)])], 16));
	}
}), [["__scopeId", "data-v-f2274c15"]]), ks = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatLayout",
	inheritAttrs: !1
}, {
	__name: "MatLayout",
	...
	setup(e) {
		let t = [
			...
			"start",
			"end"
		], n = $("layout", e), r = ee(), o = j(null), s = j(null), l = k({
			size: {
				width: 0,
				height: 0
			},
			...
			"--mat-layout-padding-top": `${l.padding.top}px`,
			"--mat-layout-padding-bottom": `${l.padding.bottom}px`,
			"--mat-layout-padding-left": `${l.padding.left}px`,
			"--mat-layout-padding-right": `${l.padding.right}px`,
			"--mat-layout-padding-start": `${l.padding.start}px`,
			"--mat-layout-padding-end": `${l.padding.end}px`
		}]), f = [], p = !1, m, h, g = !1;
		function y() {
			if (!p || !o.value) return;
			let e = o.value.getBoundingClientRect(), t = Math.max(0, Number(e.width) || 0), n = Math.max(0, Number(e.height) || 0), r = {
				top: 0,
				bottom: 0,
				left: 0,
				right: 0,
			...
			i.sort((e, t) => {
				...
				let t = e.element.getBoundingClientRect(), n = e.edge, i = e.insets;
				if (n === "top") {
					let e = Math.max(0, Number(t.height) || t.bottom - t.top || 0);
					i.top = r.top, i.left = r.left, i.start = r.left, i.right = r.right, i.end = r.right, i.bottom = 0, i.offset = r.top, r.top += e;
				} else if (n === "bottom") {
					let e = Math.max(0, Number(t.height) || t.bottom - t.top || 0);
					i.bottom = r.bottom, i.left = r.left, i.start = r.left, i.right = r.right, i.end = r.right, i.top = 0, i.offset = r.bottom, r.bottom += e;
				} else if (n === "left" || n === "start") {
					let e = Math.max(0, Number(t.width) || t.right - t.left || 0);
					i.left = r.left, i.start = r.left, i.top = r.top, i.bottom = r.bottom, i.right = 0, i.end = 0, i.offset = r.left, r.left += e, r.start += e;
				} else if (n === "right" || n === "end") {
					let e = Math.max(0, Number(t.width) || t.right - t.left || 0);
					i.right = r.right, i.end = r.right, i.top = r.top, i.bottom = r.bottom, i.left = 0, i.start = 0, i.offset = r.right, r.right += e, r.end += e;
				}
			}), Object.assign(l.size, {
				width: t,
				height: n
			}), Object.assign(l.padding, r);
		}
		function b() {
			if (!p || g) return;
			g = !0;
			...
			if (typeof window < "u" && typeof window.requestAnimationFrame == "function") {
				h = window.requestAnimationFrame(e);
				return;
			}
			h = setTimeout(e, 0);
		}
		function x({ edge: e, element: n } = {}) {
			if (!t.includes(e)) throw TypeError("registerEdge() 的 edge 必须是 top、bottom、left、right、start 或 end");
			if (!(n instanceof HTMLElement) || n.ownerDocument !== document) throw TypeError("registerEdge() 的 element 必须是当前 document 中的 HTMLElement");
			let r = k({
				bottom: 0,
				end: 0,
			...
			return f.push(i), m?.observe(n), b(), Object.freeze({
				insets: A(r),
				unregister: () => {
					i.active && (i.active = !1, m?.unobserve?.(n), b());
				},
				update: () => {
					i.active && b();
				}
		...
		return O(Ln, {
			...
			p = !0, m = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(b), m?.observe(o.value), f.forEach((e) => {
				e.active && m?.observe(e.element);
			}), window.addEventListener("resize", b), await v(), b();
		}), C(() => {
			p = !1, m?.disconnect(), m = void 0, window.removeEventListener("resize", b), h !== void 0 && (typeof window < "u" && typeof window.cancelAnimationFrame == "function" ? window.cancelAnimationFrame(h) : clearTimeout(h));
		}), (e, t) => (D(), a(F(z(n).as), _({
			ref_key: "rootElement",
			ref: o
		}, e.$attrs, {
			...
			default: U(() => [c("div", {
				ref_key: "contentElement",
				ref: s,
				class: "mat-layout__content"
			}, [P(e.$slots, "default", {}, void 0, !0)], 512)]),
			_: 3
		}, 16, ["style"]));
	}
}), [["__scopeId", "data-v-3d041fba"]]), As = /*@__PURE__*/ Object.assign({
	...
	setup(e, { expose: n, emit: r }) {
		let i = $("virtualScroll", e), o = r, l = j(null), { calculate: u, getItemKey: d, getScroller: f, paddingBottom: p, paddingTop: m, refresh: h, scrollTo: g, scrollToIndex: _, setItemRef: v, visibleItems: y } = Ei({
			root: l,
			props: i,
			enabled: !0,
			pinEdges: !1,
	...
	setup(e) {
		let t = $("loading", e), { colorStyle: n } = dt(i(() => t.color)), r = j(0), a, o = 0, c, l, u = i(() => {
			...
			return Math.min(Math.max(e, Ps), Fs);
			...
			...f.value,
			...g.value
		})), y = i(() => u.value * (38 / 48)), b = i(() => p.value ? h.value >= 1 ? "soft-burst" : "circle" : qr[r.value]), S = i(() => {
		...
		function k(e) {
			...
			c !== void 0 && (o += e - c), c = e;
			let t = Math.floor(o / Is) % qr.length;
...
}), [["__scopeId", "data-v-47a074d9"]]), Rs = { class: "mat-pull-to-refresh__indicator" }, zs = 80, Bs = .5, Vs = 4, Hs = 600, Us = 1600, Ws = 80, Gs = 700, Ks = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatPullToRefresh" }, {
	...
	setup(e, { emit: t }) {
		let n = 2 * Math.sqrt(Gs) * .9, r = e, a = $("pullToRefresh", r), o = t, l = h(Ti, null), u = l?.scroller ?? j(null), f = l?.orientation ?? j("vertical"), p = i(() => f.value === "horizontal"), m = i(() => Dt(a.triggerDistance, {
			positive: !0,
			fallback: zs
		...
		function Z(e) {
			_.value = !0, g.value = "refresh", P = !1, F = 0, b.value = 0, Y.start(v.value, 0), S.value < 1 && X(), e && (o("update:modelValue", !0), o("refresh"));
		}
		function ne() {
			g.value !== "collapse" && (g.value = "collapse", b.value = 0, Y.start(v.value, 0), J.start(S.value, 0));
		}
		function re() {
			_.value = !1, ne();
		}
		V(() => r.modelValue, (e) => {
			e && !_.value ? Z(!1) : !e && _.value && re();
		}), V(() => a.disabled, (e) => {
		...
		function ce(e) {
			...
			if (!M) {
				...
				M = !0, N = !0, X(), T.setPointerCapture?.(e.pointerId);
			}
			if (F = Math.max(0, t - Vs), F <= 0) {
				le(e.pointerId);
				return;
			}
			oe(), e.preventDefault();
		...
		function me(e) {
			...
			if (!P) {
				...
				P = !0, F = 0, g.value = "drag", X();
			}
			if (F = Math.max(0, F + t), F <= 0) {
				P = !1, ne();
				return;
			}
			e.preventDefault(), oe(), F * Bs >= m.value && Z(!0);
		}
		function he() {
			P && (P = !1, F = 0, ne());
		}
...
}), [["__scopeId", "data-v-c84588cf"]]), qs = ["aria-valuemax", "aria-valuenow"], Js = ["width", "height"], Ys = { key: 0 }, Xs = ["width", "height"], Zs = { class: "mat-progress__linear-bar mat-progress__linear-bar--primary" }, Qs = ["d"], $s = { class: "mat-progress__linear-bar mat-progress__linear-bar--secondary" }, ec = ["d"], tc = ["d", "mask"], nc = { class: "mat-progress__linear-bar mat-progress__linear-bar--primary" }, rc = ["d"], ic = { class: "mat-progress__linear-bar mat-progress__linear-bar--secondary" }, ac = ["d"], oc = ["d"], sc = {
	key: 1,
	class: "mat-progress__linear-stop"
}, cc = ["viewBox"], lc = { class: "mat-progress__circular-linear-rotate" }, uc = { class: "mat-progress__circular-rotate-arc" }, dc = [
	"cx",
	"cy",
	"r"
], fc = ["d"], pc = 4, mc = 48, hc = 24, gc = 240, _c = 4, vc = 4.8, yc = 3, bc = 40, xc = 15, Sc = 18, Cc = 20.4, wc = 2, Tc = 4, Ec = .001, Dc = 100, Oc = 300, kc = 900, Ac = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatProgress",
	inheritAttrs: !1
}, {
	__name: "MatProgress",
	...
	setup(e) {
		...
		function u(e, t, n, r, i) {
			...
			for (let e = s + 2; e < c; e += 2) {
				let t = (e - s) / bc * Math.PI * 2, n = o - Math.sin(t - i) * r;
				l.push(`L ${a(e)} ${a(n)}`);
			}
			let u = (c - s) / bc * Math.PI * 2, d = o - Math.sin(u - i) * r;
		...
		let f = $("progress", e), { colorStyle: p } = dt(i(() => f.color)), m = j(null), h = j(Dc), g = j(+(f.shape === "wavy")), v = j(0), y = `mat-progress-linear-mask-${te()}`, b, S, w, E = i(() => r(f.max) ? f.max : 1), O = i(() => f.variant === "circular"), k = i(() => f.shape === "wavy"), A = i(() => {
			let e = Dt(f.size, {
				allowNegative: !0,
				fallback: mc
			});
			return Math.min(Math.max(e, hc), gc);
		}), M = i(() => A.value / 12), N = i(() => M.value * 2), P = i(() => A.value / mc), F = i(() => 1.6 * P.value), I = i(() => xc * P.value), L = i(() => wc * P.value), R = i(() => O.value ? f.thickness === "heavy" ? N.value : M.value : f.thickness === "heavy" ? vc : _c), ee = i(() => {
			let e = n(f.value) ? f.value : 0;
			return Math.min(Math.max(e, 0), E.value);
		}), B = i(() => Number((ee.value / E.value * 100).toFixed(3))), H = i(() => R.value + yc * 2 * g.value), U = i(() => Math.min(100, R.value / h.value * 100)), W = i(() => {
			let e = h.value - R.value;
			return e <= 0 ? 1 : h.value / e;
		}), G = i(() => B.value === 100 ? 100 : Math.min(100, Math.max(B.value, U.value + Ec))), K = i(() => u(h.value, H.value, R.value, 0, 0)), q = i(() => u(h.value, H.value, R.value, yc * g.value, v.value)), J = i(() => A.value / 2), Y = i(() => (Sc + (Cc - Sc) * g.value) * P.value), X = i(() => `0 0 ${A.value} ${A.value}`), Z = i(() => d(J.value, Y.value, F.value * g.value, v.value, I.value)), ne = i(() => {
			let e = Math.PI * 2 * Y.value;
			return (pc + R.value) / e * 100;
		}), re = i(() => Math.min(12, ne.value)), ie = i(() => {
			if (f.indeterminate) return {};
			let e = Number(Math.max(0, 100 - B.value - ne.value * 2).toFixed(3)), t = Number(Math.min(100, B.value + ne.value).toFixed(3));
			return {
				opacity: +(e > 0),
				strokeDasharray: `${a(e)} ${a(100 - e)}`,
				strokeDashoffset: `-${a(t)}`
			};
		}), ae = i(() => f.indeterminate ? {} : { strokeDasharray: `${a(B.value === 0 ? Ec : B.value)} 200` }), oe = i(() => ({
			...p.value,
			...
			"--mat-progress-progress": `${B.value}`,
			"--mat-progress-stop-indicator-size": `${Tc}px`,
		...
		function se(e) {
			...
			if (w = e, t > 0 && r !== 0) {
				let e = Math.min(Math.abs(r), t / Oc);
				g.value += Math.sign(r) * e;
			}
			t > 0 && f.waveMotion && g.value > 0 && (v.value += t / kc * Math.PI * 2, v.value %= Math.PI * 2);
		...
		return V(k, ce), V(() => f.waveMotion, ce), T(() => {
			...
			(D(), s("svg", {
				...
				z(f).indeterminate ? (D(), s("defs", Ys, [c("mask", {
					id: y,
				...
				z(f).indeterminate ? (D(), s(t, { key: 2 }, [c("g", nc, [c("path", {
			...
			z(f).indeterminate ? o("", !0) : (D(), s("span", sc))
		], 512))], 16, qs));
	}
}), [["__scopeId", "data-v-90a3c307"]]), jc = Symbol("mat-snackbar-externally-managed"), Mc = [], Nc = null;
function Pc() {
	Nc || Mc.length === 0 || (Nc = Mc.shift(), Nc.activate());
}
function Fc(e) {
	e === Nc || Mc.includes(e) || (Mc.push(e), Pc());
}
function Ic(e) {
	let t = Mc.indexOf(e);
	t !== -1 && Mc.splice(t, 1);
...
var Rc = { class: "mat-snackbar__text" }, zc = {
	key: 0,
	...
	setup(e, { emit: r }) {
		...
		function ie() {
			b.value && (b.value = !1, x.value = "closed", f("closed"), y || Lc(q));
		}
		function ae() {
			if (J(), !b.value) {
				y || Ic(q);
		...
		return T(() => {
			I = !0, g || (W = pn(K), K()), l.modelValue && ue();
		}), C(() => {
			I = !1, W?.(), W = null, J(), Y(), y || (b.value ? Lc(q) : Ic(q));
		}), V(() => l.modelValue, (e) => {
			if (I) {
				if (e) {
					S.value = !1, ue();
			...
			"aria-live": "polite",
			role: "status"
		}), [c("div", Rc, [e.$slots.default ? P(e.$slots, "default", { key: 0 }, void 0, !0) : (D(), s(t, { key: 1 }, [u(R(z(l).text), 1)], 64))]), k.value ? (D(), s("div", zc, [E.value ? (D(), s("div", Bc, [e.$slots.action ? P(e.$slots, "action", {
			key: 0,
			action: ce
		}, void 0, !0) : (D(), a(ke, {
			key: 1,
			...
			_: 1
		}, 8, ["use-cursor"]))])) : o("", !0), O.value ? (D(), s("div", Vc, [e.$slots.close ? P(e.$slots, "close", {
			key: 0,
			close: se
		}, void 0, !0) : (D(), a(ke, {
			key: 1,
...
}), [["__scopeId", "data-v-6a4f08b6"]]), Uc = ["aria-orientation"], Wc = { class: "mat-toolbar__surface" }, Gc = { class: "mat-toolbar__content" }, Kc = 200, qc = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatToolbar",
	inheritAttrs: !1
}, {
	__name: "MatToolbar",
	...
	setup(e) {
		...
		let u = $("toolbar", e), d = ee(), p = B(), m = f(), g = h(Mt, null), y = m?.vnode.props ?? {}, b = Object.prototype.hasOwnProperty.call(y, "attach"), S = j(u.modelValue), w = j(u.modelValue ? "open" : "closed"), E = j(null), O = j(null), k = j({
			blockSize: 0,
			inlineSize: 0
		...
		]), q = L(null), J, Y, X = !1, Z = !1, ne = At(), re = jt({ motion: ne }), ie = !1;
		function ae() {
			ne.cancel();
		}
		function oe(e) {
			ne.wait(E.value, Kc, e);
		}
		async function se() {
			ae(), S.value = !0, w.value = "opening", await v(), !(!Z || !S.value || !u.modelValue || w.value !== "opening") && oe(() => {
		...
		function ce() {
			...
			w.value !== "closing" && re.start({
				canStart: () => S.value && w.value !== "closing",
				duration: Kc,
				getElement: () => E.value,
				isActive: () => Z && !u.modelValue && S.value && w.value === "closing",
				onFinish: () => {
		...
		function pe() {
			Y?.disconnect(), Y = void 0, X = !1, window.removeEventListener("resize", ue), J?.unregister(), J = void 0, q.value?.unregister(), q.value = null;
		}
		async function me() {
			if (await v(), Z) {
				if (!S.value || !E.value) {
				...
				X || (X = !0, Y = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(ue), Y?.observe(E.value), window.addEventListener("resize", ue)), R.value ? (J?.unregister(), J = void 0, !N.value && !q.value && (q.value = g.publicContext.registerEdge({
					edge: "bottom",
					element: E.value
				})), N.value && q.value && (q.value.unregister(), q.value = null)) : (q.value?.unregister(), q.value = null, J ||= un(E.value, {
					getRect: de,
					isBottom: () => I.value
		...
		}), [c("div", Wc, [c("div", Gc, [P(r.$slots, "default", {}, void 0, !0)])]), N.value && z(p).fab ? (D(), s("div", {
			key: 0,
			ref_key: "fabElement",
			ref: O,
			class: "mat-toolbar__fab"
		}, [P(r.$slots, "fab", {}, void 0, !0)], 512)) : o("", !0)], 16, Uc)) : o("", !0)], 8, ["to", "disabled"]))], 64));
	}
}), [["__scopeId", "data-v-49a9f065"]]), Jc = Symbol("mat-panes"), Yc = [
	"compact",
	"medium",
	"expanded",
	"large",
	...
	emits: {
		...
		"update:breakpoint": (e) => Yc.includes(e)
	},
	setup(e, { emit: t }) {
		...
		function Y(e, t) {
			...
			t.preventDefault(), B(H(r.left.id, r.right.id, u, c, o));
		}
		function X(e) {
...
}), [["__scopeId", "data-v-e119bd21"]]), Zc = ["id"], Qc = {
	key: 0,
	...
	"aria-valuemin",
	"aria-valuenow"
], el = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	name: "MatPane",
	inheritAttrs: !1
}, {
	__name: "MatPane",
	...
	setup(e) {
		let n = $("pane", e), r = h(Jc, null), a = j(null), l = i(() => n.resizeLabel), u, d = i(() => r?.getPaneStyle(n.id) ?? { "--mat-pane-weight": 1 }), f = i(() => !!r?.hasBoundary(n.id)), p = i(() => !!r?.isHandleVisible(n.id)), m = i(() => r?.getHandleAttributes(n.id) ?? {}), g = i(() => !!r?.isBoundaryActive(n.id));
		function v() {
		...
		return T(v), V(() => n.id, v), C(() => u?.()), (i, l) => (D(), s(t, null, [c("div", _({
			...
			class: "mat-pane",
			style: d.value
		}), [P(i.$slots, "default", {}, void 0, !0)], 16, Zc), f.value ? (D(), s("div", Qc, [p.value ? (D(), s("div", {
			key: 0,
		...
		}, null, 42, $c)) : o("", !0)])) : o("", !0)], 64));
	}
}), [["__scopeId", "data-v-1bf28501"]]), tl = Symbol("mat-navigation-rail"), nl = { class: "mat-navigation-item__indicator mat-navigation-rail-item__indicator mat-navigation-bar-item__indicator" }, rl = {
	key: 0,
	class: "mat-navigation-item__icon-wrap mat-navigation-rail-item__icon-wrap mat-navigation-bar-item__icon-wrap"
}, il = { class: "mat-navigation-item__label-wrap mat-navigation-rail-item__label-wrap mat-navigation-bar-item__label-wrap" }, al = {
	key: 0,
	...
	setup(e, { emit: n }) {
		let r = [
			...
			"bottom-start",
			"start"
		], l = $("navigationItem", e), u = n, d = B(), f = h(Ne, Me), p = h(tl, null), m = i(() => p?.expanded.value ?? !1), g = i(() => p?.fullWidth.value ?? !1), v = i(() => p?.orientation.value === "horizontal"), b = i(() => p?.isSelected(l.value) ?? !1), x = i(() => !!(d.icon || l.icon && l.icon.trim())), S = i(() => x.value || !m.value), C = i(() => x.value ? l.icon : "circle"), w = i(() => {
			let e = l.badge;
			return e ? {
		...
		}), T = i(() => An("label", m.value && !v.value ? "large" : "medium")), E = i(() => An("label", "medium")), O = i(() => ({
		...
		return (e, n) => (D(), a(ke, _(e.$attrs, {
			...
			default: U(() => [
				c("span", nl, [
					S.value ? (D(), s("span", rl, [w.value ? (D(), a(Oa, {
						key: 0,
						color: w.value.color,
					...
					c("span", il, [c("span", { class: y([
						"mat-navigation-item__label",
						"mat-navigation-rail-item__label",
						"mat-navigation-bar-item__label",
						T.value
					]) }, [P(e.$slots, "default", {}, void 0, !0)], 2)]),
					g.value ? (D(), s(t, { key: 1 }, [e.$slots.trailing ? (D(), s("span", al)) : o("", !0), e.$slots.trailing ? (D(), s("span", ol, [P(e.$slots, "trailing", {
						expanded: m.value,
						selected: b.value
					}, void 0, !0)])) : o("", !0)], 64)) : o("", !0)
				]),
				...
				g.value ? o("", !0) : (D(), s(t, { key: 0 }, [e.$slots.trailing ? (D(), s("span", sl)) : o("", !0), e.$slots.trailing ? (D(), s("span", cl, [P(e.$slots, "trailing", {
					expanded: m.value,
					selected: b.value
				}, void 0, !0)])) : o("", !0)], 64))
			]),
...
}), [["__scopeId", "data-v-93081cfe"]]), ul = /*@__PURE__*/ Object.assign({
...
}), dl = { class: "mat-navigation-rail__layout" }, fl = {
	key: 0,
	...
	setup(e, { expose: n, emit: l }) {
		let u = $("navigationRail", e), p = l, v = h(Ne, Me), b = B(), S = h(Mt, null), w = h(Ln, null), E = f()?.vnode.props ?? {}, k = i(() => Object.prototype.hasOwnProperty.call(E, "attach") && E.attach !== void 0), A = i(() => k.value ? u.attach : void 0), M = j(null), N = i(() => {
			if (u.mode !== void 0) return u.mode;
			if (!u.app) return w || F.value && S ? "docked" : "flow";
		}), F = i(() => u.layout === "modal"), I = i(() => u.hideOnCollapse && !u.expanded), L = j(u.expanded), R = j(!I.value), ee = i(() => R.value && !!b.header), te = i(() => u.expanded), H = i(() => u.open === void 0 ? u.hideOnCollapse || F.value ? u.expanded : !0 : u.open), W = At(), G = jt({ motion: W });
		function K() {
			if (W.cancel(), u.expanded || !I.value) {
				L.value = u.expanded, R.value = !0;
				return;
			}
			G.start({
				canStart: () => I.value,
				duration: 200,
				getElement: () => M.value?.hostElement,
				isActive: () => I.value && R.value && !!M.value?.hostElement,
				onFinish: () => {
					L.value = !1, R.value = !1;
				},
				onStart: () => {
		...
		V(() => u.expanded, K);
		let q = i(() => u.app && !!S && !k.value), J = i(() => {
			if (!u.app || q.value) return null;
			if (typeof u.attach == "string") try {
				return document.querySelector(u.attach);
			} catch {
				return null;
			}
			return u.attach instanceof HTMLElement ? u.attach : null;
		}), Y = i(() => !u.app || q.value || !!J.value);
		function X() {
			u.app && !q.value && !J.value && console.warn("MatNavigationRail: attach 必须指向当前 document 中存在的 HTMLElement");
		}
		function Z(e) {
			return e.type === ul || e.type?.name === "MatNavigationRailItem" || e.type === ll || e.type?.name === "MatNavigationItem";
		}
		function ne(e) {
			if (Z(e)) return !0;
		...
		function re(e) {
			return g(e) ? e.type === t && Array.isArray(e.children) ? m(t, { key: e.key }, e.children.map(re)) : Z(e) || te.value || ne(e) ? e : r(e, { hidden: !0 }) : e;
		}
		function ie() {
			return b.default?.({
				expanded: u.expanded,
		...
		let ae = i(() => {
			if (u.width !== void 0) {
				let e = xt(u.width, { property: "inline-size" });
				if (e !== void 0) return e === "0" ? "0" : e;
			}
			return u.expanded || F.value ? "var(--mat-navigation-rail-expanded-width, 240px)" : "var(--mat-navigation-rail-collapsed-width, 80px)";
		}), oe = i(() => ({
			...
			"mat-navigation-rail-host--app": u.app,
			"mat-navigation-rail-host--app-root": u.app && !!S && !k.value,
			"mat-navigation-rail--expanded": u.expanded,
			"mat-navigation-rail--collapsed": !u.expanded,
			"mat-navigation-rail--modal": F.value && u.expanded,
			"mat-navigation-rail--with-header": ee.value,
			"mat-navigation-rail--app": u.app
		})), se = i(() => {
			let e = {};
			if (u.width !== void 0) {
				let t = xt(u.width, { property: "inline-size" });
				t !== void 0 && (e["--mat-navigation-rail-expanded-width"] = t);
			}
			return F.value && (e.maxInlineSize = q.value ? "calc(100% - var(--mat-navigation-rail-modal-edge-space, 8px))" : "calc(100dvi - var(--mat-navigation-rail-modal-edge-space, 8px))"), e;
		});
		function ce(e) {
			p("update:open", e), !e && (F.value || u.hideOnCollapse) && p("update:expanded", !1);
		}
		return O(tl, {
			...
			requestSelection: (e) => {
				e !== void 0 && !Object.is(u.modelValue, e) && p("update:modelValue", e);
			},
			useCursor: v.useCursor
		}), T(() => {
			X();
		}), C(() => {
			W.cancel();
			...
			asideRef: M,
			hostElement: i(() => M.value?.hostElement)
		}), (e, t) => Y.value ? (D(), a(ir, _({
			key: 0,
			ref_key: "asideRef",
			ref: M,
			as: "nav",
			...
			default: U(() => [d(Pa, {
				...
				default: U(() => [c("div", dl, [ee.value && R.value ? (D(), s("div", fl, [P(e.$slots, "header", { expanded: z(u).expanded }, void 0, !0)])) : o("", !0), R.value ? (D(), s("div", pl, [c("div", { class: y(["mat-navigation-rail__destinations", [`mat-navigation-rail__destinations--${z(u).alignment}`, { "mat-navigation-rail__destinations--show-custom-content": te.value }]]) }, [d(ie)], 2)])) : o("", !0)])]),
				_: 3
			})]),
			_: 3
		}, 16, [
...
}), [["__scopeId", "data-v-923c1c7c"]]), hl = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({
	...
	setup(e, { expose: t, emit: n }) {
		let r = $("navigationBar", e), o = n, s = h(Ne, Me), l = h(Ln, null), u = j(null), d = f()?.vnode.props ?? {}, p = i(() => Object.prototype.hasOwnProperty.call(d, "attach") && d.attach !== void 0), m = i(() => p.value ? r.attach : void 0), g = i(() => {
	...
	setup(e, { emit: t }) {
		...
		}, [c("div", yl, [P(e.$slots, "default", {}, void 0, !0)])], 8, vl)], 16));
	}
}), [["__scopeId", "data-v-260c72e4"]]), xl = /* @__PURE__ */ new WeakMap();
function Sl(e) {
...
function Cl(e, t) {
	...
	let { handler: n, options: r } = Sl(t.value), i = new IntersectionObserver((t, r) => {
		let i = xl.get(e);
		if (!i || i.observer !== r) return;
		let a = t.some((e) => e.isIntersecting), o = !i.initialized;
		i.initialized = !0, n && !(i.quiet && o) && n(a, t, r), i.once && a && (r.unobserve(e), xl.delete(e));
	}, r);
	xl.set(e, {
		handler: n,
		observer: i,
...
function wl(e) {
	let t = xl.get(e);
	t && (t.observer.unobserve(e), xl.delete(e));
}
var Tl = {
	mounted: Cl,
	updated(e, t) {
		xl.has(e) && (wl(e), Cl(e, t));
	},
	unmounted: wl
}, El = Object.freeze({
...
//#endregion
//#region src/theme.js
var Ml = "#20a6fc", Nl = "(prefers-color-scheme: dark)";
function Pl(e) {
	if (![
		"light",
		"dark",
...
function zl(e = {}) {
	...
	let t = e.mode ?? "system", n = e.seedColor ?? Ml, r = e.schemeVariant ?? "tonal-spot", i = e.contrastLevel ?? 0, a = e.target ?? document.documentElement;
	Pl(t), Rl(n), Fl(r), Il(i), Ll(a);
	let o = j(t), s = j(it(n)), c = j(r), l = j(i), u = j("light"), d = null, f = !1, p = !1;
	function m() {
		return !d && typeof window.matchMedia == "function" && (d = window.matchMedia(Nl)), d;
	}
	function h() {
...
function Gl(e) {
	...
	return Object.freeze({
		openDelay: Wl(e, "openDelay"),
		closeDelay: Wl(e, "closeDelay")
	});
}
function Kl(e) {
...
function Jl(e = {}) {
	...
	return {
		...
		install(e) {
			Bl.forEach(([t, n, r]) => {
				e.component(t, r), e.component(n, r), (El[t] ?? []).forEach((t) => {
					e.component(t, r);
				});
			}), e.directive("intersection", Tl), e.directive("state-layer", Oe), e.provide(Ne, t), e.provide(ct, n), kl(t, n);
		}
	};
}
function Yl() {
...
function $l() {
	...
	async function n(n, r = {}) {
		...
		try {
			...
			o(), t === s && (t = null), e === l && (e = null), Br(c), await v();
		}
	}
	return Object.freeze({
		get supported() {
...
var eu = $l, tu = {
...
}, nu = /*#__PURE__*/ Q(/* @__PURE__ */ Object.assign({ name: "MatImperativeDialogHost" }, {
	...
	setup(e) {
		...
		return (n, r) => (D(), a(vs, _({
			...
			actions: U(() => [d(ds), (D(!0), s(t, null, N(e.options.actions, (t, n) => (D(), a(Mn, {
				key: n,
				color: t.color,
			...
			default: U(() => [p.value ? (D(), s(t, { key: 0 }, [e.options.content ? (D(), s("p", tu, R(e.options.content), 1)) : o("", !0), d(Bo, {
				modelValue: f.value,
...
function uu(e) {
	...
	if (e.variant !== void 0 && !ru.includes(e.variant)) throw TypeError("dialog action variant 无效");
...
function du(e) {
	...
	if (e.width !== void 0 && !ou(e.width)) throw TypeError("dialog width 无效");
...
function mu(e = {}) {
	try {
		if (cu(e), e.confirmText !== void 0 && (typeof e.confirmText != "string" || e.confirmText.trim().length === 0)) throw TypeError("alert confirmText 必须是非空字符串");
		return fu({
			...e,
			actions: [{
...
var _u = /*@__PURE__*/ Object.assign({ name: "MatImperativeSnackbarHost" }, {
...
function Su(e) {
	if (xu(e), typeof e.text != "string" || e.text.trim().length === 0) throw TypeError("snackbar text 必须是非空字符串");
	...
	if (e.position !== void 0 && !vu.includes(e.position)) throw TypeError("snackbar position 无效");
...
function Cu() {
	return yu?.isConnected ? yu : (yu = document.createElement("div"), yu.dataset.matSnackbarHost = "", document.body.append(yu), yu);
}
function wu() {
	!yu || yu.childNodes.length > 0 || (yu.remove(), yu = null);
}
function Tu(e) {
	try {
		bu();
		...
		return new Promise((e, n) => {
			...
			function a() {
				...
				r = !0;
				let t = yu;
				t && M(null, t), e(), Lc(i), wu();
			}
			function o(e) {
				if (r) return;
				r = !0;
				let t = yu;
				t && M(null, t), n(e), Lc(i), wu();
			}
			i = { activate() {
				try {
					let e = Cu();
...
var Eu = Tu;
//#endregion
export { Tl as Intersection, gr as MatAppBar, In as MatAppRoot, ir as MatAside, Wr as MatAvatar, Oa as MatBadge, Ts as MatBottomSheet, Mn as MatBtn, Sr as MatBtnGroup, di as MatCard, pi as MatCardActionArea, _i as MatCardActions, hi as MatCardContent, oi as MatCardHeadline, ci as MatCardMedia, ui as MatCardSubhead, Ca as MatCheckbox, Na as MatChip, Ia as MatChipSet, Os as MatContainer, vs as MatDialog, _a as MatDivider, cs as MatDockedContainer, ti as MatDynamicText, qi as MatExpansion, ua as MatExpansionPanel, kr as MatFab, Pr as MatFabMenu, Ot as MatHover, ht as MatIcon, Ir as MatImage, _r as MatInputBase, ks as MatLayout, Gi as MatList, sa as MatListGroup, ia as MatListItem, Ls as MatLoading, Ho as MatMenu, Ko as MatMenuGroup, Wo as MatMenuItem, hl as MatNavigationBar, gl as MatNavigationBarItem, _l as MatNavigationDrawer, bl as MatNavigationGroup, ll as MatNavigationItem, ml as MatNavigationRail, ul as MatNavigationRailItem, el as MatPane, Xc as MatPanes, Ac as MatProgress, Ks as MatPullToRefresh, Ra as MatRadio, Va as MatRadioGroup, So as MatRangeSlider, Pa as MatScrollArea, br as MatSearch, es as MatSelect, Jr as MatShape, Vr as MatSharedElement, Vr as MdeSharedElement, Es as MatSideSheet, vo as MatSlider, Hc as MatSnackbar, ds as MatSpacer, ri as MatSplitBtn, Ha as MatSwitch, As as MatTableWrapper, Yr as MatText, Bo as MatTextField, ts as MatTextarea, qc as MatToolbar, bn as MatTooltip, js as MatVirtualScroll, js as MdeVirtualScroll, Oe as StateLayer, mu as alert, hu as confirm, Jl as createMatUi, pu as dialog, gu as prompt, Tu as snackbar, Eu as toast, Rn as useLayout, Lt as useMatApp, $ as useMatProps, Yl as useMatTheme, $l as useMatViewTransition, eu as useMdeViewTransition };
