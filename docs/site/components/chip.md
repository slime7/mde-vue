...
:::: details 查看示例代码
::: code-group
<<< @/examples/chip/ChipHideSelectedIconExample.vue#template [template]
:::
::::
...
| `hide-selected-icon` | `boolean` | `false` | 选中的 filter Chip 不显示默认 check 前置图标 |
...
import ChipHideSelectedIconExample from '../examples/chip/ChipHideSelectedIconExample.vue';
