...
const activeTrackSize = computed(() => endPosition.value - startPosition.value);
...
const rootStyle = computed(() => ({
  ...colorStyle.value,
  '--mat-range-slider-active-track-size': `${formatSliderNumber(activeTrackSize.value)}%`,
  '--mat-range-slider-end-position': `${formatSliderNumber(endPosition.value)}%`,
  '--mat-range-slider-start-position': `${formatSliderNumber(startPosition.value)}%`,
}));
...
.mat-range-slider {
  ...
  --mat-range-slider-current-stop-color: var(--mat-slider-stop-indicator-color);
...
.mat-range-slider__active-track {
  ...
  display: block;
  inline-size: var(--mat-range-slider-active-track-size);
...
.mat-range-slider--dragging .mat-range-slider__handle {
  ...
  clip-path: inset(0 round calc(var(--mat-range-slider-current-track-corner) * .7));
}
...
.mat-range-slider--vertical .mat-range-slider__active-track {
  ...
  inset-inline: 0;
  block-size: var(--mat-range-slider-active-track-size);
  inline-size: auto;
